...
namespace App\Infrastructure\Persistence\InvItemAllowanceCharge;

use App\Invoice\InvItemAllowanceCharge\InvItemAllowanceChargeRepository as ACIIR;
use App\Infrastructure\Persistence\{
    AllowanceCharge\AllowanceCharge, InvItem\InvItem, Inv\Inv, Trait\RequireId
};
...
class InvItemAllowanceCharge
{
    ...
    public function reqInvItemId(): int
    {
        return $this->requireId($this->inv_item_id, 'Inv Item');
    }
