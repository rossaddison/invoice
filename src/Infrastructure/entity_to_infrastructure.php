...
return [
    ...
    'ClientCustom' => [
        'class'               => ClientCustom::class,
        'req_id'              => true,
        'var_annotations'     => false,
        'callers'             => [],
        'callers_updated'     => false,
        'form_created'        => false,
        'form_show_pattern'   => false,
        ...
        'tests'               => [
            'Tests/Unit/Invoice/Entity/ClientCustomEntityTest.php',
        ],
        'tests_updated'       => false,
    ],
    'ClientNote' => [
        'class'               => ClientNote::class,
        'req_id'              => true,
        'var_annotations'     => false,
        'callers'             => [],
        'callers_updated'     => false,
        ...
        'schema_cache_cleared' => false,
        'tests'               => [
            'Tests/Unit/Invoice/Entity/ClientNoteEntityTest.php',
        ],
        'tests_updated'       => false,
    ],
    'ClientPeppol' => [
    ...
    'Company' => [
        ...
        'schema_cache_cleared' => false,
        'tests'               => [
            'Tests/Unit/Invoice/Entity/CompanyEntityTest.php',
        ],
        'tests_updated'       => false,
    ],
    'CompanyPrivate' => [
        'class'               => CompanyPrivate::class,
        'req_id'              => true,
        'var_annotations'     => false,
        'callers'             => [],
        'callers_updated'     => false,
        ...
        'schema_cache_cleared' => false,
        'tests'               => [
            'Tests/Unit/Invoice/Entity/CompanyPrivateEntityTest.php',
            'Tests/Unit/CompanyPrivateFormTest.php',
        ],
        'tests_updated'       => false,
    ],
    'Contract' => [
        ...
        'schema_cache_cleared' => false,
        'tests'               => [
            'Tests/Unit/Invoice/Entity/ContractEntityTest.php',
        ],
        'tests_updated'       => false,
    ],
    'CustomField' => [
        ...
        'schema_cache_cleared' => false,
        'tests'               => [
            'Tests/Unit/CustomFieldEntityTest.php',
        ],
        'tests_updated'       => false,
    ],
    'CustomValue' => [
        'class'               => CustomValue::class,
        'req_id'              => true,
        'var_annotations'     => false,
        'callers'             => [],
        'callers_updated'     => false,
        ...
        'schema_cache_cleared' => false,
        'tests'               => [
            'Tests/Unit/Invoice/Entity/CustomValueEntityTest.php',
            'Tests/Unit/Entity/CustomValueEntityTest.php',
        ],
        'tests_updated'       => false,
    ],
    'Delivery' => [
        ...
        'schema_cache_cleared' => false,
        'tests'               => [
            'Tests/Unit/Entity/DeliveryEntityTest.php',
        ],
        'tests_updated'       => false,
    ],
    'DeliveryParty' => [
        'class'               => DeliveryParty::class,
        'req_id'              => true,
        'var_annotations'     => false,
        'callers'             => [],
        'callers_updated'     => false,
    ...
    'EmailTemplate' => [
        ...
        'schema_cache_cleared' => false,
        'tests'               => [
            'Tests/Unit/EmailTemplateEntityTest.php',
        ],
        'tests_updated'       => false,
    ],
    'Family'                        => [
    ...
    'FromDropDown' => [
        ...
        'schema_cache_cleared' => false,
        'tests'               => [
            'Tests/Unit/Invoice/Entity/FromDropDownEntityTest.php',
            'Tests/Unit/FromDropDownEntityTest.php',
        ],
        'tests_updated'       => false,
    ],
    'Gentor'                        => null,
    ...
    'PostalAddress' => [
        ...
        'schema_cache_cleared' => false,
        'tests'               => [
            'Tests/Unit/PostalAddressEntityTest.php',
        ],
        'tests_updated'       => false,
    ],
    'Product'                       => [
    ...
    'Quote'                         => [
        ...
        'var_annotations'     => false,
        'callers'             => [
            'src/Infrastructure/Persistence/QuoteAllowanceCharge/QuoteAllowanceCharge.php',
            'src/Infrastructure/Persistence/SalesOrder/SalesOrder.php',
            'src/Command/Invoice/QuoteTruncate2Command.php',
            'src/Invoice/Client/ClientController.php',
            'src/Invoice/Helpers/MpdfHelper.php',
            'src/Invoice/Helpers/NumberHelper.php',
            'src/Invoice/Helpers/PdfHelper.php',
            'src/Invoice/InvItem/InvItemService.php',
            'src/Invoice/Product/ProductController.php',
            'src/Invoice/Quote/QuoteCustomFieldProcessor.php',
            'src/Invoice/Quote/QuoteDeletionService.php',
            'src/Invoice/Quote/QuoteForm.php',
            'src/Invoice/Quote/QuoteRepository.php',
            'src/Invoice/Quote/QuoteService.php',
            'src/Invoice/Quote/Trait/Add.php',
            'src/Invoice/Quote/Trait/Index.php',
            'src/Invoice/Quote/Trait/OptionsData.php',
            'src/Invoice/Quote/Trait/QuoteToSo.php',
            'src/Invoice/QuoteAmount/QuoteAmountRepository.php',
            'src/Invoice/QuoteAmount/QuoteAmountService.php',
            'src/Invoice/QuoteCustom/QuoteCustomForm.php',
            'src/Invoice/QuoteCustom/QuoteCustomRepository.php',
            'src/Invoice/QuoteCustom/QuoteCustomService.php',
            'src/Invoice/QuoteItem/QuoteItemController.php',
            'src/Invoice/QuoteItem/QuoteItemForm.php',
            'src/Invoice/QuoteItem/QuoteItemRepository.php',
            'src/Invoice/QuoteItem/QuoteItemService.php',
            'src/Invoice/QuoteItemAllowanceCharge/QuoteItemAllowanceChargeController.php',
            'src/Invoice/QuoteItemAllowanceCharge/QuoteItemAllowanceChargeForm.php',
            'src/Invoice/QuoteItemAllowanceCharge/QuoteItemAllowanceChargeRepository.php',
            'src/Invoice/QuoteItemAllowanceCharge/QuoteItemAllowanceChargeService.php',
            'src/Invoice/QuoteTaxRate/QuoteTaxRateForm.php',
            'src/Invoice/QuoteTaxRate/QuoteTaxRateRepository.php',
            'src/Invoice/QuoteTaxRate/QuoteTaxRateService.php',
            'src/Invoice/Task/TaskController.php',
            'src/Widget/QuoteToolbar.php',
            'resources/views/invoice/quote/guest.php',
            'resources/views/invoice/quote/index.php',
            'resources/views/invoice/quote/partial_quote_table.php',
        ],
        'callers_updated'     => true,
        'form_created'        => false,
        'form_show_pattern'   => false,
    ...
    'QuoteItemAllowanceCharge' => [
        'class'               => QuoteItemAllowanceCharge::class,
        'req_id'              => true,
        'var_annotations'     => false,
        'callers'             => [],
        'callers_updated'     => false,
