...
final class CategorySecondaryController
{
    ...
    public function index(CategorySecondaryRepository $categorySecondaryRepository, 
     ...
     * @return Response
     */
    public function delete(CategorySecondaryRepository $categorysecondaryRepository, #[RouteArgument('id')] int $id 
    ): Response {
        try {
    ...
    {
        if ($id) {
            $categorysecondary = $categorysecondaryRepository->repoCategorySecondaryLoadedQuery((string)$id);
    ...
    {
        $categorysecondaries = $categorysecondaryRepository->findAllPreloaded();        
        return $categorysecondaries;
    }
     ...
     */
    public function view(CategorySecondaryRepository $categorysecondaryRepository,
                         CategoryPrimaryRepository $categoryPrimaryRepository,   
