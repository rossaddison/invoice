...
final readonly class QuoteAllowanceChargeService
{
    public function __construct(
        private QuoteAllowanceChargeRepository $repository, private ACR $acR)
    {
    }
    ...
    public function saveQuoteAllowanceCharge(
        QuoteAllowanceCharge $model, array $array): void
    {
     ...
     * @param QuoteAllowanceCharge $model
     */
    public function deleteQuoteAllowanceCharge(QuoteAllowanceCharge $model): void
    {
