...
final readonly class CustomFieldService
{
    ...
    public function saveCustomField(CustomField $model, array $array): void
    {
        ...
        $model->setEmailMultiple($array['email_multiple'] === '1');
        ...
        $this->applyTextAreaSettings($model, $array);
        ...
        $model->setRequired($array['required'] === '1');
        $this->repository->save($model);
    }

    private function applyTextAreaSettings(CustomField $model, array $array): void
    {
