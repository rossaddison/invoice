...
final readonly class ProductService
{
    ...
    public function saveProduct(
        ...
        isset($apf['product_additional_item_property_value']) ? 
            $model->setProduct_additional_item_property_value(
                (string) $apf[
        ...
        isset($apf['tax_rate_id']) ? 
            $model->setTax_rate_id(
                (int) $apf['tax_rate_id']) : '';
        isset($apf['unit_id']) ? 
            $model->setUnit_id((int) $apf['unit_id']) : '';
        isset($apf['unit_peppol_id']) ? 
            $model->setUnit_peppol_id(
                (int) $apf['unit_peppol_id']) : '';
        isset($apf['family_id']) ? 
            $model->setFamily_id((int) $apf['family_id']) : '';
