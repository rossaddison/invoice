...
class PModeReliability
{
    ...
    public function isReceptionAwarenessEnabled(): bool
    {
        return $this->receptionAwarenessEnabled;
    }
    ...
    public function isDuplicateDetectionEnabled(): bool
    {
        return $this->duplicateDetectionEnabled;
    }
