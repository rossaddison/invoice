...
final class InvsListWidget extends Widget
{
    ...
    public function render(): string
    {
        ...
        $gridView = GridView::widget()
            ...
            // the real aria-sort attribute on each sortable <th> (see
            // BaseListView/GlobalContext), so these glyphs would otherwise
            // be redundant, inconsistently-read Unicode noise on top of a
