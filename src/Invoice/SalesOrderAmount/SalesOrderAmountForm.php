...
final class SalesOrderAmountForm extends FormModel
{
     ...
     * @return Required[][]
     *
     * @psalm-return array{item_subtotal: list{Required},
                          item_tax_total: list{Required},
                          packhandleship_total: list{Required},
                          packhandleship_tax: list{Required},
                          tax_total: list{Required},
                          total: list{Required},
                          sales_order_id: list{Required}}
     */
