...
trait PeppolUneceRec2011eTrait5
{
    protected function getUNECERec2011eChunk69(): array
    {
        return [
            1702 => [
                'Id' => 'STC',
    ...
    protected function getUNECERec2011eChunk70(): array
    {
        return [
            1726 => [
                'Id' => 'TST',
    ...
    protected function getUNECERec2011eChunk71(): array
    {
        return [
            1751 => [
                'Id' => 'Z11',
    ...
    protected function getUNECERec2011eChunk72(): array
    {
        return [
            1781 => [
                'Id' => 'X8B',
    ...
    protected function getUNECERec2011eChunk73(): array
    {
        return [
            1809 => [
                'Id' => 'XBK',
    ...
    protected function getUNECERec2011eChunk74(): array
    {
        return [
            1840 => [
                'Id' => 'XCP',
    ...
    protected function getUNECERec2011eChunk75(): array
    {
        return [
            1873 => [
                'Id' => 'XEE',
    ...
    protected function getUNECERec2011eChunk76(): array
    {
        return [
            1902 => [
                'Id' => 'XHN',
    ...
    protected function getUNECERec2011eChunk77(): array
    {
        return [
            1931 => [
                'Id' => 'XMB',
    ...
    protected function getUNECERec2011eChunk78(): array
    {
        return [
            1960 => [
                'Id' => 'XOE',
    ...
    protected function getUNECERec2011eChunk79(): array
    {
        return [
            1989 => [
                'Id' => 'XPE',
    ...
    protected function getUNECERec2011eChunk80(): array
    {
        return [
            2020 => [
                'Id' => 'XQQ',
    ...
    protected function getUNECERec2011eChunk81(): array
    {
        return [
            2050 => [
                'Id' => 'XSZ',
    ...
    protected function getUNECERec2011eChunk82(): array
    {
        return [
            2080 => [
                'Id' => 'XVN',
    ...
    protected function getUNECERec2011eChunk83(): array
    {
        return [
            2112 => [
                'Id' => 'XXG',
    ...
    protected function getUNECERec2011eChunk84(): array
    {
        return [
            2145 => [
                'Id' => 'XZJ',
