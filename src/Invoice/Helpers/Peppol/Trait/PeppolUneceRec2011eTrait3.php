...
trait PeppolUneceRec2011eTrait3
{
    protected function getUNECERec2011eChunk35(): array
    {
        return [
            875 => [
                'Id' => 'H65',
    ...
    protected function getUNECERec2011eChunk36(): array
    {
        return [
            899 => [
                'Id' => 'H91',
    ...
    protected function getUNECERec2011eChunk37(): array
    {
        return [
            924 => [
                'Id' => 'HTZ',
    ...
    protected function getUNECERec2011eChunk38(): array
    {
        return [
            949 => [
                'Id' => 'J24',
    ...
    protected function getUNECERec2011eChunk39(): array
    {
        return [
            974 => [
                'Id' => 'J50',
    ...
    protected function getUNECERec2011eChunk40(): array
    {
        return [
            1000 => [
                'Id' => 'J76',
    ...
    protected function getUNECERec2011eChunk41(): array
    {
        return [
            1026 => [
                'Id' => 'K10',
    ...
    protected function getUNECERec2011eChunk42(): array
    {
        return [
            1052 => [
                'Id' => 'K37',
    ...
    protected function getUNECERec2011eChunk43(): array
    {
        return [
            1078 => [
                'Id' => 'K65',
    ...
    protected function getUNECERec2011eChunk44(): array
    {
        return [
            1105 => [
                'Id' => 'K93',
    ...
    protected function getUNECERec2011eChunk45(): array
    {
        return [
            1130 => [
                'Id' => 'KLX',
    ...
    protected function getUNECERec2011eChunk46(): array
    {
        return [
            1155 => [
                'Id' => 'KWH',
    ...
    protected function getUNECERec2011eChunk47(): array
    {
        return [
            1182 => [
                'Id' => 'L30',
    ...
    protected function getUNECERec2011eChunk48(): array
    {
        return [
            1209 => [
                'Id' => 'L57',
    ...
    protected function getUNECERec2011eChunk49(): array
    {
        return [
            1236 => [
                'Id' => 'L86',
    ...
    protected function getUNECERec2011eChunk50(): array
    {
        return [
            1261 => [
                'Id' => 'LP',
    ...
    protected function getUNECERec2011eChunk51(): array
    {
        return [
            1286 => [
                'Id' => 'M24',
