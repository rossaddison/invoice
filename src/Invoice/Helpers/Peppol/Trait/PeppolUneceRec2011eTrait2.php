...
trait PeppolUneceRec2011eTrait2
{
    ...
    protected function getUNECERec2011eChunk19(): array
    {
        return [
            465 => [
                'Id' => 'DEC',
    ...
    protected function getUNECERec2011eChunk20(): array
    {
        return [
            489 => [
                'Id' => 'E09',
    ...
    protected function getUNECERec2011eChunk21(): array
    {
        return [
            512 => [
                'Id' => 'E37',
    ...
    protected function getUNECERec2011eChunk22(): array
    {
        return [
            536 => [
                'Id' => 'E60',
    ...
    protected function getUNECERec2011eChunk23(): array
    {
        return [
            559 => [
                'Id' => 'E83',
    ...
    protected function getUNECERec2011eChunk24(): array
    {
        return [
            584 => [
                'Id' => 'F06',
    ...
    protected function getUNECERec2011eChunk25(): array
    {
        return [
            610 => [
                'Id' => 'F33',
    ...
    protected function getUNECERec2011eChunk26(): array
    {
        return [
            637 => [
                'Id' => 'F60',
    ...
    protected function getUNECERec2011eChunk27(): array
    {
        return [
            663 => [
                'Id' => 'F86',
    ...
    protected function getUNECERec2011eChunk28(): array
    {
        return [
            689 => [
                'Id' => 'FS',
    ...
    protected function getUNECERec2011eChunk29(): array
    {
        return [
            716 => [
                'Id' => 'G28',
    ...
    protected function getUNECERec2011eChunk30(): array
    {
        return [
            743 => [
                'Id' => 'G54',
    ...
    protected function getUNECERec2011eChunk31(): array
    {
        return [
            770 => [
                'Id' => 'G81',
    ...
    protected function getUNECERec2011eChunk32(): array
    {
        return [
            796 => [
                'Id' => 'GIA',
    ...
    protected function getUNECERec2011eChunk33(): array
    {
        return [
            822 => [
                'Id' => 'H11',
    ...
    protected function getUNECERec2011eChunk34(): array
    {
        return [
            848 => [
                'Id' => 'H38',
