...
trait PeppolUneceRec2011eTrait4
{
    protected function getUNECERec2011eChunk52(): array
    {
        return [
            1310 => [
                'Id' => 'M48',
    ...
    protected function getUNECERec2011eChunk53(): array
    {
        return [
            1334 => [
                'Id' => 'M71',
    ...
    protected function getUNECERec2011eChunk54(): array
    {
        return [
            1356 => [
                'Id' => 'M92',
    ...
    protected function getUNECERec2011eChunk55(): array
    {
        return [
            1379 => [
                'Id' => 'MIN',
    ...
    protected function getUNECERec2011eChunk56(): array
    {
        return [
            1408 => [
                'Id' => 'MVA',
    ...
    protected function getUNECERec2011eChunk57(): array
    {
        return [
            1428 => [
                'Id' => 'N27',
    ...
    protected function getUNECERec2011eChunk58(): array
    {
        return [
            1450 => [
                'Id' => 'N48',
    ...
    protected function getUNECERec2011eChunk59(): array
    {
        return [
            1471 => [
                'Id' => 'N69',
    ...
    protected function getUNECERec2011eChunk60(): array
    {
        return [
            1493 => [
                'Id' => 'N91',
    ...
    protected function getUNECERec2011eChunk61(): array
    {
        return [
            1517 => [
                'Id' => 'NX',
    ...
    protected function getUNECERec2011eChunk62(): array
    {
        return [
            1543 => [
                'Id' => 'P21',
    ...
    protected function getUNECERec2011eChunk63(): array
    {
        return [
            1566 => [
                'Id' => 'P44',
    ...
    protected function getUNECERec2011eChunk64(): array
    {
        return [
            1588 => [
                'Id' => 'P65',
    ...
    protected function getUNECERec2011eChunk65(): array
    {
        return [
            1610 => [
                'Id' => 'P87',
    ...
    protected function getUNECERec2011eChunk66(): array
    {
        return [
            1632 => [
                'Id' => 'PS',
    ...
    protected function getUNECERec2011eChunk67(): array
    {
        return [
            1654 => [
                'Id' => 'Q27',
    ...
    protected function getUNECERec2011eChunk68(): array
    {
        return [
            1678 => [
                'Id' => 'QTR',
