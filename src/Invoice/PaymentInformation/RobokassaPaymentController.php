...
final class RobokassaPaymentController
{
    ...
    /**
     * Shared load+isConfigured+balance guard chain for robokassaInForm() —
    ...
    private function resolveConfiguredInvoiceWithBalance(CurrentRoute $currentRoute): Response|array
    {
        ...
        $configured = $this->requireRobokassaConfigured();
    ...
    private function requireRobokassaConfigured(): ?Response
    {
