...
final readonly class ClientPeppolService
{
    ...
    public function saveClientPeppol(ClientPeppol $model, array $array): void
    {
        ...
        isset($array['client_id']) ? $model->setClient_id(
                (int) $array['client_id']) : '';
        isset($array['accounting_cost']) ? $model->setAccountingCost(
                (string) $array['accounting_cost']) : '';
        isset($array['buyer_reference']) ? $model->setBuyerReference(
                (string) $array['buyer_reference']) : '';
        isset($array['endpointid']) ? $model->setEndpointid(
                (string) $array['endpointid']) : '';
        isset($array['endpointid_schemeid']) ? $model->setEndpointid_schemeid(
        ...
        isset($array['identificationid']) ? $model->setIdentificationid(
