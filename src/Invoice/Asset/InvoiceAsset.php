...
class InvoiceAsset extends AssetBundle
{
    ...
    /** @psalm-suppress NonInvariantDocblockPropertyType */
    public array $js = [
        // TypeScript compiled bundle (IIFE format) - contains quote, inv, salesorder, client, family, product, setting functionality
        'rebuild/js/invoice-typescript-iife.js',
        
        // Individual JS files (commented out - replaced by TypeScript bundle above)
        // 'rebuild/js/quote.js',
        // 'rebuild/js/inv.js',
        ...
        // Keep these JS files that haven't been converted to TypeScript yet
