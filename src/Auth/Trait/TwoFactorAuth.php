...
{
    /**
     * Step 1: Install any TOTP authenticator app on your mobile (Google
     *         Authenticator, Microsoft Authenticator, Authy, 1Password,
     *         Bitwarden, Yandex ID, Aegis, etc. — this is standard RFC 6238
     *         TOTP, not tied to any one app)
     * Step 2: Add a new entry (usually a "+" / scan icon in the app)
