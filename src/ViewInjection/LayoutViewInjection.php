...
final readonly class LayoutViewInjection implements LayoutParametersInjectionInterface
{
    ...
    public function getLayoutParameters(): array
    {
        ...
        return [
            ...
            'noFrontPageHmrcApiStatus' => $bs['noFrontPageHmrcApiStatus'],
    ...
    private function buildLocaleDropdownItemsAtoO(
        ...
        return [
            'afZA' => DropdownItem::link(
                $fl('af-ZA', 'Afrikaans South African'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'af-ZA'],
                    fallbackRouteName: $siteIndex
                ),
                itemAttributes: $itemFontArray
            ),
            'arBH' => DropdownItem::link(
                $fl('ar-BH', 'Arabic Bahrainian/ عربي'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'ar-BH'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'az' => DropdownItem::link(
                $fl('az', 'Azerbaijani / Azərbaycan'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'az'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'beBY' => DropdownItem::link(
                $fl('be-BY', 'Belarusian / Беларуская'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'be-BY'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'bs' => DropdownItem::link(
                $fl('bs', 'Bosnian / Bosanski'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'bs'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'zhCN' => DropdownItem::link(
                $fl('zh-CN', 'Chinese Simplified / 简体中文'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'zh-CN'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'zhTW' => DropdownItem::link(
                $fl('zh-TW', 'Tiawanese Mandarin / 简体中文'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'zh-TW'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'fil' => DropdownItem::link(
                $fl('fil', 'Filipino / Filipino'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'fil'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'fr' => DropdownItem::link(
                $fl('fr', 'French / Français'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'fr'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'gdGB' => DropdownItem::link(
                $fl('gd-GB', 'Scots Gaelic / Gàidhlig na h-Alba'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'gd-GB'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'haNG' => DropdownItem::link(
                $fl('ha-NG', 'Hausa Nigerian / Hausawa Ɗan Najeriya'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'ha-NG'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'heIL' => DropdownItem::link(
                $fl('he-IL', 'Hebrew Israel / העברית ישראל'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'he-IL'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'nl' => DropdownItem::link(
                $fl('nl', 'Dutch / Nederlands'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'nl'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'de' => DropdownItem::link(
                $fl('de', 'German / Deutsch'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'de'],
                    fallbackRouteName: $siteIndex
                ),
    ...
    private function buildLocaleDropdownItemsPtoZ(
        ...
        return [
            'id' => DropdownItem::link(
                $fl('id', 'Indonesian / bahasa Indonesia'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'id'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'igNG' => DropdownItem::link(
                $fl('ig-NG', 'Igbo Nigerian / Igbo Naịjirịa'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'ig-NG'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'it' => DropdownItem::link(
                $fl('it', 'Italian / Italiano'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'it'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'ptBR' => DropdownItem::link(
                $fl('pt-BR', 'Portugese Brazilian / Português Brasileiro'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'pt-BR'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'ru' => DropdownItem::link(
                $fl('ru', 'Russian / Русский'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'ru'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'sk' => DropdownItem::link(
                $fl('sk', 'Slovakian / Slovenský'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'sk'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'sl' => DropdownItem::link(
                $fl('sl', 'Slovenian / Slovenski'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'sl'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'es' => DropdownItem::link(
                $fl('es', 'Spanish /  Española x'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'es'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'uk' => DropdownItem::link(
                $fl('uk', 'Ukrainian / українська'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'uk'],
                    fallbackRouteName: $siteIndex
                ),
            ...
            'vi' => DropdownItem::link(
                $fl('vi', 'Vietnamese / Tiếng Việt'),
                $this->urlGenerator->generateFromCurrent(
                    [$argLang => 'vi'],
                    fallbackRouteName: $siteIndex
                ),
