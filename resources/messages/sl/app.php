...
return [
    ...
    'as4.messages.log' => 'Sporočila AS4',
    ...
    'body' => 'Telo',
    'bookkeeping.export.hint' => 'Sinhronizira knjigo iz vaših računov in nato pošlje vse, kar še ni izvoženo, v QuickBooks.',
    'bookkeeping.export.now' => 'Izvozi zdaj',
    'bookkeeping.export.summary' => 'Izvoz knjigovodstva končan: %d izvoženih, %d neuspešnih.',
    'bookkeeping.quickbooks.account.accounts.receivable' => 'ID računa terjatev',
    'bookkeeping.quickbooks.account.bank' => 'ID bančnega računa',
    'bookkeeping.quickbooks.account.payment.fees' => 'ID računa za plačilne provizije',
    'bookkeeping.quickbooks.account.sales' => 'ID prodajnega računa',
    'bookkeeping.quickbooks.account.vat.or.tax' => 'ID računa za DDV/davek od prodaje',
    'bookkeeping.quickbooks.client.id' => 'ID stranke',
    'bookkeeping.quickbooks.client.secret' => 'Skrivnost odjemalca',
    'bookkeeping.quickbooks.connect' => 'Povežite se s QuickBooksom',
    'bookkeeping.quickbooks.connect.cancelled' => 'Povezava s QuickBooksom je bila preklicana ali zavrnjena.',
    'bookkeeping.quickbooks.connect.hint' => 'Preusmeritve na QuickBooks za avtorizacijo te aplikacije – najprej je treba shraniti spodnji ID stranke/skrivnost.',
    'bookkeeping.quickbooks.connect.invalid.state' => 'Povezava s QuickBooksom ni uspela: neveljaven parameter stanja.',
    'bookkeeping.quickbooks.connect.success' => 'Povezan s QuickBooksom.',
    'bookkeeping.quickbooks.connect.unexpected.response' => 'QuickBooks je vrnil nepričakovan odgovor.',
    'bookkeeping.quickbooks.connected' => 'Povezan',
    'bookkeeping.quickbooks.not.configured' => 'ID/skrivnost odjemalca QuickBooks nista konfigurirana.',
    'bookkeeping.quickbooks.not.connected' => 'Ni povezano',
    'bookkeeping.quickbooks.sandbox' => 'Peskovnik (uporablja sandbox-quickbooks.api.intuit.com)',
    ...
    'bootstrap5.calendar.accent.color' => 'Barva poudarka koledarja',
    ...
    'bootstrap5.layout.invoice.navbar.sticky' => 'Lepljiva navigacijska vrstica',
    'bootstrap5.layout.invoice.navbar.sticky.hint' => 'Zgornjo navigacijsko vrstico pripne na mestu, medtem ko se stran pomika pod njo. Shrani se takoj – učinek bo viden pri naslednjem nalaganju strani.',
    ...
    'client.postaladdress.add.save.first' => 'Najprej shranite to stranko, nato pa dodajte poštni naslov',
    ...
    'debug.reset.tree.confirm' => 'Ste prepričani, da želite nadaljevati?',
    'debug.reset.tree.confirm.button' => 'Spusti in obnovi',
    'debug.reset.tree.db.password' => 'Geslo baze podatkov',
    'debug.reset.tree.done' => 'Tabele računov, ponudb in naročil izbrisane in ponovno sestavljene',
    'debug.reset.tree.failed' => 'Ponastavitev ni uspela, nič drugega ni bilo spremenjeno',
    'debug.reset.tree.menu' => 'Ponastavi račun/ponudbo/prodajno naročilo',
    'debug.reset.tree.tables.heading' => 'Naslednje tabele bodo odstranjene in ponovno ustvarjene prazne:',
    'debug.reset.tree.title' => 'Ponastavi račun, ponudbo in prodajno naročilo',
    'debug.reset.tree.warning' => 'S tem trajno izbrišete vse račune, ponudbe in prodajna naročila ter vse njihove postavke, zneske, davčne stopnje, polja po meri in stroške nadomestil. Najprej se v /backups zapiše gzipirana varnostna kopija, vendar tega na tem zaslonu ni mogoče razveljaviti.',
    'debug.reset.tree.wrong.password' => 'Napačno geslo za bazo podatkov, nič ni bilo spremenjeno',
    ...
    'delivery.location.peppol.output.fix' => 'Nastavite ga zdaj',
    ...
    'grid.sticky.header' => 'Glava lepljive mreže',
    'grid.sticky.header.hint' => 'Med pomikanjem po dolgem seznamu računa, ponudbe, prodajnega naročila ali izdelkov ostanejo glave stolpcev pripete na vrh. Shrani se takoj – učinek je viden, ko obiščete seznam.',
    'gridview.api' => 'API',
    ...
    'home.hmrc.api.status' => 'Status HMRC API ➡️',
    ...
    'home.peppol.access.point.status' => 'Stanje dostopne točke Peppol ➡️',
    ...
    'invoice.status.cannot.revert' => 'Izdanega računa ni mogoče razveljaviti v prejšnje stanje. Razveljavite ga (če ni bil plačan) ali izdajte dobropis.',
    'invoice.status.issued' => 'Izdano',
    ...
    'invoice.void' => 'Ničen račun',
    'invoice.void.confirm' => 'Želite razveljaviti ta račun? Preklican bo, ohranil bo svojo številko in ga ne bo več mogoče urejati ali plačati.',
    'invoice.void.not.allowed' => 'Razveljaviti je mogoče le izdan ali ogledan račun brez plačil. Namesto tega izdajte dobropis.',
    'invoice.void.selected.confirm' => 'Stornirati izbrane račune? Stornirani bodo samo izdani ali ogledani računi brez plačil; ohranijo svoje številke in jih ni več mogoče urejati.',
    'invoice.void.success' => 'Račun je bil razveljavljen.',
    ...
    'menu.hmrc.api.status' => 'Status HMRC API',
    'menu.language' => 'Jezik',
    'menu.login' => 'Prijava',
    'menu.logout' => 'Odjava ({login})',
    'menu.more' => 'Več',
    'menu.peppol.status' => 'Stanje dostopne točke Peppol',
    'menu.pricing' => 'Cenik',
    ...
    'mtd.business.missing.nino.or.token' => 'Številka nacionalnega zavarovanja ali dostopni žeton HMRC ni nastavljen',
    'mtd.eori' => 'Registracijska in identifikacijska številka gospodarskega subjekta (EORI)',
    'mtd.eori.hint' => 'Potrebno za identifikacijo tega podjetja v HMRC-jevem API-ju za carinske deklaracije – npr. GB123456789000',
    'mtd.fph' => 'Glave za preprečevanje goljufij',
    'mtd.fph.all.valid' => 'Vse glave za preprečevanje goljufij so veljavne',
    'mtd.fph.feedback.client.credentials.error' => 'HMRC je zavrnil zahtevo za žeton za omejen dostop aplikacije: "{error}" – {description}',
    'mtd.fph.feedback.no.client.credentials.token' => 'DEVELOPER_GOV_SANDBOX_HMRC_API_CLIENT_ID ali _CLIENT_SECRET ni nastavljen v .env -- FPH Feedback potrebuje svoj žeton za omejen dostop aplikacije od HMRC, ločen od žetona, ki ga uporablja vsaka druga stran HMRC tukaj.',
    'mtd.fph.feedback.unexpected.token.response' => 'HMRC je vrnil kodo 200 za zahtevo za žeton dostopa z omejenim dostopom aplikacije, vendar v telesu odgovora ni bilo žetona access_token.',
    'mtd.fph.generate' => 'Ustvari',
    'mtd.fph.manage.subscriptions.link.text' => 'dodaj tukaj',
    'mtd.fph.missing.hmrc.token' => 'Niste prijavljeni v HMRC. {link}, poskusite znova.',
    'mtd.fph.missing.otp.session' => 'Podrobnosti o seji dvofaktorskega preverjanja pristnosti manjkajo ali so potekle, kar je potrebno za testiranje glav za preprečevanje goljufij. Odjavite se in se znova prijavite ter poskusite znova.',
    ...
    'mtd.fph.validate.error.generic' => 'HMRC je vrnil napako pri preverjanju vaših glav za preprečevanje goljufij: "{code}" — {message}',
    'mtd.fph.validate.error.not.subscribed' => 'HMRC je vrnil »{code}«: {message} Vaši aplikaciji Developer Hub je treba pod naročnine dodati API za glave za preprečevanje goljufij pri testiranju – {link}.',
    ...
    'mtd.hmrc.developer.hub' => 'Središče za razvijalce HMRC',
    'mtd.hmrc.developer.hub.add.production.application' => 'Dodaj produkcijsko aplikacijo',
    'mtd.hmrc.developer.hub.add.sandbox.application' => 'Dodaj aplikacijo za peskovnik',
    'mtd.hmrc.developer.hub.application.id' => 'ID aplikacije v središču za razvijalce',
    'mtd.hmrc.developer.hub.application.id.not.set' => 'Ni nastavljeno – v .env dodajte DEVELOPER_GOV_SANDBOX_HMRC_API_APPLICATION_ID (UUID iz URL-ja »Upravljanje aplikacije« v središču za razvijalce, ne OAuth client_id)',
    'mtd.hmrc.developer.hub.change.name.and.description' => 'Spremeni ime in opis',
    'mtd.hmrc.developer.hub.change.password' => 'Spremeni geslo',
    'mtd.hmrc.developer.hub.client.secrets' => 'Skrivnosti strank',
    'mtd.hmrc.developer.hub.delete.application' => 'Izbriši aplikacijo',
    'mtd.hmrc.developer.hub.email.preferences' => 'Nastavitve e-pošte',
    'mtd.hmrc.developer.hub.ip.allowlist' => 'Seznam dovoljenih IP-jev',
    'mtd.hmrc.developer.hub.login' => 'Prijava',
    'mtd.hmrc.developer.hub.logout' => 'Odjava',
    'mtd.hmrc.developer.hub.manage.application' => 'Upravljanje aplikacije',
    'mtd.hmrc.developer.hub.profile' => 'Profil',
    'mtd.hmrc.developer.hub.redirect.uris' => 'Preusmeritveni URI-ji',
    'mtd.hmrc.developer.hub.security.preferences' => 'Varnostne nastavitve',
    'mtd.hmrc.developer.hub.subscriptions' => 'Naročnine',
    'mtd.hmrc.developer.hub.tc.and.privacy.policy.url' => 'URL pogojev in določil / pravilnika o zasebnosti',
    'mtd.hmrc.developer.hub.team.members' => 'Člani ekipe',
    'mtd.individual.calculations.trigger.error' => 'HMRC je vrnil napako pri sprožitvi izračuna: "{code}" — {message}',
    'mtd.individual.calculations.triggered' => 'Izračun sprožen (ID: {calculationId}).',
    'mtd.nino' => 'Nacionalna zavarovalna številka (NINO)',
    'mtd.nino.hint' => 'Potrebno za vsak spodnji API, ki temelji na NINO (samozaposleno podjetje, podrobnosti o podjetju itd.) – za peskovnik HMRC uporabite nino, ki ga vrne možnost »Ustvari testnega uporabnika«, ne svojega dejanskega NINO.',
    ...
    'mtd.vat.return.error.client_or_agent_not_authorised' => 'Ta račun ni pooblaščen za oddajo obračunov DDV za to VRN.',
    'mtd.vat.return.error.duplicate_submission' => 'Za to obdobje je bila že predložena obračunska napoved DDV.',
    'mtd.vat.return.error.invalid_monetary_amount' => 'Eden od poslanih zneskov ni veljavna denarna vrednost (od 0 do 99.999.999.999,99, na 2 decimalni mesti).',
    'mtd.vat.return.error.invalid_numeric_value' => 'Ena od poslanih vrednosti ni veljavna številka.',
    'mtd.vat.return.error.invalid_request' => 'HMRC je to zahtevo zavrnil kot napačno oblikovano.',
    'mtd.vat.return.error.not_finalised' => 'Ta napoved ni bila razglašena za dokončno – označite potrditveno polje in jo ponovno oddajte.',
    'mtd.vat.return.error.period_key_invalid' => 'Ključ obdobja za to obračun DDV je neveljaven ali neprepoznan.',
    'mtd.vat.return.error.rule_insolvent_trader' => 'V evidencah HMRC je ta trgovec insolventen, zato vračil ni mogoče sprejeti.',
    'mtd.vat.return.error.tax_period_not_ended' => 'To davčno obdobje se še ni končalo – HMRC ne more sprejeti davčne napovedi pred koncem obdobja.',
    'mtd.vat.return.error.vat_net_value' => 'Polje 5 (Neto zapadli DDV) mora biti enako razliki med poljema 3 in 4.',
    'mtd.vat.return.error.vat_total_value' => 'Polje 3 (Skupni znesek DDV) mora biti enako polju 1 + polju 2.',
    'mtd.vat.return.error.vrn_invalid' => 'Navedena identifikacijska številka za DDV ni veljavna.',
    ...
    'off' => 'Izklopljeno',
    'on' => 'Vklopljeno',
    'online.bookkeeping' => 'Spletno knjigovodstvo',
    ...
    'online.payment.bitpay.generic.complete.message' => 'Vaše plačilo BitPay je v obdelavi. Vaš račun se bo samodejno posodobil, ko ga BitPay potrdi v verigi – za najnovejše stanje preverite neposredno na računu.',
    ...
    'online.payment.payment.processing.generic' => 'Hvala',
    ...
    'online.payment.posToken' => 'POS žeton',
    ...
    'oxalis' => 'Oksalis',
    'oxalis.env.not.set' => 'Ni nastavljeno',
    'oxalis.env.only.note' => 'Oxalis je konfiguriran prek spremenljivk .env, ne tukaj – spodaj so prikazane samo za branje. Za korake nastavitve glejte src/Invoice/Peppol/README.md. Oxalis v tej uvedbi še ni bil uporabljen za dejansko pošiljanje.',
    'oxalis.setup.guide' => 'Navodila za namestitev Oxalisa →',
    'page' => 'Stran',
    'paid' => 'Plačano',
    'password' => 'Geslo',
    ...
    'peppol.access.point' => 'Dostopna točka Peppol',
    'peppol.access.point.get.credentials' => 'Pridobi poverilnice →',
    'peppol.access.point.hint' => 'Izberite, katera dostopna točka dejansko prenaša vaše dokumente Peppol, nato pa spodaj izpolnite podatke tega ponudnika – pri pošiljanju se uporablja samo kartica izbranega ponudnika.',
    'peppol.access.point.provider' => 'Ponudnik dostopne točke',
    ...
    'peppol.buyer.postal.address.not.found.fix' => 'Popravi zdaj',
    ...
    'peppol.client.check.missing' => 'Ta stranka sploh nima nastavljenih podatkov o Peppolu.',
    'peppol.client.check.no.client' => 'Ta račun nima priložene stranke – Peppola ni mogoče poslati brez nje.',
    ...
    'peppol.endpointid.checksum.invalid' => 'Ta vrednost ne prejme kontrolne vsote, ki jo zahteva shema.',
    'peppol.endpointid.looks.like.email' => 'To je videti kot e-poštni naslov, vendar nobena prava shema Peppol ne uporablja e-poštnega naslova kot identifikatorja – namesto tega vnesite identifikator podjetja (registrsko številko, številko za DDV, GLN itd.), ki ustreza izbrani shemi.',
    ...
    'peppol.messages.log' => 'Peppolova sporočila',
    'peppol.optional' => ' (Neobvezno)',
    'peppol.send.via' => 'Pošlji prek Peppola',
    ...
    'peppol.tax.category.not.found.fix' => 'Nastavi zdaj',
    ...
    'product.peppol.unit.hint' => 'Shranjevanje tega izdelka ni obvezno, vendar je obvezno v trenutku, ko je račun, ki uporablja ta izdelek, poslan prek Peppola – to mora biti zapis UnitPeppol za isto zgoraj izbrano enoto, ne kar kateri koli zapis UnitPeppol. Nastavite ga zdaj, če bo ta izdelek kdaj uporabljen na računu Peppol.',
    'product.peppol.unit.missing' => 'Ni nastavljeno',
    'product.price' => 'Cena',
    ...
    'rejected' => 'Zavrnjeno',
    'remember.me.days' => 'Trajanje funkcije »Zapomni si me« (dnevi)',
    ...
    'run.sheet.pdf' => 'Preglednica teka (PDF)',
    'run.sheet.pdf.tooltip' => 'Prenesite PDF datoteko vsakega računa, ki ga trenutno prikazujejo vaši filtri, predvsem naslov kot povezavo Google Zemljevidov, na katero lahko kliknete – uporabno za čiščenje HomeCare ali kateri koli drug seznam računov, ki ga morate obiskati ali uporabiti brez povezave.',
    'sales' => 'Prodaja',
    ...
    'setting.arbitration.details.note' => 'Polji Arbitražni organ in Arbitražna pristojnost, ki se uporabljata v razdelkih Reševanje sporov in Veljavno pravo, sta nastavljeni tudi na strani podjetja.',
    ...
    'setting.company.details.note' => 'Ime podjetja, kontaktni podatki in naslov, prikazani na tej strani, se upravljajo na strani Podjetje.',
    ...
    'setting.hide.from.front.page' => 'Skrij na naslovnici',
    'setting.key' => 'Nastavitveni ključ',
    'setting.privacy.policy.preview' => 'Predogled pravilnika o zasebnosti',
    'setting.section' => 'Oddelek',
    'setting.subsection' => 'Pododdelek',
    'setting.terms.of.service.preview' => 'Predogled pogojev storitve',
    ...
    'sticky.grid.header' => 'Glava lepljive mreže',
    'sticky.grid.header.hint' => 'Med pomikanjem ohrani glave stolpcev seznama računov pripete. Shrani se takoj – uveljavi se pri naslednjem nalaganju strani.',
    'sticky.navbar' => 'Lepljiva navigacijska vrstica',
    'sticky.navbar.hint' => 'Med pomikanjem po tej strani ohrani zgornjo navigacijsko vrstico pripeto. Shranjeno takoj – začne veljati pri naslednjem nalaganju strani.',
    'stop' => 'Ustavi se',
    ...
    'storecove.api.key' => 'Ključ API-ja',
    ...
    'taxes' => 'Davki',
    'taxrate.peppol.tax.rate.code.hint' => 'Shranjevanje te davčne stopnje ni obvezno, vendar je obvezno (koda UNCL5305, npr. S/Z/E/AE) v trenutku, ko je račun s to davčno stopnjo poslan prek Peppola – nastavite ga zdaj, če bo ta stopnja kdaj uporabljena na računu Peppol.',
    'taxrate.peppol.tax.rate.code.missing' => 'Ni nastavljeno',
    'telegram' => 'Telegram',
    ...
    'two.factor.authentication.use.backup.code' => 'Namesto tega uporabite 8-mestno varnostno kodo za obnovitev',
    'type' => 'Vrsta',
