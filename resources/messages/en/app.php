...
prior to importing and no existing documents e.g. Invoices.',
  ...
  'bookkeeping.frontaccounting.bank.account' => 'Bank account id that receives payments',
  'bookkeeping.frontaccounting.stock.id' => 'Sales item (stock id) that invoice net amounts post against',
  'bookkeeping.frontaccounting.vat.stock.id' => 'VAT item (stock id) whose sales account is your VAT liability account (optional)',
  'bookkeeping.frontaccounting.tax.group' => 'Zero-rated tax group id for new customers',
  'bookkeeping.frontaccounting.sales.type' => 'Sales type id (default 1)',
  'bookkeeping.frontaccounting.payment.terms' => 'Credit payment terms id (default 3)',
