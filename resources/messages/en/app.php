...
return [
  ...
  'due.date' => 'Due Date',
  'dwelling' => 'Dwelling',
  'dwelling.add' => 'Add Dwelling',
  'dwelling.edit' => 'Edit Dwelling',
  'dwelling.family' => 'Street',
  'dwelling.flat.unit' => 'Flat / Unit',
  'dwelling.house.number' => 'House Number',
  'dwelling.house.number.suffix' => 'House Number Suffix',
  'dwelling.latitude' => 'Latitude',
  'dwelling.longitude' => 'Longitude',
  'dwelling.plural' => 'Dwellings',
  'dwelling.postcode' => 'Postcode',
  'dwelling.source' => 'Source',
  'dwelling.view' => 'View Dwelling',
  ...
  'gateway.online.payment' =>
    'Online Payment',
  'gateway.status.page.summary' => 'Page %d of %d',
  'gender' => 'Gender',
...
prior to importing and no existing documents e.g. Invoices.',
  ...
  'purchase.entry.tax.year.not.configured' => 'VAT quarter grouping is unavailable: Tax Year Start (year, month, day) is not fully configured. Use the breadcrumb links below to set it.',
  'purchase.entry.tax.year.locale.applied' => 'Tax year start date applied. You can now group purchase entries by VAT quarter.',
  'purchase.entry.tax.year.locale.invalid' => 'Invalid month or day value. Please select a valid locale.',
  ...
  'off' => 'Off',
  'on' => 'On',
  'bookkeeping.provider' => 'Bookkeeping provider',
  'bookkeeping.provider.hint' => 'Where the export sends your ledger entries. Save the settings after changing it.',
  'bookkeeping.provider.active' => 'Active',
  'bookkeeping.frontaccounting.base.url' => 'API base URL (e.g. https://your-server/frontaccounting/modules/api)',
  'bookkeeping.frontaccounting.base.url.hint' => 'Use https:// for a live server. For a local trial use http://localhost/... (not 127.0.0.1) so FrontAccounting allows plain HTTP.',
  'bookkeeping.frontaccounting.company' => 'Company number (X-COMPANY, usually 0)',
  'bookkeeping.frontaccounting.username' => 'FrontAccounting user',
  'bookkeeping.frontaccounting.password' => 'FrontAccounting password',
  'bookkeeping.frontaccounting.bank.account' => 'Bank account that receives payments',
  'bookkeeping.frontaccounting.stock.id' => 'Sales item that invoice net amounts post against',
  'bookkeeping.frontaccounting.vat.stock.id' => 'VAT item whose sales account is your VAT liability account (optional)',
  'bookkeeping.frontaccounting.tax.group' => 'Zero-rated tax group for new customers',
  'bookkeeping.frontaccounting.sales.type' => 'Sales type id (default 1)',
  'bookkeeping.frontaccounting.payment.terms' => 'Credit payment terms',
  'bookkeeping.frontaccounting.location' => 'Stock location code (default DEF)',
  'bookkeeping.frontaccounting.lookup.not.synced' => 'Not synced yet -- click "Refresh FrontAccounting lists" below, or enter the id directly.',
  'bookkeeping.frontaccounting.lookup.sync.now' => 'Refresh FrontAccounting lists',
  'bookkeeping.frontaccounting.lookup.sync.hint' => 'Fetches current tax groups, sales items, bank accounts and payment terms from FrontAccounting so the fields below can be picked from a list.',
  'bookkeeping.frontaccounting.lookup.sync.summary' => 'FrontAccounting lists refreshed: %d entries synced.',
  'bookkeeping.export.now' => 'Export now',
  'bookkeeping.export.hint' => 'Syncs the ledger from your invoices, then sends anything not yet exported to QuickBooks.',
  'bookkeeping.export.summary' => 'Bookkeeping export finished: %d exported, %d failed.',
  'bookkeeping.quickbooks.account.accounts.receivable' => 'Accounts Receivable Account Id',
  'bookkeeping.quickbooks.account.bank' => 'Bank Account Id',
  'bookkeeping.quickbooks.account.payment.fees' => 'Payment Fees Account Id',
  'bookkeeping.quickbooks.account.sales' => 'Sales Account Id',
  'bookkeeping.quickbooks.account.vat.or.tax' => 'VAT/Sales Tax Account Id',
  'bookkeeping.quickbooks.client.id' => 'Client ID',
  'bookkeeping.quickbooks.client.secret' => 'Client Secret',
  'bookkeeping.quickbooks.connect' => 'Connect to QuickBooks',
  'bookkeeping.quickbooks.connect.cancelled' => 'QuickBooks connection was cancelled or rejected.',
  'bookkeeping.quickbooks.connect.hint' =>
    'Redirects to QuickBooks to authorise this app — Client ID/Secret below must be'
    . ' saved first.',
  'bookkeeping.quickbooks.connect.invalid.state' => 'QuickBooks connection failed: invalid state parameter.',
  'bookkeeping.quickbooks.connect.success' => 'Connected to QuickBooks.',
  'bookkeeping.quickbooks.connect.unexpected.response' => 'QuickBooks returned an unexpected response.',
  'bookkeeping.quickbooks.connected' => 'Connected',
  'bookkeeping.quickbooks.not.configured' => 'QuickBooks Client ID/Secret are not configured.',
  'bookkeeping.quickbooks.not.connected' => 'Not connected',
  'bookkeeping.quickbooks.sandbox' => 'Sandbox (uses sandbox-quickbooks.api.intuit.com)',
  'online.bookkeeping' => 'Online Bookkeeping',
  ...
  'online.payment.find.here' => 'Find it here →',
  'online.payment.get.credentials' => 'Get credentials →',
  'online.payment.installationId' => 'Installation Id',
  'online.payment.keyId' => 'Key ID',
  'online.payment.keySecret' => 'Key Secret',
  'online.payment.locationId' => 'Location ID',
  'online.payment.login' => 'Merchant Login',
  ...
  'online.payment.password1' => 'Password #1',
  'online.payment.password2' => 'Password #2',
  'online.payment.password3' => 'Password #3 (Refund API, optional)',
  ...
  'online.payment.posToken' => 'POS Token',
  ...
  'online.payment.signingKid' => 'Signing Key Id (kid)',
  ...
  'rejected' => 'Rejected',
  'remember.me.days' => 'Remember Me Duration (Days)',
  ...
  'sticky.navbar.hint' => 'Keeps the top navbar pinned in place while you scroll this page. Saved immediately — takes effect on your next page load.',
  'sticky.grid.header' => 'Sticky Grid Header',
  'sticky.grid.header.hint' => 'Keeps the invoice list\'s column headers pinned in place while you scroll. Saved immediately — takes effect on your next page load.',
  'stop' => 'Stop',
  ...
  'system.updates.check.failed' => 'PHP version check failed',
  'system.updates.check.now' => 'Check Now',
  'system.updates.current.version' => 'Current PHP Version',
  'system.updates.last.checked' => 'Last Checked',
  'system.updates.latest.version' => 'Latest PHP Version',
  'system.updates.never.checked' => 'Never checked',
  'system.updates.outdated' => 'A newer PHP version is available',
  'system.updates.security.release' => 'Security Release',
  'system.updates.select.platform' => 'Select your platform to see update instructions',
  'system.updates.up.to.date' => 'PHP is up to date',
  'system.updates.update.instructions' => 'Update Instructions',
  'table' => 'Table',
  'task' => 'Task',
  'task.add' => 'Task Add',
  ...
  'two.factor.authentication.use.backup.code' =>
    'Use 8-character backup recovery code instead',
  'type' => 'Type',
  ...
  'homecare.hidden.columns.guest' => 'inv/guest Columns — HomeCare Mode',
  'homecare.hidden.columns.guest.description' => 'Hide these columns on the guest-facing invoice grid (inv/guest) while Home Care QR Auto-Invoice is enabled. Number, PDF downloads, and Status always stay visible. The general guest grid is unaffected while Home Care QR Auto-Invoice is off.',
  'homecare.vision.api.key.title' => 'Run Sheet Vision Scan',
  'homecare.vision.api.key.description' => 'Required for the "Upload & Read" step on a HomeCare run sheet\'s review screen, which reads a scanned run sheet\'s hand-written annotations via Claude Haiku 4.5 vision. Leave blank to disable that step.',
  'homecare.vision.api.key' => 'Anthropic API Key',
  'homecare.vision.api.key.get' => 'Get API Key ↗',
  'homecare.runsheet.nav' => 'Run Sheets',
  'homecare.runsheet.index.title' => 'HomeCare Run Sheets',
  'homecare.runsheet.index.description' => 'Export today\'s (or a past) run as a printable sheet, then come back here once it\'s been signed and scanned.',
  'homecare.runsheet.index.run.date' => 'Run Date',
  'homecare.runsheet.index.export' => 'Export Run Sheet',
  'homecare.runsheet.index.export.invalid' => 'Choose a run and a valid date before exporting.',
  'homecare.runsheet.index.recent' => 'Recent Run Sheets',
  'homecare.runsheet.index.items' => 'Items',
  'homecare.runsheet.review.title' => 'HomeCare Run Sheet — Review Adjustments',
  'homecare.runsheet.review.download' => 'Download Run Sheet (CSV)',
  'homecare.runsheet.review.upload.label' => 'Upload the scanned/photographed run sheet',
  'homecare.runsheet.review.upload.button' => 'Upload & Read',
  'homecare.runsheet.review.upload.invalid' => 'Choose an image file (JPEG, PNG, GIF, or WebP) to upload.',
  'homecare.runsheet.review.upload.done' => 'Scan uploaded and read — review the detected adjustments below.',
  'homecare.runsheet.review.upload.not.configured' => 'The vision API key is not configured yet — ask an administrator to set it in Settings before uploading a scan.',
  'homecare.runsheet.review.upload.api.failed' => 'The vision read failed — check the Anthropic account\'s API key and billing balance in Settings, then try again. The scan file was saved; this run sheet can be retried.',
  'homecare.runsheet.review.description' => 'Only invoices where the scanned run sheet\'s hand-written annotations differ from what was printed are listed here — confirm each one before it is applied back onto the invoice list.',
  'homecare.runsheet.review.no.changes' => 'No changes were detected on this run sheet — nothing to review.',
  'homecare.runsheet.review.accept' => 'Accept',
  'homecare.runsheet.review.invoice' => 'Invoice',
  'homecare.runsheet.review.client' => 'Client',
  'homecare.runsheet.review.expected.worker' => 'Expected Worker',
  'homecare.runsheet.review.detected.worker' => 'Detected Worker',
  'homecare.runsheet.review.completed' => 'Completed',
  'homecare.runsheet.review.reason' => 'Reason',
  'homecare.runsheet.review.save' => 'Save Adjustments',
  'homecare.runsheet.review.saved' => 'Adjustments saved.',
  'homecare.runsheet.review.status' => 'Status',
  'homecare.runsheet.review.apply' => 'Apply & Mark Run Sent',
  'homecare.runsheet.review.apply.description' => 'Writes every accepted adjustment above onto its invoice, then marks every invoice in this run as sent so it appears on the customer\'s side. This cannot be undone from this screen.',
  'homecare.runsheet.review.apply.not.ready' => 'This run sheet cannot be applied right now — it may already have been applied, or the scan hasn\'t been read yet.',
  'homecare.runsheet.review.applied' => 'Run sheet applied — invoices updated and the run marked sent.',
  'homecare.visit.log.title' => 'HomeCare QR Scan Log',
  'homecare.visit.log.description' => 'Every homecare-cleaning QR scan attempt and its outcome, for staff visibility only — the customer-facing scan result page is deliberately generic and never shows this level of detail.',
  'homecare.visit.log.visited.at' => 'Visited',
  'homecare.visit.log.outcome' => 'Outcome',
  'homecare.visit.log.invoice' => 'Invoice',
  'homecare.visit.log.reason' => 'Reason (staff only)',
  'homecare.visit.log.sent.status' => 'Sent Status',
  'homecare.visit.log.sent.status.tooltip' => 'HomeCare auto-invoices are always created with status \'Sent\', regardless of the \'Mark invoice as sent when copying an invoice\' setting — that setting only applies to other invoice-copying tools. Tap/click to open it.',
  ...
  'homecare.offline.title' => 'My Offline Invoices',
  'homecare.offline.download.button' => '📥 Download for Offline',
  'homecare.offline.view.button' => '📱 View Offline Copy',
  'homecare.offline.download.success' => 'Downloaded %s invoice(s) for offline use.',
  'homecare.offline.download.failed' => 'Unable to download invoices for offline use — please try again while connected.',
  'homecare.offline.empty' => 'No invoices downloaded yet. Connect to the internet and tap "Download for Offline" from your invoice list first.',
  'homecare.offline.downloaded.at' => 'Downloaded',
  'homecare.offline.install.ios.message' => 'For offline access that survives more than a few days without a visit, tap Share, then "Add to Home Screen".',
  'homecare.offline.install.generic.message' => 'Install this app for offline access that survives longer than a few days.',
  'homecare.offline.install.button' => '📲 Install app',
