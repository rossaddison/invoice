...
return [
    ...
    'home.caption.slide1' => '<p>Signup and Login as administrator. No internet ... ignore email error connection.</p>',
    'home.caption.slide2' => '<p>As administator, signup a user. Email account is legit & internet connection ... verify. User will get client account.</p>',
    'home.caption.slide3' => '<p>Email account not legit, & no internet connection ... admin log in and user\'s Invoice User Account make active under Settings. Create client account. Assign it to user</p>',
