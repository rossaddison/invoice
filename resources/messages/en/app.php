...
return [
    ...
    'invoice.platform.scrutinizer.config.checks.php' => 'Scrutinizer configuration checks for php',
    'invoice.platform.scrutinizer.config.checks.javascript' => 'Scrutinizer configuration checks for javscript',
    'invoice.platform.scrutinizer.config.build' => 'Scrutinizer Repository build. Selected second. Root file selected first.',
