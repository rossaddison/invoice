...
return [
    ...
    'as4.messages.log' => 'Wiadomości AS4',
    ...
    'body' => 'Ciało',
    'bookkeeping.export.hint' => 'Synchronizuje księgę rachunkową z fakturami, a następnie wysyła wszystko, co nie zostało jeszcze wyeksportowane do QuickBooks.',
    'bookkeeping.export.now' => 'Eksportuj teraz',
    'bookkeeping.export.summary' => 'Zakończono eksport księgowości: wyeksportowano %d, nie udało się %d.',
    'bookkeeping.quickbooks.account.accounts.receivable' => 'Identyfikator konta należności',
    'bookkeeping.quickbooks.account.bank' => 'Identyfikator konta bankowego',
    'bookkeeping.quickbooks.account.payment.fees' => 'Opłaty za płatności Identyfikator konta',
    'bookkeeping.quickbooks.account.sales' => 'Identyfikator konta sprzedaży',
    'bookkeeping.quickbooks.account.vat.or.tax' => 'Identyfikator konta VAT/podatku od sprzedaży',
    'bookkeeping.quickbooks.client.id' => 'Identyfikator klienta',
    'bookkeeping.quickbooks.client.secret' => 'Tajemnica klienta',
    'bookkeeping.quickbooks.connect' => 'Połącz się z QuickBooks',
    'bookkeeping.quickbooks.connect.cancelled' => 'Połączenie z QuickBooks zostało anulowane lub odrzucone.',
    'bookkeeping.quickbooks.connect.hint' => 'Przekierowuje do QuickBooks w celu autoryzacji tej aplikacji — najpierw należy zapisać poniższy identyfikator klienta/klucz tajny.',
    'bookkeeping.quickbooks.connect.invalid.state' => 'Połączenie z QuickBooks nie powiodło się: nieprawidłowy parametr stanu.',
    'bookkeeping.quickbooks.connect.success' => 'Połączono z QuickBooks.',
    'bookkeeping.quickbooks.connect.unexpected.response' => 'QuickBooks zwrócił nieoczekiwaną odpowiedź.',
    'bookkeeping.quickbooks.connected' => 'Połączony',
    'bookkeeping.quickbooks.not.configured' => 'Identyfikator/tajemnica klienta QuickBooks nie są skonfigurowane.',
    'bookkeeping.quickbooks.not.connected' => 'Nie połączony',
    'bookkeeping.quickbooks.sandbox' => 'Sandbox (używa sandbox-quickbooks.api.intuit.com)',
    ...
    'bootstrap5.calendar.accent.color' => 'Kolor akcentu kalendarza',
    ...
    'bootstrap5.layout.invoice.navbar.sticky.hint' => 'Utrzymuje górny pasek nawigacyjny w miejscu, gdy strona przewija się pod nim. Zapisany natychmiast — efekt widoczny po załadowaniu następnej strony.',
    ...
    'client.postaladdress.add.save.first' => 'Najpierw zapisz tego klienta, a następnie dodaj adres pocztowy',
    ...
    'debug.reset.tree.confirm' => 'Czy na pewno chcesz kontynuować?',
    'debug.reset.tree.confirm.button' => 'Upuść i odbuduj',
    'debug.reset.tree.db.password' => 'Hasło bazy danych',
    'debug.reset.tree.done' => 'Tabele Inv, Quote i SalesOrder zostały usunięte i utworzone ponownie',
    'debug.reset.tree.failed' => 'Resetowanie nie powiodło się, nic innego nie zostało zmienione',
    'debug.reset.tree.menu' => 'Resetuj fakturę/ofertę/zamówienie sprzedaży',
    'debug.reset.tree.tables.heading' => 'Następujące tabele zostaną usunięte i utworzone ponownie jako puste:',
    'debug.reset.tree.title' => 'Zresetuj fakturę, ofertę i zamówienie sprzedaży',
    'debug.reset.tree.warning' => 'Spowoduje to trwałe usunięcie każdej faktury, oferty i zamówienia sprzedaży wraz ze wszystkimi ich pozycjami, kwotami, stawkami podatku, polami niestandardowymi i opłatami za zniżkę. Kopia zapasowa skompresowana w formacie gzip jest najpierw zapisywana w katalogu /backups, ale tej operacji nie można cofnąć z tego ekranu.',
    'debug.reset.tree.wrong.password' => 'Nieprawidłowe hasło do bazy danych, nic nie zostało zmienione',
    ...
    'grid.sticky.header.hint' => 'Utrzymuje nagłówki kolumn przypięte do góry podczas przewijania długiej listy faktur, ofert, zamówień sprzedaży lub produktów. Zapisywane natychmiast — efekt widoczny po przejściu na listę.',
    'gridview.api' => 'API',
    ...
    'home.peppol.access.point.status' => 'Status punktu dostępowego Peppol ➡️',
    ...
    'invoice.status.cannot.revert' => 'Wystawionej faktury nie można cofnąć do wcześniejszego statusu. Anuluj ją (jeśli nie została opłacona) lub wystaw notę ​​kredytową.',
    'invoice.status.issued' => 'Wydany',
    'invoice.status.void' => 'Próżnia',
    'invoice.to.html' => 'Faktura do HTML',
    'invoice.trash' => 'Kosz na faktury',
    'invoice.validation.errors' => 'Błędy walidacji faktur',
    'invoice.void' => 'Nieważna faktura',
    'invoice.void.confirm' => 'Unieważnić tę fakturę? Zostanie anulowana, zachowa swój numer i nie będzie można jej edytować ani opłacić.',
    'invoice.void.not.allowed' => 'Tylko wystawiona lub wyświetlona faktura bez płatności może zostać anulowana. Zamiast tego wystaw notę ​​kredytową.',
    'invoice.void.selected.confirm' => 'Anulować wybrane faktury? Anulowane zostaną tylko faktury wystawione lub wyświetlone bez płatności; zachowują one swoje numery i nie można ich już edytować.',
    'invoice.void.success' => 'Faktura została anulowana.',
    ...
    'menu.more' => 'Więcej',
    'menu.peppol.status' => 'Status punktu dostępu Peppol',
    'menu.pricing' => 'Wycena',
    ...
    'mtd.business.missing.nino.or.token' => 'Numer ubezpieczenia społecznego lub token dostępu HMRC nie został ustawiony',
    'mtd.eori' => 'Numer Rejestracji i Identyfikacji Podmiotów Gospodarczych (EORI)',
    'mtd.eori.hint' => 'Wymagane do identyfikacji tej firmy w interfejsie API deklaracji celnych HMRC, np. GB123456789000',
    ...
    'mtd.fph.feedback.client.credentials.error' => 'HMRC odrzuciło wniosek o token dostępu z ograniczeniami aplikacji: „{error}” — {description}',
    'mtd.fph.feedback.no.client.credentials.token' => 'Zmienna DEVELOPER_GOV_SANDBOX_HMRC_API_CLIENT_ID lub _CLIENT_SECRET nie jest ustawiona w .env — FPH Feedback potrzebuje własnego tokenu dostępu do ograniczonych aplikacji od HMRC, oddzielnego od tokenu używanego przez każdą inną stronę HMRC tutaj.',
    'mtd.fph.feedback.unexpected.token.response' => 'HMRC zwróciło wartość 200 w odpowiedzi na żądanie tokenu dostępu ograniczonego do aplikacji, ale w treści odpowiedzi nie było access_tokenu.',
    'mtd.fph.generate' => 'Spowodować',
    'mtd.fph.manage.subscriptions.link.text' => 'dodaj to tutaj',
    'mtd.fph.missing.hmrc.token' => 'Nie jesteś zalogowany w HMRC. {link}, spróbuj ponownie.',
    'mtd.fph.missing.otp.session' => 'Brakuje danych sesji uwierzytelniania dwuskładnikowego lub wygasły one, co jest wymagane do testów Fraud Prevention Headers. Wyloguj się i zaloguj ponownie, a następnie spróbuj ponownie.',
    ...
    'mtd.fph.validate.error.generic' => 'HMRC zwrócił błąd podczas weryfikacji nagłówków zapobiegania oszustwom: „{code}” — {message}',
    'mtd.fph.validate.error.not.subscribed' => 'HMRC zwróciło „{code}”: {message} Do Twojej aplikacji Developer Hub należy dodać interfejs API Test Fraud Prevention Headers w ramach subskrypcji — {link}.',
    ...
    'mtd.hmrc.developer.hub' => 'Centrum programistów HMRC',
    'mtd.hmrc.developer.hub.add.production.application' => 'Dodaj aplikację produkcyjną',
    'mtd.hmrc.developer.hub.add.sandbox.application' => 'Dodaj aplikację sandbox',
    'mtd.hmrc.developer.hub.application.id' => 'Identyfikator aplikacji Centrum programistycznego',
    'mtd.hmrc.developer.hub.application.id.not.set' => 'Nie ustawiono — dodaj DEVELOPER_GOV_SANDBOX_HMRC_API_APPLICATION_ID do pliku .env (identyfikator UUID z adresu URL „Zarządzaj aplikacją” w Centrum programistów, a nie identyfikator klienta OAuth)',
    'mtd.hmrc.developer.hub.change.name.and.description' => 'Zmień nazwę i opis',
    'mtd.hmrc.developer.hub.change.password' => 'Zmień hasło',
    'mtd.hmrc.developer.hub.client.secrets' => 'Tajemnice klienta',
    'mtd.hmrc.developer.hub.delete.application' => 'Usuń aplikację',
    'mtd.hmrc.developer.hub.email.preferences' => 'Preferencje e-mailowe',
    'mtd.hmrc.developer.hub.ip.allowlist' => 'Lista dozwolonych adresów IP',
    'mtd.hmrc.developer.hub.login' => 'Zaloguj się',
    'mtd.hmrc.developer.hub.logout' => 'Wyloguj się',
    'mtd.hmrc.developer.hub.manage.application' => 'Zarządzaj aplikacją',
    'mtd.hmrc.developer.hub.profile' => 'Profil',
    'mtd.hmrc.developer.hub.redirect.uris' => 'Przekieruj URI',
    'mtd.hmrc.developer.hub.security.preferences' => 'Preferencje bezpieczeństwa',
    'mtd.hmrc.developer.hub.subscriptions' => 'Subskrypcje',
    'mtd.hmrc.developer.hub.tc.and.privacy.policy.url' => 'Regulamin / polityka prywatności URL',
    'mtd.hmrc.developer.hub.team.members' => 'Członkowie zespołu',
    'mtd.individual.calculations.trigger.error' => 'HMRC zwrócił błąd uruchamiający obliczenia: „{code}” — {message}',
    'mtd.individual.calculations.triggered' => 'Wyzwolono obliczenie (ID: {calculationId}).',
    'mtd.nino' => 'Numer ubezpieczenia społecznego (NINO)',
    'mtd.nino.hint' => 'Wymagane dla każdego interfejsu API opartego na numerze NINO poniżej (działalność na własny rachunek, dane firmy itp.) — w przypadku piaskownicy HMRC należy użyć numeru NINO zwróconego przez opcję Utwórz użytkownika testowego, a nie własnego prawdziwego numeru NINO',
    ...
    'mtd.vat.return.error.client_or_agent_not_authorised' => 'To konto nie jest upoważnione do składania deklaracji VAT dla tego numeru VRN.',
    'mtd.vat.return.error.duplicate_submission' => 'Za ten okres złożono już deklarację VAT.',
    'mtd.vat.return.error.invalid_monetary_amount' => 'Jedna z podanych kwot nie jest prawidłową wartością pieniężną (od 0 do 99 999 999 999,99, do dwóch miejsc po przecinku).',
    'mtd.vat.return.error.invalid_numeric_value' => 'Jedna z przesłanych wartości nie jest prawidłową liczbą.',
    'mtd.vat.return.error.invalid_request' => 'HMRC odrzuciło ten wniosek z uwagi na jego błędny format.',
    'mtd.vat.return.error.not_finalised' => 'Ten zwrot nie został uznany za ostateczny — zaznacz pole wyboru deklaracji i prześlij ponownie.',
    'mtd.vat.return.error.period_key_invalid' => 'Klucz okresu dla tej deklaracji VAT jest nieprawidłowy lub nierozpoznany.',
    'mtd.vat.return.error.rule_insolvent_trader' => 'Z rejestrów HMRC wynika, że ​​przedsiębiorca ten jest niewypłacalny, dlatego zwrotów nie można przyjąć.',
    'mtd.vat.return.error.tax_period_not_ended' => 'Ten okres podatkowy jeszcze się nie zakończył — HMRC nie może przyjąć zeznania przed jego zakończeniem.',
    'mtd.vat.return.error.vat_net_value' => 'Pole 5 (należny podatek VAT netto) musi być równe różnicy pomiędzy polem 3 i polem 4.',
    'mtd.vat.return.error.vat_total_value' => 'Pole 3 (Całkowita kwota należnego podatku VAT) musi być równe polu 1 + polu 2.',
    'mtd.vat.return.error.vrn_invalid' => 'Podany numer VAT jest nieprawidłowy.',
    ...
    'off' => 'Wyłączony',
    'on' => 'NA',
    'online.bookkeeping' => 'Księgowość online',
    ...
    'online.payment.bitpay.generic.complete.message' => 'Twoja płatność BitPay jest przetwarzana. Faktura zostanie automatycznie zaktualizowana po potwierdzeniu jej przez BitPay w łańcuchu — sprawdź bezpośrednio swoją fakturę, aby poznać jej aktualny status.',
    ...
    'online.payment.payment.processing.generic' => 'Dziękuję',
    ...
    'peppol.buyer.postal.address.not.found.fix' => 'Napraw to teraz',
    ...
    'peppol.messages.log' => 'Wiadomości Peppol',
    ...
    'product.peppol.unit.hint' => 'Nie jest wymagane do zapisania tego produktu, ale jest wymagane w momencie wysłania faktury z tym produktem za pośrednictwem Peppol — musi to być rekord UnitPeppol dla tej samej jednostki wybranej powyżej, a nie dowolny rekord UnitPeppol. Ustaw to teraz, jeśli ten produkt ma zostać kiedykolwiek użyty na fakturze Peppol.',
    'product.peppol.unit.missing' => 'Nie ustawiono',
    'product.price' => 'Cena',
    ...
    'rejected' => 'Odrzucony',
    'remember.me.days' => 'Czas trwania opcji „Zapamiętaj mnie” (dni)',
    ...
    'run.sheet.pdf' => 'Arkusz przebiegu (PDF)',
    'run.sheet.pdf.tooltip' => 'Pobierz plik PDF każdej faktury wyświetlanej aktualnie przez wybrane filtry, a adres podaj jako klikalny link do Map Google — może się przydać w przypadku sprzątania w HomeCare lub w przypadku innych list faktur, które musisz przejrzeć lub sprawdzić w trybie offline.',
    'sales' => 'Obroty',
    ...
    'setting.arbitration.details.note' => 'Pola Organ arbitrażowy i Jurysdykcja arbitrażowa używane w sekcjach Rozstrzyganie sporów i Prawo właściwe są również ustawiane na stronie Firma.',
    ...
    'setting.company.details.note' => 'Nazwą firmy, danymi kontaktowymi i adresem widocznymi na tej stronie można zarządzać na stronie Firma.',
    ...
    'setting.hide.from.front.page' => 'Ukryj na stronie głównej',
    'setting.key' => 'Ustawienie klucza',
    'setting.privacy.policy.preview' => 'Podgląd Polityki prywatności',
    'setting.section' => 'Sekcja',
    'setting.subsection' => 'Podrozdział',
    'setting.terms.of.service.preview' => 'Podgląd Warunków korzystania z usługi',
    ...
    'sticky.grid.header.hint' => 'Utrzymuje nagłówki kolumn listy faktur w miejscu podczas przewijania. Zapisane natychmiast — zmiany zostaną zastosowane po załadowaniu następnej strony.',
    'sticky.navbar' => 'Sticky Navbar',
    'sticky.navbar.hint' => 'Utrzymuje górny pasek nawigacyjny w miejscu podczas przewijania tej strony. Zapisano natychmiast — zmiana zostanie wprowadzona po załadowaniu następnej strony.',
    ...
    'two.factor.authentication.use.backup.code' => 'Zamiast tego użyj 8-cyfrowego kodu odzyskiwania kopii zapasowej',
    'type' => 'Typ',
