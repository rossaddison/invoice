...
return [
    ...
    'as4.messages.log' => 'Сообщения AS4',
    ...
    'body' => 'Тело',
    'bookkeeping.export.hint' => 'Синхронизирует бухгалтерские записи из ваших счетов-фактур, а затем отправляет в QuickBooks все данные, которые еще не были экспортированы.',
    'bookkeeping.export.now' => 'Экспорт сейчас',
    'bookkeeping.export.summary' => 'Экспорт бухгалтерских данных завершен: %d экспортирован, %d не удалось.',
    'bookkeeping.quickbooks.account.accounts.receivable' => 'Идентификатор счета дебиторской задолженности',
    'bookkeeping.quickbooks.account.bank' => 'Идентификатор банковского счета',
    'bookkeeping.quickbooks.account.payment.fees' => 'Платежные комиссии. Идентификатор счета.',
    'bookkeeping.quickbooks.account.sales' => 'Идентификатор учетной записи продавца',
    'bookkeeping.quickbooks.account.vat.or.tax' => 'Идентификатор счета НДС/налога с продаж',
    'bookkeeping.quickbooks.client.id' => 'Идентификатор клиента',
    'bookkeeping.quickbooks.client.secret' => 'Секрет клиента',
    'bookkeeping.quickbooks.connect' => 'Подключиться к QuickBooks',
    'bookkeeping.quickbooks.connect.cancelled' => 'Подключение к QuickBooks было отменено или отклонено.',
    'bookkeeping.quickbooks.connect.hint' => 'Для авторизации этого приложения будет выполнено перенаправление на QuickBooks — предварительно необходимо сохранить указанный ниже идентификатор клиента/секретный ключ.',
    'bookkeeping.quickbooks.connect.invalid.state' => 'Сбой подключения к QuickBooks: недопустимый параметр состояния.',
    'bookkeeping.quickbooks.connect.success' => 'Подключено к QuickBooks.',
    'bookkeeping.quickbooks.connect.unexpected.response' => 'QuickBooks выдал неожиданный ответ.',
    'bookkeeping.quickbooks.connected' => 'Подключено',
    'bookkeeping.quickbooks.not.configured' => 'Идентификатор/секрет клиента QuickBooks не настроены.',
    'bookkeeping.quickbooks.not.connected' => 'Не подключено',
    'bookkeeping.quickbooks.sandbox' => 'Песочница (использует sandbox-quickbooks.api.intuit.com)',
    'boolean' => 'Булев',
    ...
    'bootstrap5.calendar.accent.color' => 'Дополнительный цвет календаря',
    ...
    'bootstrap5.layout.invoice.navbar.sticky' => 'Фиксированная панель навигации',
    'bootstrap5.layout.invoice.navbar.sticky.hint' => 'Фиксирует верхнюю панель навигации на месте, пока страница прокручивается под ней. Сохраняется немедленно — эффект виден при следующей загрузке страницы.',
    ...
    'client.postaladdress.add.save.first' => 'Сначала сохраните этого клиента, затем добавьте почтовый адрес.',
    ...
    'cookie.consent.accept' => 'Принимать',
    'cookie.consent.decline' => 'Отклонить',
    'cookie.consent.message' => 'Мы используем несколько необходимых файлов cookie, чтобы вы оставались авторизованными, запоминали ваш язык и защищали сайт от подделок. Мы не используем файлы cookie для рекламы или отслеживания.',
    'cookie.consent.preferences' => 'Настройки файлов cookie',
    'copied' => 'Скопировано!',
    'copy' => 'Копия',
    ...
    'debug.reset.tree.confirm' => 'Вы уверены, что хотите продолжить?',
    'debug.reset.tree.confirm.button' => 'Снять и собрать заново',
    'debug.reset.tree.db.password' => 'Пароль к базе данных',
    'debug.reset.tree.done' => 'Таблицы Inv, Quote и SalesOrder были удалены и созданы заново.',
    'debug.reset.tree.failed' => 'Сброс не удался, ничего больше не было изменено.',
    'debug.reset.tree.menu' => 'Сбросить счет/предложение/заказ на продажу',
    'debug.reset.tree.tables.heading' => 'Следующие таблицы будут удалены и созданы заново пустыми:',
    'debug.reset.tree.title' => 'Сбросить счета-фактуры, коммерческие предложения и заказы на продажу.',
    'debug.reset.tree.warning' => 'Это приведет к безвозвратному удалению всех счетов-фактур, коммерческих предложений и заказов на продажу, а также всех их позиций, сумм, налоговых ставок, пользовательских полей и скидочных платежей. Сначала создается сжатая резервная копия в папку /backups, но отменить это действие с этого экрана невозможно.',
    'debug.reset.tree.wrong.password' => 'Неверный пароль к базе данных, ничего не было изменено.',
    ...
    'grid.sticky.header' => 'Фиксированный заголовок сетки',
    'grid.sticky.header.hint' => 'Сохраняет заголовки столбцов в верхней части списка при прокрутке длинного списка счетов-фактур, коммерческих предложений, заказов на продажу или товаров. Сохраняется немедленно — эффект виден при переходе к следующему элементу списка.',
    'gridview.api' => 'API',
    ...
    'home.hmrc.api.status' => 'Статус API HMRC ➡️',
    ...
    'home.peppol.access.point.status' => 'Статус точки доступа Peppol ➡️',
    ...
    'invoice.status.cannot.revert' => 'Выставленный счет-фактура не может быть возвращен в прежнее состояние. Его следует аннулировать (если он не оплачен) или выставить кредитное извещение.',
    'invoice.status.issued' => 'Изданный',
    ...
    'invoice.void' => 'Аннулированный счет-фактура',
    'invoice.void.confirm' => 'Аннулировать этот счет? Он будет отменен, сохранит свой номер и больше не сможет быть отредактирован или оплачен.',
    'invoice.void.not.allowed' => 'Аннулировать можно только выставленный или просмотренный счет-фактуру, по которому не произведены платежи. Вместо этого следует выставить кредитное извещение.',
    'invoice.void.selected.confirm' => 'Аннулировать выбранные счета-фактуры? Аннулированию подлежат только выставленные или просмотренные счета-фактуры без оплаты; их номера сохраняются, и их больше нельзя редактировать.',
    'invoice.void.success' => 'Счет-фактура аннулирован.',
    ...
    'menu.hmrc.api.status' => 'Статус API HMRC',
    'menu.language' => 'Язык',
    'menu.login' => 'Авторизоваться',
    'menu.logout' => 'Выйти ({login})',
    'menu.more' => 'Более',
    'menu.peppol.status' => 'Статус точки доступа Peppol',
    ...
    'mtd' => 'Цифровые налоги',
    'mtd.business.missing.nino.or.token' => 'Номер национального страхования или токен доступа HMRC не установлены.',
    'mtd.eori' => 'Регистрационный и идентификационный номер экономического оператора (EORI)',
    'mtd.eori.hint' => 'Необходимо идентифицировать это предприятие в API таможенных деклараций HMRC — например, GB123456789000.',
    'mtd.fph' => 'Заголовки предотвращения мошенничества',
    'mtd.fph.all.valid' => 'Все заголовки предотвращения мошенничества действительны',
    'mtd.fph.feedback.client.credentials.error' => 'Налоговая служба Великобритании (HMRC) отклонила запрос на получение токена доступа с ограниченным доступом для приложения: "{error}" — {description}',
    'mtd.fph.feedback.no.client.credentials.token' => 'Параметр DEVELOPER_GOV_SANDBOX_HMRC_API_CLIENT_ID или _CLIENT_SECRET не задан в файле .env — для работы с обратной связью FPH требуется собственный токен доступа к приложению от HMRC, отдельный от токена, используемого на всех остальных страницах HMRC здесь.',
    'mtd.fph.feedback.unexpected.token.response' => 'Налоговая служба Великобритании (HMRC) вернула код 200 для запроса токена доступа, ограниченного для конкретного приложения, но в теле ответа отсутствовал access_token.',
    'mtd.fph.generate' => 'Генерировать',
    'mtd.fph.manage.subscriptions.link.text' => 'добавьте это сюда',
    'mtd.fph.missing.hmrc.token' => 'Вы не вошли в систему HMRC. {ссылка}, попробуйте еще раз.',
    'mtd.fph.missing.otp.session' => 'Данные вашей двухфакторной аутентификации отсутствуют или устарели, что необходимо для тестирования заголовков предотвращения мошенничества. Выйдите из системы и войдите снова, затем попробуйте еще раз.',
    ...
    'mtd.fph.validate.error.generic' => 'Налоговая служба Великобритании (HMRC) вернула ошибку при проверке ваших заголовков предотвращения мошенничества: "{code}" — {message}',
    'mtd.fph.validate.error.not.subscribed' => 'HMRC вернула "{code}": {message} Вашему приложению Developer Hub необходимо добавить API Test Fraud Prevention Headers в раздел подписок — {link}.',
    ...
    'mtd.hmrc.developer.hub' => 'Центр разработчиков HMRC',
    'mtd.hmrc.developer.hub.add.production.application' => 'Добавить производственное приложение',
    'mtd.hmrc.developer.hub.add.sandbox.application' => 'Добавить тестовое приложение',
    'mtd.hmrc.developer.hub.application.id' => 'Идентификатор приложения в Центре разработчиков',
    'mtd.hmrc.developer.hub.application.id.not.set' => 'Не задано — добавьте DEVELOPER_GOV_SANDBOX_HMRC_API_APPLICATION_ID в .env (UUID из собственного URL-адреса «Управление приложением» в Developer Hub, а не client_id OAuth).',
    'mtd.hmrc.developer.hub.change.name.and.description' => 'Изменить название и описание',
    'mtd.hmrc.developer.hub.change.password' => 'Изменить пароль',
    'mtd.hmrc.developer.hub.client.secrets' => 'Секреты клиента',
    'mtd.hmrc.developer.hub.delete.application' => 'Удалить приложение',
    'mtd.hmrc.developer.hub.email.preferences' => 'Настройки электронной почты',
    'mtd.hmrc.developer.hub.ip.allowlist' => 'Список разрешенных IP-адресов',
    'mtd.hmrc.developer.hub.login' => 'Авторизоваться',
    'mtd.hmrc.developer.hub.logout' => 'Выйти',
    'mtd.hmrc.developer.hub.manage.application' => 'Управление приложением',
    'mtd.hmrc.developer.hub.profile' => 'Профиль',
    'mtd.hmrc.developer.hub.redirect.uris' => 'URI перенаправления',
    'mtd.hmrc.developer.hub.security.preferences' => 'Настройки безопасности',
    'mtd.hmrc.developer.hub.subscriptions' => 'Подписки',
    'mtd.hmrc.developer.hub.tc.and.privacy.policy.url' => 'Условия использования / URL политики конфиденциальности',
    'mtd.hmrc.developer.hub.team.members' => 'Члены команды',
    'mtd.individual.calculations.trigger.error' => 'Налоговая служба Великобритании (HMRC) вернула ошибку, запустившую расчет: "{code}" — {message}',
    'mtd.individual.calculations.triggered' => 'Вычисление запущено (ID: {calculationId}).',
    'mtd.nino' => 'Национальный страховой номер (NINO)',
    'mtd.nino.hint' => 'Необходим для каждого из перечисленных ниже API на основе NINO (самозанятость, сведения о бизнесе и т. д.) — для тестовой среды HMRC используйте NINO, возвращаемый функцией Create Test User, а не свой собственный реальный NINO.',
    ...
    'mtd.vat.return.error.client_or_agent_not_authorised' => 'Данная учетная запись не авторизована для подачи деклараций по НДС по этому регистрационному номеру.',
    'mtd.vat.return.error.duplicate_submission' => 'Декларация по НДС за этот период уже подана.',
    'mtd.vat.return.error.invalid_monetary_amount' => 'Одна из представленных сумм не является допустимым денежным значением (от 0 до 99 999 999 999,99, с точностью до двух знаков после запятой).',
    'mtd.vat.return.error.invalid_numeric_value' => 'Одно из представленных значений не является допустимым числом.',
    'mtd.vat.return.error.invalid_request' => 'Налоговая служба Великобритании (HMRC) отклонила этот запрос как некорректно оформленный.',
    'mtd.vat.return.error.not_finalised' => 'Данная декларация не была признана окончательной — поставьте галочку в поле «Заявление» и отправьте ее повторно.',
    'mtd.vat.return.error.period_key_invalid' => 'Ключ периода для данной декларации по НДС недействителен или не распознан.',
    'mtd.vat.return.error.rule_insolvent_trader' => 'Согласно данным налоговой службы Великобритании (HMRC), этот предприниматель неплатежеспособен, поэтому возврат денежных средств не принимается.',
    'mtd.vat.return.error.tax_period_not_ended' => 'Данный налоговый период еще не закончился — налоговая служба (HMRC) не может принять декларацию до его окончания.',
    'mtd.vat.return.error.vat_net_value' => 'Сумма в графе 5 (НДС к уплате) должна равняться разнице между суммой в графах 3 и 4.',
    'mtd.vat.return.error.vat_total_value' => 'Сумма в ячейке 3 (общая сумма НДС к уплате) должна равняться сумме в ячейке 1 + сумме в ячейке 2.',
    'mtd.vat.return.error.vrn_invalid' => 'Указанный регистрационный номер плательщика НДС недействителен.',
    ...
    'off' => 'Выключенный',
    'on' => 'На',
    'online.bookkeeping' => 'Онлайн-бухгалтерия',
    ...
    'online.payment.bitpay.generic.complete.message' => 'Ваш платеж через BitPay обрабатывается. Ваш счет-фактура обновится автоматически после подтверждения BitPay в блокчейне — пожалуйста, проверьте свой счет-фактуру напрямую, чтобы узнать актуальный статус.',
    ...
    'online.payment.payment.processing.generic' => 'Спасибо',
    ...
    'peppol.buyer.postal.address.not.found.fix' => 'Исправьте это сейчас же!',
    ...
    'peppol.messages.log' => 'Сообщения Пеппола',
    ...
    'product.peppol.unit.hint' => 'Сохранение этого товара не обязательно, но необходимо в момент отправки счета-фактуры с использованием этого товара через Peppol — это должна быть запись UnitPeppol для того же подразделения, которое было выбрано выше, а не любая запись UnitPeppol. Установите это сейчас, если этот товар когда-либо будет использоваться в счете-фактуре Peppol.',
    'product.peppol.unit.missing' => 'Не задано',
    'product.price' => 'Цена',
    ...
    'remember.me.days' => 'Продолжительность Remember Me (дни)',
    ...
    'run.sheet.pdf' => 'План выполнения работ (PDF)',
    'run.sheet.pdf.tooltip' => 'Загрузите PDF-файлы всех счетов-фактур, отображаемых в данный момент вашими фильтрами, указав в первую очередь адрес в виде кликабельной ссылки на Google Maps — это полезно для поиска информации о выезде клининговой компании HomeCare или для любого другого списка счетов-фактур, который вам необходимо просмотреть или использовать в автономном режиме.',
    'sales' => 'Продажи',
    ...
    'setting.arbitration.details.note' => 'Поля «Арбитражный орган» и «Арбитражная юрисдикция», используемые в разделах «Разрешение споров» и «Применимое право», также задаются на странице «Компания».',
    ...
    'setting.company.details.note' => 'Название компании, контактные данные и адрес, указанные на этой странице, управляются на странице «Компания».',
    ...
    'setting.hide.from.front.page' => 'Скрыть с главной страницы',
    'setting.key' => 'Установка ключа',
    'setting.privacy.policy.preview' => 'Предварительный просмотр политики конфиденциальности',
    'setting.section' => 'Раздел',
    'setting.subsection' => 'Подраздел',
    'setting.terms.of.service.preview' => 'Предварительный просмотр условий предоставления услуг',
    ...
    'sticky.grid.header' => 'Фиксированный заголовок сетки',
    'sticky.grid.header.hint' => 'Фиксирует заголовки столбцов списка счетов-фактур на месте при прокрутке. Сохраняется немедленно — вступает в силу при следующей загрузке страницы.',
    'sticky.navbar' => 'Фиксированная панель навигации',
    'sticky.navbar.hint' => 'Эта функция удерживает верхнюю панель навигации в закрепленном положении во время прокрутки этой страницы. Сохраняется немедленно — вступает в силу при следующей загрузке страницы.',
    ...
    'two.factor.authentication.use.backup.code' => 'Вместо этого используйте 8-значный резервный код восстановления.',
    'type' => 'Тип',
