...
return [
    ...
    'body' => 'Telo',
    'bookkeeping.export.hint' => 'Synchronizuje účtovnú knihu z vašich faktúr a potom odošle všetko, čo ešte nebolo exportované, do QuickBooks.',
    'bookkeeping.export.now' => 'Exportovať teraz',
    'bookkeeping.export.summary' => 'Export účtovníctva dokončený: exportovaných %d, zlyhalo %d.',
    'bookkeeping.quickbooks.account.accounts.receivable' => 'ID účtu pohľadávok',
    'bookkeeping.quickbooks.account.bank' => 'ID bankového účtu',
    'bookkeeping.quickbooks.account.payment.fees' => 'ID účtu poplatkov za platbu',
    'bookkeeping.quickbooks.account.sales' => 'ID predajného účtu',
    'bookkeeping.quickbooks.account.vat.or.tax' => 'ID účtu DPH/dane z predaja',
    'bookkeeping.quickbooks.client.id' => 'ID klienta',
    'bookkeeping.quickbooks.client.secret' => 'Tajomstvo klienta',
    'bookkeeping.quickbooks.connect' => 'Pripojenie k QuickBooks',
    'bookkeeping.quickbooks.connect.cancelled' => 'Pripojenie k QuickBooks bolo zrušené alebo zamietnuté.',
    'bookkeeping.quickbooks.connect.hint' => 'Presmeruje na QuickBooks na autorizáciu tejto aplikácie – najprv je potrebné uložiť ID klienta/tajomstvo uvedené nižšie.',
    'bookkeeping.quickbooks.connect.invalid.state' => 'Pripojenie k QuickBooks zlyhalo: neplatný parameter stavu.',
    'bookkeeping.quickbooks.connect.success' => 'Pripojené k QuickBooks.',
    'bookkeeping.quickbooks.connect.unexpected.response' => 'QuickBooks vrátil neočakávanú odpoveď.',
    'bookkeeping.quickbooks.connected' => 'Pripojené',
    'bookkeeping.quickbooks.not.configured' => 'ID/tajomstvo klienta QuickBooks nie je nakonfigurované.',
    'bookkeeping.quickbooks.not.connected' => 'Nepripojené',
    'bookkeeping.quickbooks.sandbox' => 'Pieskovisko (používa sandbox-quickbooks.api.intuit.com)',
    ...
    'bootstrap5.calendar.accent.color' => 'Farba zvýraznenia kalendára',
    ...
    'bootstrap5.layout.invoice.navbar.sticky.hint' => 'Udrží horný navigačný panel pripnutý na mieste, zatiaľ čo sa stránka posúva pod ním. Uloží sa okamžite – efekt bude viditeľný pri ďalšom načítaní stránky.',
    ...
    'client.postaladdress.add.save.first' => 'Najprv uložte tohto klienta a potom pridajte poštovú adresu',
    ...
    'debug.reset.tree.confirm' => 'Naozaj chcete pokračovať?',
    'debug.reset.tree.confirm.button' => 'Zhodiť a znova postaviť',
    'debug.reset.tree.db.password' => 'Heslo databázy',
    'debug.reset.tree.done' => 'Tabuľky faktúr, cenových ponúk a predajných objednávok boli odstránené a znovu vytvorené',
    'debug.reset.tree.failed' => 'Reset zlyhal, nič iné sa nezmenilo',
    'debug.reset.tree.menu' => 'Obnoviť faktúru/cenovú ponuku/objednávku',
    'debug.reset.tree.tables.heading' => 'Nasledujúce tabuľky budú odstránené a znovu vytvorené prázdne:',
    'debug.reset.tree.title' => 'Obnoviť faktúru, cenovú ponuku a predajnú objednávku',
    'debug.reset.tree.warning' => 'Týmto sa natrvalo odstránia všetky faktúry, cenové ponuky a predajné objednávky a všetky ich riadkové položky, sumy, daňové sadzby, vlastné polia a poplatky za príspevky. Najprv sa do priečinka /backups zapíše záloha pomocou gzip súboru, ale z tejto obrazovky sa to nedá vrátiť späť.',
    'debug.reset.tree.wrong.password' => 'Nesprávne heslo k databáze, nič sa nezmenilo',
    ...
    'delivery.location.peppol.output.fix' => 'Nastavte si ho teraz',
    ...
    'grid.sticky.header' => 'Záhlavie s pevnou mriežkou',
    'grid.sticky.header.hint' => 'Pri posúvaní dlhej faktúry, cenovej ponuky, predajnej objednávky alebo zoznamu produktov zostanú hlavičky stĺpcov pripnuté navrchu. Uloží sa okamžite – efekt je viditeľný pri návšteve zoznamu.',
    'gridview.api' => 'API',
    ...
    'home' => 'Domov',
    'home.admin.setup.walkthrough' => 'Návod na nastavenie pre správcu',
    'home.built.on.yii3' => 'Postavené na PHP frameworku {yii3_link}. Znak Yii 3 zobrazený vyššie je vlastnou oficiálnou ochrannou známkou {yii_software_link}, používanou bez úprav pod ich licenciou {license_link}.',
    ...
    'home.description' => 'Samostatne hostovaná fakturačná platforma s otvoreným zdrojovým kódom, postavená v PHP na frameworku Yii3. Vytvára elektronické faktúry kompatibilné s Peppol/UBL 2.4 (vrátane prenosu AS4), prijíma online platby prostredníctvom 17 integrovaných platobných brán v Európe, Severnej a Južnej Amerike, Ázii, Afrike a Oceánii a obsahuje modul HomeCare na automatizáciu fakturácie opakujúcich sa služieb – plánovanie čistenia, prideľovanie pracovníkov a offline PWA pre terénnych pracovníkov. Plánované príkazy konzoly spracovávajú automatizované zálohy a opakovanú fakturáciu.',
    'home.github.click.tracking.explanation' => 'Prekliknutím na GitHub sa zaznamená, z ktorej krajiny pochádza (nič identifikačnejšie ako to) – priamo to pomáha rozhodnúť, ktoré platobné brány budú ďalej uprednostňované, pretože regióny, od ktorých vidíme skutočný záujem, sú tie, pre ktoré sa oplatí stavať.',
    'home.hmrc.api.status' => 'Stav HMRC API ➡️',
    'home.oauth2.client.description' => 'Samostatný, súvisiaci vývojový projekt — klientska knižnica OAuth 2.0 pre framework Yii3.',
    'home.oauth2.client.heading' => 'Tiež na tejto stránke: Vývoj klientov OAuth2.0',
    'home.open.source.license' => 'Otvorený zdrojový kód pod licenciou BSD-3-Clause.',
    'home.payment.gateway.coverage' => 'Krytie platobnou bránou ➡️',
    'home.peppol.access.point.status' => 'Stav prístupového bodu Peppol ➡️',
    'home.title' => 'Yii3-i — systém fakturácie a elektronickej fakturácie s otvoreným zdrojovým kódom',
    'home.view.source.github' => '⭐ Zdrojový kód nájdete na GitHub — github.com/rossaddison/invoice',
    ...
    'homecare.runsheet.index.description' => 'Exportujte dnešný (alebo minulý) beh ako tlačiteľný hárok a potom sa sem vráťte, keď bude podpísaný a naskenovaný.',
    'homecare.runsheet.index.export' => 'Exportovať hárok chodu',
    'homecare.runsheet.index.export.invalid' => 'Pred exportom vyberte spustenie a platný dátum.',
    'homecare.runsheet.index.items' => 'Položky',
    'homecare.runsheet.index.recent' => 'Tabuľky posledných behov',
    'homecare.runsheet.index.run.date' => 'Dátum spustenia',
    'homecare.runsheet.index.title' => 'Pracovné listy HomeCare',
    'homecare.runsheet.nav' => 'Spustiť tabuľky',
    'homecare.runsheet.review.accept' => 'Prijať',
    'homecare.runsheet.review.applied' => 'Použitý hárok behu – faktúry aktualizované a beh označený ako odoslaný.',
    'homecare.runsheet.review.apply' => 'Použiť a označiť spustenie ako odoslané',
    'homecare.runsheet.review.apply.description' => 'Zapíše každú vyššie uvedenú akceptovanú úpravu na príslušnú faktúru a potom označí každú faktúru v tomto behu ako odoslanú, aby sa zobrazila na strane zákazníka. Toto nie je možné z tejto obrazovky vrátiť späť.',
    'homecare.runsheet.review.apply.not.ready' => 'Tento hárok spúšťania sa momentálne nedá použiť – možno už bol použitý alebo sken ešte nebol načítaný.',
    'homecare.runsheet.review.client' => 'Klient',
    'homecare.runsheet.review.completed' => 'Dokončené',
    'homecare.runsheet.review.description' => 'Uvedené sú iba faktúry, u ktorých sa ručne písané anotácie na naskenovanom hárku s faktúrami líšia od vytlačených – pred opätovným použitím do zoznamu faktúr je potrebné každú z nich skontrolovať.',
    'homecare.runsheet.review.detected.worker' => 'Zistený pracovník',
    'homecare.runsheet.review.download' => 'Stiahnuť harmonogram behu (CSV)',
    'homecare.runsheet.review.expected.worker' => 'Očakávaný pracovník',
    'homecare.runsheet.review.invoice' => 'Faktúra',
    'homecare.runsheet.review.no.changes' => 'Na tomto hárku sa nezistili žiadne zmeny – nič na kontrolu.',
    'homecare.runsheet.review.reason' => 'Dôvod',
    'homecare.runsheet.review.save' => 'Uložiť úpravy',
    'homecare.runsheet.review.saved' => 'Úpravy boli uložené.',
    'homecare.runsheet.review.status' => 'Stav',
    'homecare.runsheet.review.title' => 'Záznam o domácej starostlivosti – Kontrola úprav',
    'homecare.runsheet.review.upload.api.failed' => 'Čítanie vízie zlyhalo – v Nastaveniach skontrolujte kľúč API a zostatok na faktúre účtu Anthropic a skúste to znova. Skenovaný súbor bol uložený; tento hárok spustenia je možné skúsiť znova.',
    'homecare.runsheet.review.upload.button' => 'Nahrať a čítať',
    'homecare.runsheet.review.upload.done' => 'Naskenujte nahraný súbor a prečítajte si ho – skontrolujte zistené úpravy nižšie.',
    'homecare.runsheet.review.upload.invalid' => 'Vyberte súbor obrázka (JPEG, PNG, GIF alebo WebP), ktorý chcete nahrať.',
    'homecare.runsheet.review.upload.label' => 'Nahrajte naskenovaný/odfotený záznam o behu',
    'homecare.runsheet.review.upload.not.configured' => 'Kľúč rozhrania API pre rozhranie Vision ešte nie je nakonfigurovaný – pred nahraním skenu požiadajte správcu o jeho nastavenie v nastaveniach.',
    ...
    'homecare.vision.api.key' => 'Antropický API kľúč',
    'homecare.vision.api.key.description' => 'Vyžaduje sa pre krok „Nahrať a načítať“ na obrazovke kontroly pracovného hárku HomeCare, ktorá prečíta ručne písané anotácie naskenovaného pracovného hárku pomocou systému Claude Haiku 4.5 Vision. Ak chcete tento krok deaktivovať, ponechajte toto pole prázdne.',
    'homecare.vision.api.key.get' => 'Získať API kľúč ↗',
    'homecare.vision.api.key.title' => 'Spustiť skenovanie hárka',
    ...
    'invoice.status.cannot.revert' => 'Vydanú faktúru nie je možné vrátiť do predchádzajúceho stavu. Zrušte ju (ak nie je zaplatená) alebo vystavte dobropis.',
    'invoice.status.issued' => 'Vydané',
    'invoice.status.void' => 'Prázdnota',
    'invoice.to.html' => 'Faktúra do HTML',
    'invoice.trash' => 'Kôš faktúr',
    'invoice.validation.errors' => 'Chyby pri overovaní faktúr',
    'invoice.void' => 'Neplatná faktúra',
    'invoice.void.confirm' => 'Chcete zrušiť túto faktúru? Bude zrušená, zachová si svoje číslo a už ju nebude možné upravovať ani platiť.',
    'invoice.void.not.allowed' => 'Zrušiť možno iba vystavenú alebo zobrazenú faktúru bez platieb. Namiesto toho vystavte dobropis.',
    'invoice.void.selected.confirm' => 'Zrušiť vybrané faktúry? Zrušené budú iba vystavené alebo zobrazené faktúry bez platieb; tie si zachovajú svoje čísla a už ich nebude možné upravovať.',
    'invoice.void.success' => 'Faktúra zrušená.',
    ...
    'menu.hmrc.api.status' => 'Stav HMRC API',
    'menu.language' => 'Jazyk',
    'menu.login' => 'Prihlásenie',
    'menu.logout' => 'Odhlásiť sa ({login})',
    'menu.more' => 'Viac',
    'menu.peppol.status' => 'Stav prístupového bodu Peppol',
    'menu.pricing' => 'Cenník',
    ...
    'mtd.business.missing.nino.or.token' => 'Číslo národného poistenia alebo prístupový token HMRC nie je nastavený',
    'mtd.eori' => 'Registračné a identifikačné číslo hospodárskeho subjektu (EORI)',
    'mtd.eori.hint' => 'Potrebné na identifikáciu tejto firmy v rozhraní API colných deklarácií HMRC – napr. GB123456789000',
    'mtd.fph' => 'Hlavičky o predchádzaní podvodom',
    'mtd.fph.all.valid' => 'Všetky hlavičky na predchádzanie podvodom sú platné',
    'mtd.fph.feedback.client.credentials.error' => 'Daňový a colný úrad (HMRC) zamietol žiadosť o token s obmedzeným prístupom pre aplikáciu: „{error}“ – {description}',
    'mtd.fph.feedback.no.client.credentials.token' => 'DEVELOPER_GOV_SANDBOX_HMRC_API_CLIENT_ID alebo _CLIENT_SECRET nie je nastavené v .env – FPH Feedback potrebuje vlastný token prístupu s obmedzeným prístupom aplikácie od HMRC, oddelený od tokenu používaného každou inou stránkou HMRC.',
    'mtd.fph.feedback.unexpected.token.response' => 'HMRC vrátila kód 200 pre žiadosť o token prístupu s obmedzeným prístupom aplikácie, ale v tele odpovede nebol žiadny access_token.',
    'mtd.fph.generate' => 'Generovať',
    'mtd.fph.manage.subscriptions.link.text' => 'pridaj to sem',
    'mtd.fph.missing.hmrc.token' => 'Nie ste prihlásený/á do HMRC. {link}, skúste to znova.',
    'mtd.fph.missing.otp.session' => 'Údaje o vašej relácii dvojfaktorového overenia chýbajú alebo ich platnosť vypršala, čo je potrebné na testovanie hlavičiek na predchádzanie podvodom. Odhláste sa a znova prihláste a skúste to znova.',
    ...
    'mtd.fph.validate.error.generic' => 'Daňový úrad Spojeného kráľovstva (HMRC) vrátil chybu pri overovaní vašich hlavičiek na predchádzanie podvodom: „{code}“ – {message}',
    'mtd.fph.validate.error.not.subscribed' => 'HMRC vrátil „{code}“: {message} Vaša aplikácia Developer Hub potrebuje do svojich predplatných pridať rozhranie Test Fraud Prevention Headers API – {link}.',
    ...
    'mtd.hmrc.developer.hub' => 'Centrum pre vývojárov HMRC',
    'mtd.hmrc.developer.hub.add.production.application' => 'Pridať produkčnú aplikáciu',
    'mtd.hmrc.developer.hub.add.sandbox.application' => 'Pridať aplikáciu sandbox',
    'mtd.hmrc.developer.hub.application.id' => 'ID aplikácie Centra pre vývojárov',
    'mtd.hmrc.developer.hub.application.id.not.set' => 'Nie je nastavené – do .env sa pridá DEVELOPER_GOV_SANDBOX_HMRC_API_APPLICATION_ID (UUID z URL adresy „Spravovať aplikáciu“ v centre pre vývojárov, nie OAuth client_id)',
    'mtd.hmrc.developer.hub.change.name.and.description' => 'Zmeniť názov a popis',
    'mtd.hmrc.developer.hub.change.password' => 'Zmeniť heslo',
    'mtd.hmrc.developer.hub.client.secrets' => 'Tajomstvá klienta',
    'mtd.hmrc.developer.hub.delete.application' => 'Odstrániť aplikáciu',
    'mtd.hmrc.developer.hub.email.preferences' => 'Predvoľby e-mailu',
    'mtd.hmrc.developer.hub.ip.allowlist' => 'Zoznam povolených IP adries',
    'mtd.hmrc.developer.hub.login' => 'Prihlásiť sa',
    'mtd.hmrc.developer.hub.logout' => 'Odhlásiť sa',
    'mtd.hmrc.developer.hub.manage.application' => 'Spravovať aplikáciu',
    'mtd.hmrc.developer.hub.profile' => 'Profil',
    'mtd.hmrc.developer.hub.redirect.uris' => 'Presmerovacie URI',
    'mtd.hmrc.developer.hub.security.preferences' => 'Bezpečnostné nastavenia',
    'mtd.hmrc.developer.hub.subscriptions' => 'Predplatné',
    'mtd.hmrc.developer.hub.tc.and.privacy.policy.url' => 'URL adresa zmluvných podmienok / zásad ochrany osobných údajov',
    'mtd.hmrc.developer.hub.team.members' => 'Členovia tímu',
    'mtd.individual.calculations.trigger.error' => 'Daňový úrad vrátil chybu pri spustení výpočtu: „{code}“ — {message}',
    'mtd.individual.calculations.triggered' => 'Výpočet spustený (ID: {calculationId}).',
    'mtd.nino' => 'Národné poistné číslo (NINO)',
    'mtd.nino.hint' => 'Potrebné pre každé nižšie uvedené API založené na NINO (SZČO, Podrobnosti o firme atď.) -- pre sandbox HMRC použite nino vrátené funkciou Vytvoriť testovacieho používateľa, nie vaše vlastné skutočné NINO',
    ...
    'mtd.vat.return.error.client_or_agent_not_authorised' => 'Tento účet nie je autorizovaný na podávanie daňových priznaní k DPH pre toto registračné číslo (VRN).',
    'mtd.vat.return.error.duplicate_submission' => 'Za toto obdobie už bolo podané daňové priznanie k DPH.',
    'mtd.vat.return.error.invalid_monetary_amount' => 'Jedna z odoslaných čiastok nie je platná peňažná hodnota (0 až 99 999 999 999,99, zaokrúhlená na 2 desatinné miesta).',
    'mtd.vat.return.error.invalid_numeric_value' => 'Jedna z odoslaných hodnôt nie je platné číslo.',
    'mtd.vat.return.error.invalid_request' => 'Daňový úrad (HMRC) túto žiadosť zamietol ako chybnú.',
    'mtd.vat.return.error.not_finalised' => 'Toto daňové priznanie nebolo vyhlásené za konečné – zaškrtnite políčko vyhlásenia a znova ho odošlite.',
    'mtd.vat.return.error.period_key_invalid' => 'Kľúč obdobia pre toto daňové priznanie k DPH je neplatný alebo nie je rozpoznaný.',
    'mtd.vat.return.error.rule_insolvent_trader' => 'Záznamy HMRC ukazujú, že tento obchodník je v platobnej neschopnosti, takže vrátenie tovaru nie je možné akceptovať.',
    'mtd.vat.return.error.tax_period_not_ended' => 'Toto zdaňovacie obdobie ešte neskončilo – HMRC nemôže prijať daňové priznanie pred ukončením obdobia.',
    'mtd.vat.return.error.vat_net_value' => 'Políčko 5 (Čistá DPH splatná) sa musí rovnať rozdielu medzi políčkom 3 a políčkom 4.',
    'mtd.vat.return.error.vat_total_value' => 'Políčko 3 (Celková splatná DPH) sa musí rovnať poľu 1 + poľu 2.',
    'mtd.vat.return.error.vrn_invalid' => 'Zadané IČ DPH je neplatné.',
    ...
    'off' => 'Vypnuté',
    'on' => 'Zapnuté',
    'online.bookkeeping' => 'Online účtovníctvo',
    ...
    'online.payment.bitpay.generic.complete.message' => 'Vaša platba BitPay sa spracováva. Vaša faktúra sa automaticky aktualizuje, keď ju BitPay potvrdí v reťazci – aktuálny stav si, prosím, skontrolujte priamo na faktúre.',
    ...
    'online.payment.payment.processing.generic' => 'Ďakujem',
    ...
    'oxalis' => 'Oxalis',
    'oxalis.env.not.set' => 'Nie je nastavené',
    'oxalis.env.only.note' => 'Oxalis sa konfiguruje pomocou premenných .env, nie tu – nižšie sú zobrazené len na čítanie. Postup nastavenia nájdete v súbore src/Invoice/Peppol/README.md. Oxalis sa v tomto nasadení ešte nepoužil na skutočné odoslanie.',
    'oxalis.setup.guide' => 'Sprievodca nastavením Oxalisu →',
    'page' => 'Strana',
    'paid' => 'Platené',
    'password' => 'Heslo',
    ...
    'peppol.access.point' => 'Prístupový bod Peppol',
    'peppol.access.point.get.credentials' => 'Získať prihlasovacie údaje →',
    'peppol.access.point.hint' => 'Vyberte si, ktorý prístupový bod skutočne prenáša vaše dokumenty Peppol, a potom nižšie vyplňte údaje o danom poskytovateľovi – pri odosielaní sa použije iba karta vybraného poskytovateľa.',
    'peppol.access.point.provider' => 'Poskytovateľ prístupového bodu',
    ...
    'peppol.buyer.postal.address.not.found.fix' => 'Oprav to teraz',
    ...
    'peppol.client.check.missing' => 'Tento klient nemá vôbec nastavené žiadne údaje o Peppole.',
    'peppol.client.check.no.client' => 'Táto faktúra nemá priloženého klienta – Peppol nie je možné odoslať bez neho.',
    ...
    'peppol.endpointid.checksum.invalid' => 'Táto hodnota nespĺňa kontrolný súčet požadovaný schémou.',
    'peppol.endpointid.looks.like.email' => 'Toto vyzerá ako e-mailová adresa, ale žiadna skutočná schéma Peppol ju nepoužíva ako identifikátor – namiesto toho zadajte identifikátor firmy (registračné číslo, IČ DPH, GLN atď.), ktorý zodpovedá vybranej schéme.',
    ...
    'peppol.messages.log' => 'Správy Peppolu',
    'peppol.optional' => ' (Voliteľné)',
    'peppol.send.via' => 'Odoslať cez Peppol',
    ...
    'peppol.tax.category.not.found.fix' => 'Nastavte to teraz',
    ...
    'product.added.despite.insufficient.stock' => 'Pridané napriek nedostatočnému množstvu zásob:',
    ...
    'product.available.stock' => 'Dostupné zásoby',
    ...
    'product.peppol.unit.hint' => 'Uloženie tohto produktu nie je povinné, ale je povinné v momente odoslania faktúry používajúcej tento produkt cez Peppol – musí to byť záznam UnitPeppol pre rovnakú jednotku vybratú vyššie, nie len tak hocijaký záznam UnitPeppol. Nastavte to teraz, ak sa tento produkt niekedy použije na faktúre Peppol.',
    'product.peppol.unit.missing' => 'Nie je nastavené',
    'product.price' => 'Cena',
    ...
    'rejected' => 'Zamietnuté',
    'remember.me.days' => 'Trvanie funkcie Zapamätaj si ma (dni)',
    ...
    'run.sheet.pdf' => 'Záznam o priebehu (PDF)',
    'run.sheet.pdf.tooltip' => 'Stiahnite si PDF súbor každej faktúry, ktorú aktuálne zobrazujú vaše filtre, a adresu si prečítajte predovšetkým ako klikateľný odkaz na Mapy Google – užitočné pre upratovanie v HomeCare alebo akýkoľvek iný zoznam faktúr, ktorý potrebujete navštíviť alebo si ho pozrieť offline.',
    'sales' => 'Predaj',
    ...
    'setting.arbitration.details.note' => 'Polia Rozhodcovský orgán a Rozhodcovská jurisdikcia používané v sekciách Riešenie sporov a Rozhodné právo sú nastavené aj na stránke spoločnosti.',
    ...
    'setting.company.details.note' => 'Názov spoločnosti, kontaktné údaje a adresa zobrazené na tejto stránke sa spravujú na stránke Spoločnosť.',
    ...
    'setting.hide.from.front.page' => 'Skryť z titulnej strany',
    'setting.key' => 'Kľúč nastavenia',
    'setting.privacy.policy.preview' => 'Zásady ochrany osobných údajov v ukážke',
    'setting.section' => 'Sekcia',
    'setting.subsection' => 'Podsekcia',
    'setting.terms.of.service.preview' => 'Ukážka zmluvných podmienok',
    ...
    'sticky.grid.header' => 'Záhlavie s pevnou mriežkou',
    'sticky.grid.header.hint' => 'Počas posúvania ponechá hlavičky stĺpcov v zozname faktúr pripnuté na mieste. Uloží sa okamžite – prejaví sa pri ďalšom načítaní stránky.',
    'sticky.navbar' => 'Sticky Navbar',
    'sticky.navbar.hint' => 'Počas posúvania tejto stránky ponechá horný navigačný panel pripnutý na mieste. Uloží sa okamžite – prejaví sa pri ďalšom načítaní stránky.',
    'stop' => 'Zastaviť',
    ...
    'taxes' => 'Dane',
    'taxrate.peppol.tax.rate.code.hint' => 'Túto daňovú sadzbu nie je potrebné uložiť, ale je povinné (kód UNCL5305, napr. S/Z/E/AE) v momente odoslania faktúry s touto daňovou sadzbou prostredníctvom spoločnosti Peppol – nastavte ju teraz, ak sa táto sadzba niekedy použije na faktúre spoločnosti Peppol.',
    'taxrate.peppol.tax.rate.code.missing' => 'Nie je nastavené',
    'telegram' => 'Telegram',
    ...
    'two.factor.authentication.use.backup.code' => 'Použite namiesto toho 8-miestny záložný kód na obnovenie',
    'type' => 'Typ',
