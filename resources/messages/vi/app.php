...
return [
    'PEPPOL.COMMON.R040' => 'GLN phải có định dạng hợp lệ theo quy tắc GS1.',
    'PEPPOL.COMMON.R041' => 'Mã số tổ chức của Na Uy PHẢI được ghi đúng định dạng.',
    'PEPPOL.COMMON.R042' => 'Số CVR của Đan Mạch PHẢI được ghi đúng định dạng.',
    'PEPPOL.COMMON.R043' => 'Mã số doanh nghiệp Bỉ PHẢI được ghi đúng định dạng.',
    'PEPPOL.COMMON.R044' => 'Mã IPA (Mã đơn vị tổ chức duy nhất) phải được ghi đúng định dạng.',
    'PEPPOL.COMMON.R045' => 'Mã số thuế (Codice Fiscale) phải được ghi đúng định dạng.',
    'PEPPOL.COMMON.R046' => 'Mã số thuế (Codice Fiscale) cho chương trình quốc gia PHẢI được ghi đúng định dạng.',
    'PEPPOL.COMMON.R047' => 'Mã số thuế GTGT của Ý (Partita Iva) phải được ghi đúng định dạng.',
    'PEPPOL.COMMON.R049' => 'Mã số tổ chức Thụy Điển PHẢI được ghi đúng định dạng.',
    'PEPPOL.COMMON.R050' => 'Mã số doanh nghiệp Úc (ABN) PHẢI được ghi đúng định dạng.',
    'PEPPOL.COMMON.R052' => 'Số đăng ký phòng thương mại Đan Mạch PHẢI được ghi đúng định dạng.',
    'PEPPOL.COMMON.R053' => 'Mã số ERSTORG của Đan Mạch PHẢI được ghi đúng định dạng.',
    'PEPPOL.EN16931.R001' => 'Quy trình kinh doanh PHẢI được cung cấp',
    'PEPPOL.EN16931.R002' => 'Chỉ được phép ghi chú tối đa một lần trừ khi cả hai bên đều là người Đức.',
    'PEPPOL.EN16931.R003' => 'Cần có mã số tham chiếu của người mua hoặc mã số tham chiếu đơn hàng.',
    'PEPPOL.EN16931.R004.INVALID' => 'Định dạng mã định danh thông số kỹ thuật không hợp lệ',
    'PEPPOL.EN16931.R004.REQUIRED' => 'Mã định danh thông số kỹ thuật cần thiết',
    'PEPPOL.EN16931.R005' => 'Đơn vị tiền tệ dùng để tính thuế phải khác với đơn vị tiền tệ dùng để lập chứng từ.',
    'PEPPOL.EN16931.R007' => 'Quy trình kinh doanh PHẢI được định dạng ',
    'PEPPOL.EN16931.R008' => 'Phần tử rỗng: ',
    'PEPPOL.EN16931.R010' => 'Cần có địa chỉ email của người mua.',
    'PEPPOL.EN16931.R020' => 'Cần có địa chỉ email của người bán.',
    'PEPPOL.EN16931.R040' => 'Số tiền phải bằng cơ sở * phần trăm / 100',
    'PEPPOL.EN16931.R041' => 'Số tiền cơ bản cần thiết khi cung cấp tỷ lệ phần trăm.',
    'PEPPOL.EN16931.R042' => 'Tỷ lệ phần trăm cần thiết khi cung cấp số tiền cơ bản',
    'PEPPOL.EN16931.R043' => 'ChargeIndicator phải là &#39;true&#39; hoặc &#39;false&#39;',
    'PEPPOL.EN16931.R044' => 'Không được phép tính phí theo mức giá.',
    'PEPPOL.EN16931.R046' => 'Lỗi tính giá thực của mặt hàng',
    'PEPPOL.EN16931.R051' => 'Tất cả các khoản tiền phải được tính bằng đơn vị tiền tệ trong chứng từ.',
    'PEPPOL.EN16931.R053' => 'Tổng số thuế phải được tính bằng một tổng phụ.',
    'PEPPOL.EN16931.R054' => 'Tổng thuế không hợp lệ nếu không tính các khoản phụ.',
    'PEPPOL.EN16931.R055' => 'Số tiền thuế phải cùng dấu.',
    'PEPPOL.EN16931.R061' => 'Cần có mã số ủy quyền để thanh toán tự động.',
    'PEPPOL.EN16931.R080' => 'Chỉ cho phép tối đa một tham chiếu dự án.',
    'Q1' => 'Câu hỏi 1',
    'Q2' => 'Quý 2',
    'Q3' => 'Quý 3',
    'Q4' => 'Quý 4',
    ...
    'allowance.or.charge.allowance.tax' => 'Thuế trợ cấp',
    ...
    'allowance.or.charge.amount.fixed.must.be.positive' => 'Số tiền cố định phải lớn hơn 0.',
    'allowance.or.charge.base.amount' => 'Số lượng cơ sở',
    'allowance.or.charge.base.amount.required.when.mfn.set' => 'Số tiền cơ sở phải lớn hơn 0 khi thiết lập hệ số nhân.',
    'allowance.or.charge.charge' => 'Thù lao',
    'allowance.or.charge.charge.tax' => 'Thuế trên phí',
    ...
    'allowance.or.charge.inv.add' => 'Thêm khoản trợ cấp hoặc phí hóa đơn',
    'allowance.or.charge.item' => 'Khoản khấu trừ hoặc phí trên hóa đơn',
    'allowance.or.charge.item.add' => 'Phụ cấp/Phí Thêm',
    'allowance.or.charge.item.invoice' => 'Khoản giảm giá hoặc phụ phí cho mặt hàng trên hóa đơn',
    'allowance.or.charge.item.quote' => 'Báo giá mặt hàng, khoản phụ cấp hoặc phí.',
    'allowance.or.charge.level' => 'Mức (⬅️Tổng thể, Mục hàng ➡)',
    'allowance.or.charge.multiplier.factor.numeric' => 'Hệ số nhân Số',
    'allowance.or.charge.quote' => 'Báo giá, khoản phụ phí hoặc lệ phí',
    'allowance.or.charge.quote.add' => 'Thêm khoản giảm giá hoặc phí vào báo giá',
    'allowance.or.charge.reason' => 'Lý do',
    'allowance.or.charge.reason.code' => 'Mã lý do',
    'allowance.or.charge.shipping.handling.packaging' => 'Vận chuyển/Xử lý/Đóng gói',
    'allowance.or.charge.shipping.handling.packaging.tax' => 'Thuế vận chuyển/xử lý/đóng gói',
    'allowance.or.charge.shipping.handling.packaging.vat' => 'Thuế GTGT đối với Vận chuyển/Xử lý/Đóng gói',
    ...
    'amount.inv.item' => 'Số tiền mặt hàng trên hóa đơn',
    'amount.no' => 'Không có số tiền trong hóa đơn',
    'amount.payment' => 'Số tiền thanh toán phải trả đầy đủ',
    'amount.quote.item' => 'Số tiền mặt hàng trong báo giá',
    'amount.settings' => 'Cài đặt số lượng',
    'amounts' => 'Số tiền hóa đơn',
    'any.family' => 'Bất kỳ gia đình nào',
    'api.error.forbidden' => 'Bạn không có quyền truy cập vào tài nguyên này.',
    'api.error.not_found' => 'Không tìm thấy {resource} được yêu cầu.',
    'api.error.unauthorized' => 'Cần xác thực để truy cập tài nguyên này.',
    'api.error.validation_failed' => 'Xác thực thất bại. Vui lòng kiểm tra lại thông tin đã nhập.',
    'api.success.created' => '{resource} đã được tạo thành công',
    'api.success.deleted' => '{resource} đã được xóa thành công',
    'api.success.updated' => '{resource} đã được cập nhật thành công',
    'app.cdn.not.node.module' => 'Hãy sử dụng AppCdnAsset (không phải AppNodeModulesAsset)',
    ...
    'as4.messages.log' => 'Thông báo AS4',
    ...
    'autofit.columns' => 'Tự động điều chỉnh chiều rộng cột cho phù hợp với nội dung',
    'automatic.email.on.recur' => 'Tự động gửi hóa đơn định kỳ qua Email',
    'back' => 'Mặt sau',
    'backup' => 'Hỗ trợ',
    'backup.database' => 'Sao lưu cơ sở dữ liệu',
    'backup.database.description' => 'Tải xuống bản sao nén của toàn bộ cơ sở dữ liệu — bao gồm mọi bảng, cấu trúc và dữ liệu — dưới dạng một tệp .sql.gz duy nhất. Lưu trữ tệp này ở một nơi an toàn bên ngoài máy chủ này.',
    'backup.database.download' => 'Tải xuống bản sao lưu cơ sở dữ liệu',
    'backup.download.failed' => 'Sao lưu cơ sở dữ liệu thất bại',
    'bacs.account.number' => 'Số tài khoản',
    'bacs.bank.details' => 'Thông tin ngân hàng',
    'bacs.copy' => 'Sao chép vào clipboard',
    'bacs.mobile.tip' => 'Trên thiết bị di động, hãy nhấn vào biểu tượng sao chép bên cạnh mỗi trường để dán thông tin trực tiếp vào ứng dụng ngân hàng của bạn.',
    'bacs.no.outstanding.invoices' => 'Hiện tại không có hóa đơn nào chưa thanh toán.',
    'bacs.no.outstanding.invoices.hint' => 'Số dư tài khoản của bạn đã được thanh toán đầy đủ — hiện tại bạn không cần phải trả gì cả.',
    'bacs.not.yet.configured' => 'Thông tin chuyển khoản ngân hàng hiện chưa có.',
    'bacs.not.yet.configured.hint' => 'Vui lòng liên hệ trực tiếp với chúng tôi để biết chi tiết thanh toán.',
    'bacs.outstanding.invoices' => 'Hóa đơn chưa thanh toán',
    'bacs.pay.by.bank.transfer' => 'Thanh toán bằng chuyển khoản ngân hàng',
    'bacs.payee' => 'Người nhận tiền',
    'bacs.payment.instructions' => 'Khi thực hiện chuyển khoản ngân hàng, vui lòng sử dụng mã sắp xếp, số tài khoản và mã tham chiếu được hiển thị ở trên. Mã tham chiếu giúp chúng tôi đối chiếu khoản thanh toán của bạn với tài khoản của bạn.',
    'bacs.quick.pay' => 'Thanh toán bằng chuyển khoản ngân hàng (BACS / Faster Payments)',
    'bacs.reference' => 'Người tham khảo của bạn',
    'bacs.scan.qr.hint' => 'Ứng dụng ngân hàng của bạn sẽ tự động mở với tên người nhận, mã chi nhánh, số tài khoản và số tiền được điền sẵn — bạn không cần phải nhập thêm.',
    'bacs.scan.to.pay' => 'Quét mã để xem chi tiết thanh toán',
    'bacs.sort.code' => 'Mã sắp xếp',
    'balance' => 'Sự cân bằng',
    'balance.does.not.equal.zero' => 'Số dư không bằng 0.Trạng thái là Đã thanh toán =&gt; Số dư phải bằng 0.',
    'bank.ref' => 'Số tham chiếu ngân hàng',
    ...
    'birthdate' => 'Ngày sinh',
    'body' => 'Thân hình',
    'bookkeeping.export.hint' => 'Đồng bộ sổ cái từ hóa đơn của bạn, sau đó gửi bất kỳ dữ liệu nào chưa được xuất sang QuickBooks.',
    'bookkeeping.export.now' => 'Xuất ngay',
    'bookkeeping.export.summary' => 'Quá trình xuất dữ liệu kế toán đã hoàn tất: %d đã xuất, %d thất bại.',
    'bookkeeping.quickbooks.account.accounts.receivable' => 'Mã tài khoản phải thu',
    'bookkeeping.quickbooks.account.bank' => 'Mã số tài khoản ngân hàng',
    'bookkeeping.quickbooks.account.payment.fees' => 'Mã tài khoản phí thanh toán',
    'bookkeeping.quickbooks.account.sales' => 'Mã tài khoản bán hàng',
    'bookkeeping.quickbooks.account.vat.or.tax' => 'Mã số tài khoản thuế GTGT/thuế bán hàng',
    'bookkeeping.quickbooks.client.id' => 'Mã khách hàng',
    'bookkeeping.quickbooks.client.secret' => 'Bí mật khách hàng',
    'bookkeeping.quickbooks.connect' => 'Kết nối với QuickBooks',
    'bookkeeping.quickbooks.connect.cancelled' => 'Kết nối QuickBooks đã bị hủy hoặc từ chối.',
    'bookkeeping.quickbooks.connect.hint' => 'Ứng dụng này sẽ chuyển hướng đến QuickBooks để xác thực — Bạn cần lưu lại Mã khách hàng/Mã bí mật bên dưới trước.',
    'bookkeeping.quickbooks.connect.invalid.state' => 'Kết nối QuickBooks thất bại: tham số trạng thái không hợp lệ.',
    'bookkeeping.quickbooks.connect.success' => 'Đã kết nối với QuickBooks.',
    'bookkeeping.quickbooks.connect.unexpected.response' => 'QuickBooks đã trả về một phản hồi không mong muốn.',
    'bookkeeping.quickbooks.connected' => 'Đã kết nối',
    'bookkeeping.quickbooks.not.configured' => 'Mã định danh/mã bí mật của QuickBooks chưa được cấu hình.',
    'bookkeeping.quickbooks.not.connected' => 'Không kết nối',
    'bookkeeping.quickbooks.sandbox' => 'Sandbox (sử dụng sandbox-quickbooks.api.intuit.com)',
    'boolean' => 'Boolean',
    ...
    'bootstrap5.calendar.accent.color' => 'Màu nhấn của lịch',
    'bootstrap5.cdn.not.node.module' => 'CDN Bootstrap5 (Không phải Module Node)',
    'bootstrap5.form.font.size' => 'Kích thước phông chữ của biểu mẫu (px)',
    'bootstrap5.form.input.height' => 'Chiều cao ô nhập liệu (px)',
    'bootstrap5.layout.guest.navbar.font' => 'Bố cục Thanh điều hướng dành cho khách Phông chữ',
    'bootstrap5.layout.guest.navbar.font.size' => 'Bố cục Thanh điều hướng dành cho khách Kích thước phông chữ',
    ...
    'bootstrap5.layout.invoice.navbar.sticky' => 'Thanh điều hướng cố định',
    'bootstrap5.layout.invoice.navbar.sticky.hint' => 'Giữ thanh điều hướng trên cùng cố định trong khi trang cuộn bên dưới. Lưu ngay lập tức — hiệu ứng hiển thị ở lần tải trang tiếp theo.',
    'bootstrap5.layout.main.navbar.font' => 'Bố cục phông chữ thanh điều hướng chính',
    'bootstrap5.layout.main.navbar.font.size' => 'Bố cục Thanh điều hướng chính Kích thước phông chữ',
    ...
    'bootstrap5.sidebar.background' => 'Màu nền thanh bên',
    'bootstrap5.sidebar.guest.background' => 'Màu nền của thanh bên dành cho khách',
    'breadcrumb.product.index' => 'Chỉ mục sản phẩm',
    'breadcrumb.product.property.index' => 'Chỉ số tài sản sản phẩm',
    'business.error.client.credit_limit' => 'Khách hàng {client_name} đã vượt quá hạn mức tín dụng {limit}.',
    'business.error.insufficient_stock' => 'Sản phẩm {product_name} không còn hàng. Số lượng có sẵn: {available}, Số lượng cần thiết: {required}',
    'business.error.invoice.already_paid' => 'Hóa đơn số {invoice_number} đã được đánh dấu là đã thanh toán.',
    'business.error.payment.gateway_failed' => 'Giao dịch thanh toán thất bại: {error_message}',
    ...
    'cancel' => 'Hủy bỏ',
    'canceled' => 'Đã hủy',
    'cannot.delete' => 'Không thể xóa. Vui lòng xóa các bản ghi liên quan trước.',
    'capture.gps.on.send' => 'Ghi lại vị trí GPS khi gửi đi.',
    'capture.gps.on.send.description' => 'Được dành riêng cho quy trình làm việc trạng thái nhân viên/quản lý trong tương lai (trạng thái bắt đầu/hoàn thành nằm giữa bản nháp và đã gửi, với vai trò &quot;nhân viên&quot; chỉ giới hạn trong các công việc được phân bổ cho họ) — hiện chưa được xây dựng, vì vậy việc bật tính năng này hiện tại không có tác dụng.',
    'cart.insufficient.stock' => 'Chúng tôi chỉ có đủ hàng để thêm một phần những gì bạn yêu cầu — giỏ hàng của bạn đã được cập nhật với số lượng tối đa hiện có.',
    ...
    'checkout' => 'Thanh toán',
    'checkout.failed' => 'Rất tiếc, chúng tôi không thể xử lý đơn hàng của bạn. Vui lòng thử lại.',
    'city' => 'Thành phố',
    ...
    'client.deactivate.warning' => 'Cảnh báo: Hóa đơn và các tài liệu nguồn liên quan sẽ không hiển thị nếu khách hàng không hoạt động.',
    ...
    'client.not.found' => 'Không tìm thấy máy khách',
    ...
    'client.peppol.po.item.id' => 'Mã số sản phẩm Peppol PO',
    ...
    'client.po.number' => 'Số đơn đặt hàng của khách hàng',
    'client.po.person' => 'Liên hệ đặt hàng của khách hàng',
    'client.postaladdress' => 'Địa chỉ bưu chính',
    'client.postaladdress.add' => 'Thêm địa chỉ bưu chính của khách hàng',
    'client.postaladdress.add.save.first' => 'Trước tiên hãy lưu thông tin khách hàng này, sau đó thêm địa chỉ bưu chính.',
    ...
    'client.telegram.chat.id' => 'ID nhóm chat Telegram',
    ...
    'company.seo' => 'Mô tả về Tối ưu hóa Công cụ Tìm kiếm (SEO)',
    'complete' => 'Hoàn thành',
    'confirm' => 'Xác nhận',
    'confirm.deletion' => 'Xác nhận xóa',
    'consent.periodic.invoice' => 'Hóa đơn đăng ký hàng tháng/hàng tuần qua Telegram ',
    'consent.telegram.chat.id' => 'ID nhóm chat Telegram (bắt buộc để nhận thông báo thanh toán — nhắn tin cho @userinfobot trên Telegram để tìm ID của bạn)',
    'consent.telegram.outstanding' => 'Tôi đồng ý nhận thông báo qua Telegram khi có khoản thanh toán chưa được thực hiện.',
    'contact.information' => 'Thông tin liên lạc',
    'continue' => 'Tiếp tục',
    'continue.with.developer.sandbox.hmrc' => 'Tiếp tục với Developer Gov Sandbox UK',
    'continue.with.developersandboxhmrc' => 'Tiếp tục với Developer Gov Sandbox UK',
    ...
    'continue.with.oidc' => 'Tiếp tục với Open Id Connect',
    'continue.with.openbanking' => 'Tiếp tục với Ngân hàng mở',
    ...
    'contracts' => 'Hợp đồng',
    'converted.to.invoice' => 'Đã chuyển đổi thành hóa đơn',
    'converted.to.so' => 'Đã chuyển đổi thành Đơn đặt hàng bán hàng',
    ...
    'copy.all.to.date.new.date' => 'Ngày mới',
    'copy.all.to.date.warning' => 'Thao tác này sẽ sao chép tất cả các hóa đơn hiện đang hiển thị theo bộ lọc ở trên xuống ngày bên dưới, mỗi hóa đơn vẫn thuộc về một khách hàng riêng.',
    ...
    'currency' => 'Tiền tệ',
    'currency.and.number.settings' => 'Cài đặt tiền tệ và số',
    'currency.code' => 'Mã tiền tệ',
    'currency.name.EUR' => 'Euro',
    'currency.name.GBP' => 'Bảng Anh',
    'currency.name.USD' => 'Đô la Mỹ',
    ...
    'dashboard.outstanding_invoices' => 'Hóa đơn chưa thanh toán',
    'dashboard.overdue_amount' => 'Số tiền quá hạn',
    'dashboard.overview.title' => 'Tổng quan tài chính',
    'dashboard.recent_payments' => 'Các khoản thanh toán gần đây',
    'dashboard.total_revenue' => 'Tổng doanh thu tháng này',
    ...
    'debug.reset.tree.confirm' => 'Bạn có chắc chắn muốn tiếp tục không?',
    'debug.reset.tree.confirm.button' => 'Thả xuống và xây dựng lại',
    'debug.reset.tree.db.password' => 'Mật khẩu cơ sở dữ liệu',
    'debug.reset.tree.done' => 'Các bảng Inv, Quote và SalesOrder đã bị xóa và xây dựng lại.',
    'debug.reset.tree.failed' => 'Quá trình khôi phục thất bại, không có gì khác được thay đổi.',
    'debug.reset.tree.menu' => 'Đặt lại Hóa đơn/Báo giá/Đơn đặt hàng',
    'debug.reset.tree.tables.heading' => 'Các bảng sau đây sẽ bị xóa và tạo lại trống:',
    'debug.reset.tree.title' => 'Đặt lại Hóa đơn, Báo giá và Đơn đặt hàng',
    'debug.reset.tree.warning' => 'Thao tác này sẽ xóa vĩnh viễn mọi hóa đơn, báo giá và đơn đặt hàng cùng tất cả các mục hàng, số tiền, thuế suất, trường tùy chỉnh và phí chiết khấu của chúng. Một bản sao lưu nén gzip sẽ được ghi vào thư mục /backups trước, nhưng không thể hoàn tác thao tác này từ màn hình này.',
    'debug.reset.tree.wrong.password' => 'Mật khẩu cơ sở dữ liệu không chính xác, không có gì thay đổi.',
    ...
    'default.list.limit.hint' => 'Thiết lập số lượng hàng hiển thị trên các trang danh sách. Lưu ngay lập tức — hiệu lực hiển thị khi bạn truy cập vào danh sách.',
    ...
    'delete.invoice.action' => 'Hành động xóa hóa đơn',
    'delete.invoice.archive' => 'Hóa đơn lưu trữ',
    'delete.invoice.date.soft.deleted' => 'Đã xóa tạm thời (Chi tiết có thể khôi phục)',
    'delete.invoice.restore' => 'Khôi phục',
    'delete.invoice.restore.warning' => 'Bạn có chắc chắn muốn khôi phục hóa đơn này không?',
    'delete.invoice.restored' => 'Hóa đơn đã được khôi phục thành công.',
    'delete.invoice.trash' => 'Hóa đơn rác',
    'delete.invoice.trash.empty' => 'Không có hóa đơn nào được lưu trữ.',
    ...
    'delete.quote.derived' => 'Có thể là Đơn đặt hàng bán hoặc Hóa đơn được liên kết với Báo giá này và do đó không thể xóa được.',
    'delete.quote.single' => 'Có thể xóa báo giá này vì không có Đơn đặt hàng hoặc Hóa đơn nào được liên kết với nó',
    ...
    'delivery.location.peppol.output.fix' => 'Đặt ngay bây giờ',
    ...
    'do.not.send.blocksBulkSent' => 'Hóa đơn chưa được đánh dấu là đã gửi — Đã đặt cờ &quot;Không gửi&quot;.',
    'do.not.send.blocksEmail' => 'Hóa đơn này được đánh dấu là &quot;Không gửi&quot; và không thể gửi qua email cho khách hàng.',
    'do.not.send.flashCleared' => 'Cờ &quot;Không gửi&quot; đã được xóa.',
    'do.not.send.flashSet' => 'Đã đặt cờ &quot;Không gửi&quot; — hóa đơn này không thể được đánh dấu là đã gửi cho đến khi được chấp thuận.',
    'do.not.send.not.set' => 'Chưa được thiết lập',
    'do.not.send.reason.customer_dispute' => 'Tranh chấp của khách hàng',
    'do.not.send.reason.damage_occurred' => 'Thiệt hại đã xảy ra',
    'do.not.send.reason.job_incomplete' => 'Công việc chưa hoàn thành',
    'do.not.send.reason.other' => 'Khác',
    'do.not.send.reason.property_inaccessible' => 'Tài sản không thể tiếp cận',
    'do.not.send.reason.safety_concern' => 'Mối quan ngại về an toàn',
    ...
    'due.date' => 'Hai Ngày',
    'dwelling' => 'Nơi ở',
    'dwelling.add' => 'Thêm nhà ở',
    'dwelling.edit' => 'Chỉnh sửa nhà ở',
    'dwelling.family' => 'Đường phố',
    'dwelling.flat.unit' => 'Căn hộ/Đơn vị',
    'dwelling.house.number' => 'Số nhà',
    'dwelling.house.number.suffix' => 'Hậu tố số nhà',
    'dwelling.latitude' => 'Vĩ độ',
    'dwelling.longitude' => 'Kinh độ',
    'dwelling.plural' => 'Nhà ở',
    'dwelling.postcode' => 'Mã bưu điện',
    'dwelling.source' => 'Nguồn',
    ...
    'email.client' => 'Trình soạn thảo email',
    ...
    'email.invoice.created.body' => '
        <h2>Kính gửi {client_name},</h2><p> Chúng tôi đã tạo một hóa đơn mới cho bạn:</p><ul><li> <strong>Số hóa đơn:</strong> #{invoice_number}</li><li> <strong>Ngày:</strong> {invoice_date}</li><li> <strong>Ngày đến hạn:</strong> {due_date}</li><li> <strong>Số tiền:</strong> {amount}</li></ul><p> <a href="{view_link}">Xem hóa đơn</a> | <a href="{payment_link}">Thanh toán ngay</a></p><p> Điều khoản thanh toán: {payment_terms}</p><p> Trân trọng,<br> {tên_công_ty}</p>
    ',
    'email.invoice.created.subject' => 'Hóa đơn mới số #{invoice_number} từ {company_name}',
    'email.invoice.overdue.subject' => 'QUÁ HẠN: Hóa đơn số {invoice_number} - Cần xử lý ngay lập tức',
    'email.invoice.reminder.subject' => 'Nhắc nhở thanh toán - Hóa đơn số {invoice_number}',
    ...
    'email.logs.table' => 'Bảng ghi nhật ký email liên quan đến hóa đơn này.',
    ...
    'family.comma.list' => 'Danh sách số sản phẩm, ví dụ: 1, 2, 5, 7 dành cho Trình tạo sản phẩm',
    'family.history' => 'Lịch sử gia đình tồn tại.Không thể xóa',
    'family.name' => 'Họ tên',
    'family.product.prefix' => 'Danh sách mã số sản phẩm, tiền tố, ví dụ: Nhà',
    'family.product.prefix.required.when.commalist.filled' => 'Tiền tố sản phẩm là bắt buộc khi cung cấp danh sách dấu phẩy.',
    ...
    'faq.homecare.auto.invoice' => 'Hóa đơn tự động cho dịch vụ vệ sinh nhà cửa là gì?',
    ...
    'faq.sort.order' => 'Thứ tự sắp xếp',
    'faq.taxpoint' => 'Làm thế nào để xác định Điểm thuế là gì?',
    'faq.wsl.to.alpine' => 'Làm thế nào để cập nhật một trang web được lưu trữ trên Alpine bằng WSL (Windows Subsystem for Linux) của Windows 11?',
    ...
    'gateway.status.page.summary' => 'Trang %d trên %d',
    'gender' => 'Giới tính',
    ...
    'generator.google.translate.all.locales' => 'Google Translate cho tất cả các ngôn ngữ (Diff)',
    ...
    'generator.google.translate.info' => 'Dịch tài liệu thông tin (invoice.php)',
    ...
    'gln' => 'GLN',
    'gocardless.direct.debit.collection.scheduled.for' => 'Khoản thanh toán tự động của bạn dự kiến ​​được thực hiện vào lúc %s.',
    'gov.developer.sandbox' => 'Sandbox dành cho nhà phát triển',
    'gov.developer.sandbox.uk' => 'Hmrc',
    'grand.fathered' => 'Ông nội',
    'grid.sticky.header' => 'Tiêu đề lưới cố định',
    'grid.sticky.header.hint' => 'Giữ tiêu đề cột luôn ở đầu trang khi cuộn danh sách dài các hóa đơn, báo giá, đơn đặt hàng hoặc sản phẩm. Hiệu ứng được lưu ngay lập tức — hiển thị khi bạn truy cập vào danh sách.',
    ...
    'home' => 'Trang chủ',
    'home.admin.setup.walkthrough' => 'Hướng dẫn thiết lập quản trị viên',
    'home.built.on.yii3' => 'Được xây dựng trên framework PHP {yii3_link}. Biểu tượng Yii 3 hiển thị ở trên là nhãn hiệu chính thức của {yii_software_link}, được sử dụng nguyên trạng theo giấy phép {license_link} của họ.',
    ...
    'home.description' => 'Một nền tảng lập hóa đơn tự lưu trữ, mã nguồn mở được xây dựng bằng PHP trên framework Yii3. Nền tảng này tạo ra các hóa đơn điện tử tuân thủ tiêu chuẩn Peppol/UBL 2.4 (bao gồm cả truyền tải AS4), chấp nhận thanh toán trực tuyến thông qua 17 cổng thanh toán tích hợp trải rộng khắp Châu Âu, Bắc và Nam Mỹ, Châu Á, Châu Phi và Châu Đại Dương, và bao gồm một mô-đun Chăm sóc tại nhà để tự động hóa việc lập hóa đơn dịch vụ định kỳ — lên lịch dọn dẹp, phân bổ nhân viên và một ứng dụng web tiến bộ (PWA) có khả năng hoạt động ngoại tuyến dành cho nhân viên làm việc tại hiện trường. Các lệnh điều khiển theo lịch trình xử lý việc sao lưu tự động và lập hóa đơn định kỳ.',
    'home.github.click.tracking.explanation' => 'Việc nhấp chuột vào liên kết đến GitHub sẽ ghi lại quốc gia mà giao dịch đến từ (không có thông tin nhận dạng nào khác ngoài điều đó) — điều này giúp trực tiếp quyết định cổng thanh toán nào sẽ được ưu tiên tiếp theo, vì những khu vực mà chúng tôi nhận thấy có sự quan tâm thực sự là những khu vực đáng để phát triển.',
    'home.hmrc.api.status' => 'Trạng thái API của HMRC ➡️',
    'home.oauth2.client.description' => 'Một dự án phát triển riêng biệt, có liên quan — thư viện máy khách OAuth 2.0 dành cho framework Yii3.',
    'home.oauth2.client.heading' => 'Cũng trên trang web này: Phát triển ứng dụng khách OAuth2.0',
    'home.open.source.license' => 'Mã nguồn mở theo giấy phép BSD-3-Clause.',
    'home.payment.gateway.coverage' => 'Phạm vi phủ sóng của cổng thanh toán ➡️',
    'home.peppol.access.point.status' => 'Trạng thái điểm truy cập Peppol ➡️',
    'home.title' => 'Yii3-i — Hệ thống lập hóa đơn và hóa đơn điện tử mã nguồn mở',
    'home.view.source.github' => '⭐ Xem mã nguồn trên GitHub — github.com/rossaddison/invoice',
    'homecare' => 'Chăm sóc tại nhà',
    'homecare.auto.invoice.enabled' => 'Kích hoạt tính năng tự động lập hóa đơn QR cho dịch vụ chăm sóc tại nhà',
    'homecare.column.client.active' => 'Máy khách đang hoạt động',
    'homecare.column.delivery.add' => 'Thêm phí giao hàng',
    'homecare.column.pdf.email' => 'Hành động đối với PDF / Email',
    'homecare.column.quick.pay' => 'Thanh toán nhanh',
    'homecare.column.workflow.type' => 'Loại quy trình làm việc',
    'homecare.column.year.month' => 'Năm-Tháng',
    'homecare.current.run' => 'Lần chạy hiện tại',
    'homecare.current.run.category.secondary' => 'Đợt chạy hiện tại — Khu vực',
    'homecare.current.run.last.run.date' => 'Lần chạy hiện tại — Ngày chạy cuối cùng',
    'homecare.hidden.columns' => 'Cột inv/index — Chế độ HomeCare',
    'homecare.hidden.columns.description' => 'Ẩn các cột này trên inv/index khi tính năng Tự động lập hóa đơn QR cho dịch vụ Chăm sóc tại nhà được bật, để người quản lý có thể thấy lưới hiển thị ngắn gọn và dễ sử dụng hơn trên điện thoại. Các cột Nhân viên, Số tiền và Không gửi luôn hiển thị. Lưới hiển thị chung không bị ảnh hưởng khi tính năng Tự động lập hóa đơn QR cho dịch vụ Chăm sóc tại nhà bị tắt.',
    'homecare.hidden.columns.guest' => 'Cột inv/guest — Chế độ Chăm sóc tại nhà',
    'homecare.hidden.columns.guest.description' => 'Ẩn các cột này trên lưới hóa đơn dành cho khách hàng (inv/guest) khi tính năng Tự động tạo hóa đơn bằng mã QR của Home Care được bật. Số hóa đơn, số lượt tải xuống PDF và trạng thái vẫn hiển thị. Lưới thông tin khách hàng chung không bị ảnh hưởng khi tính năng Tự động tạo hóa đơn bằng mã QR của Home Care bị tắt.',
    'homecare.mobile.rotate.tip.body' => 'Nếu giao diện inv/index trông chật chội ở chế độ dọc, hãy thử chế độ ngang. Vuốt xuống từ góc trên bên phải để mở Cài đặt nhanh, sau đó vuốt xuống một lần nữa để mở rộng – biểu tượng khóa xoay nằm trong bảng điều khiển được mở rộng.',
    'homecare.mobile.rotate.tip.title' => 'Mẹo dành cho Android:',
    'homecare.offline.download.button' => '📥 Tải xuống để xem ngoại tuyến',
    'homecare.offline.download.failed' => 'Không thể tải xuống hóa đơn để sử dụng ngoại tuyến — vui lòng thử lại khi có kết nối internet.',
    'homecare.offline.download.success' => 'Đã tải xuống hóa đơn %s để sử dụng ngoại tuyến.',
    'homecare.offline.downloaded.at' => 'Đã tải xuống',
    'homecare.offline.empty' => 'Chưa có hóa đơn nào được tải xuống. Hãy kết nối internet và nhấn vào &quot;Tải xuống để xem ngoại tuyến&quot; từ danh sách hóa đơn của bạn trước.',
    'homecare.offline.install.button' => '📲 Cài đặt ứng dụng',
    'homecare.offline.install.generic.message' => 'Hãy cài đặt ứng dụng này để truy cập ngoại tuyến trong thời gian dài hơn vài ngày.',
    'homecare.offline.install.ios.message' => 'Để truy cập ngoại tuyến mà không cần kết nối trong vài ngày, hãy nhấn Chia sẻ, sau đó chọn &quot;Thêm vào màn hình chính&quot;.',
    'homecare.offline.title' => 'Hóa đơn ngoại tuyến của tôi',
    'homecare.offline.view.button' => '📱 Xem bản sao ngoại tuyến',
    'homecare.runsheet.index.description' => 'Xuất kết quả chạy bộ hôm nay (hoặc trước đó) dưới dạng tờ in, sau đó quay lại đây sau khi đã ký và quét xong.',
    'homecare.runsheet.index.export' => 'Bảng báo cáo xuất khẩu',
    'homecare.runsheet.index.export.invalid' => 'Hãy chọn lần chạy và ngày hợp lệ trước khi xuất dữ liệu.',
    'homecare.runsheet.index.items' => 'Mặt hàng',
    'homecare.runsheet.index.recent' => 'Bảng thống kê hoạt động gần đây',
    'homecare.runsheet.index.run.date' => 'Ngày chạy',
    'homecare.runsheet.index.title' => 'Phiếu ghi chép hoạt động chăm sóc tại nhà',
    'homecare.runsheet.nav' => 'Bảng kê chi tiết',
    'homecare.runsheet.review.accept' => 'Chấp nhận',
    'homecare.runsheet.review.applied' => 'Phiếu chạy đơn đã được áp dụng — hóa đơn đã được cập nhật và đơn hàng đã được đánh dấu là đã gửi.',
    'homecare.runsheet.review.apply' => 'Áp dụng &amp; Đánh dấu Đã gửi',
    'homecare.runsheet.review.apply.description' => 'Hệ thống sẽ ghi tất cả các điều chỉnh đã được chấp nhận ở trên vào hóa đơn tương ứng, sau đó đánh dấu mọi hóa đơn trong đợt này là đã gửi để hiển thị ở phía khách hàng. Thao tác này không thể hoàn tác từ màn hình này.',
    'homecare.runsheet.review.apply.not.ready' => 'Phiếu chạy này hiện không thể được áp dụng — có thể nó đã được áp dụng rồi, hoặc quá trình quét chưa được thực hiện.',
    'homecare.runsheet.review.client' => 'Khách hàng',
    'homecare.runsheet.review.completed' => 'Hoàn thành',
    'homecare.runsheet.review.description' => 'Chỉ những hóa đơn có ghi chú viết tay trên phiếu in khác với bản in mới được liệt kê ở đây — hãy xác nhận lại từng hóa đơn trước khi đưa chúng trở lại danh sách hóa đơn.',
    'homecare.runsheet.review.detected.worker' => 'Công nhân được phát hiện',
    'homecare.runsheet.review.download' => 'Tải xuống bảng thống kê hoạt động (CSV)',
    'homecare.runsheet.review.expected.worker' => 'Người lao động dự kiến',
    'homecare.runsheet.review.invoice' => 'Hóa đơn',
    'homecare.runsheet.review.no.changes' => 'Không phát hiện thấy thay đổi nào trên phiếu chạy này — không có gì cần xem xét.',
    'homecare.runsheet.review.reason' => 'Lý do',
    'homecare.runsheet.review.save' => 'Lưu các điều chỉnh',
    'homecare.runsheet.review.saved' => 'Các điều chỉnh đã được lưu.',
    'homecare.runsheet.review.status' => 'Trạng thái',
    'homecare.runsheet.review.title' => 'Bảng theo dõi hoạt động chăm sóc tại nhà — Xem xét các điều chỉnh',
    'homecare.runsheet.review.upload.api.failed' => 'Quá trình đọc hình ảnh thất bại — hãy kiểm tra khóa API và số dư tài khoản Anthropic trong Cài đặt, sau đó thử lại. Tệp quét đã được lưu; bạn có thể thử lại quy trình này.',
    'homecare.runsheet.review.upload.button' => 'Tải lên &amp; Đọc',
    'homecare.runsheet.review.upload.done' => 'Bản quét đã được tải lên và đọc — xem lại các điều chỉnh đã phát hiện bên dưới.',
    'homecare.runsheet.review.upload.invalid' => 'Chọn định dạng tệp hình ảnh (JPEG, PNG, GIF hoặc WebP) để tải lên.',
    'homecare.runsheet.review.upload.label' => 'Tải lên bản scan/ảnh chụp phiếu chạy xe.',
    'homecare.runsheet.review.upload.not.configured' => 'Khóa API Vision chưa được cấu hình — hãy yêu cầu quản trị viên thiết lập khóa này trong phần Cài đặt trước khi tải ảnh quét lên.',
    'homecare.scan.contact.us' => 'Chúng tôi không thể xử lý bản quét này. Vui lòng liên hệ trực tiếp với chúng tôi.',
    'homecare.scan.not.eligible' => 'Hiện tại chưa cần lập hóa đơn mới. Nếu bạn cho rằng đây là một sai sót, vui lòng liên hệ với chúng tôi.',
    'homecare.scan.thanks' => 'Cảm ơn bạn — hóa đơn của bạn đã được tạo và sẵn sàng để xem trong tài khoản của bạn.',
    'homecare.scan.title' => 'Chăm sóc tại nhà',
    'homecare.signup.category.new.area' => 'Khu vực của tôi không có trong danh sách — đây là một khu vực mới.',
    'homecare.signup.confirmed.expired' => 'Liên kết xác nhận này đã hết hạn hoặc đã được sử dụng. Vui lòng đăng ký lại.',
    'homecare.signup.confirmed.paid' => 'Cảm ơn bạn — tài khoản của bạn đã được thiết lập và hóa đơn đầu tiên đã được thanh toán. Mã QR của bạn ở bên dưới: hãy dán mã này ở nơi dễ nhìn thấy và quét mã sau mỗi lần truy cập để tự động yêu cầu hóa đơn tiếp theo.',
    'homecare.signup.confirmed.setup.incomplete' => 'Chúng tôi không thể hoàn tất thiết lập tài khoản của bạn. Vui lòng liên hệ trực tiếp với chúng tôi.',
    'homecare.signup.confirmed.unpaid' => 'Cảm ơn bạn — tài khoản của bạn đã được thiết lập và hóa đơn đầu tiên đã được gửi. Mã QR của bạn đã sẵn sàng để in, nhưng chức năng quét tự động để in hóa đơn chỉ hoạt động sau khi hóa đơn đó được đánh dấu là đã thanh toán.',
    'homecare.signup.payment.have.paid.cash' => 'Tôi đã thanh toán bằng tiền mặt rồi.',
    'homecare.signup.payment.will.pay.today' => 'Tôi sẽ thanh toán hôm nay',
    'homecare.signup.street.name' => 'Tên đường',
    'homecare.signup.title' => 'Đăng ký dịch vụ chăm sóc tại nhà',
    'homecare.vision.api.key' => 'Khóa API Anthropic',
    'homecare.vision.api.key.description' => 'Bước này là bắt buộc đối với bước &quot;Tải lên &amp; Đọc&quot; trên màn hình xem lại phiếu ghi chép chăm sóc tại nhà, cho phép đọc các ghi chú viết tay trên phiếu ghi chép đã quét thông qua phần mềm nhận dạng hình ảnh Claude Haiku 4.5. Để trống nếu muốn tắt bước này.',
    'homecare.vision.api.key.get' => 'Lấy khóa API ↗',
    'homecare.vision.api.key.title' => 'Bảng thông tin vận hành Quét thị giác',
    'homecare.visit.log.description' => 'Mọi lần quét mã QR dịch vụ vệ sinh nhà cửa và kết quả đều được hiển thị, chỉ dành cho nhân viên xem — trang kết quả quét dành cho khách hàng được thiết kế chung chung và không bao giờ hiển thị mức độ chi tiết này.',
    'homecare.visit.log.invoice' => 'Hóa đơn',
    'homecare.visit.log.outcome' => 'Kết quả',
    'homecare.visit.log.reason' => 'Lý do (chỉ dành cho nhân viên)',
    'homecare.visit.log.sent.status' => 'Trạng thái đã gửi',
    'homecare.visit.log.sent.status.tooltip' => 'Hóa đơn tự động của HomeCare luôn được tạo với trạng thái &#39;Đã gửi&#39;, bất kể cài đặt &#39;Đánh dấu hóa đơn là đã gửi khi sao chép hóa đơn&#39; — cài đặt đó chỉ áp dụng cho các công cụ sao chép hóa đơn khác. Nhấn/nhấp để mở.',
    'homecare.visit.log.title' => 'Nhật ký quét mã QR HomeCare',
    'homecare.visit.log.visited.at' => 'Đã ghé thăm',
    ...
    'install.pdf.viewer.extension' => 'Cài đặt tiện ích mở rộng Trình xem PDF',
    ...
    'interface' => 'Giao diện',
    'inv.cdn.not.node.module' => 'Hãy sử dụng InvoiceCdnAsset (không phải InvoiceNodeModulesAsset)',
    'invalid.amount' => 'Số tiền không hợp lệ',
    'invalid.subscriber.number' => 'Số thuê bao không hợp lệ',
    'invoice' => 'Hóa đơn',
    'invoice.created.from.quote' => 'Hóa đơn được tạo từ báo giá',
    'invoice.needs.to.be.sent' => 'Để thấy nút Thanh toán thay đổi trạng thái thành Đã gửi.',
    'invoice.origin' => 'Nguồn gốc',
    'invoice.status.cannot.revert' => 'Hóa đơn đã phát hành không thể được hoàn trả về trạng thái trước đó. Hãy hủy bỏ hóa đơn (nếu chưa thanh toán) hoặc phát hành phiếu ghi nợ.',
    'invoice.status.issued' => 'Đã phát hành',
    'invoice.status.void' => 'Hư không',
    'invoice.to.html' => 'Chuyển đổi hóa đơn sang HTML',
    'invoice.trash' => 'Hóa đơn rác',
    'invoice.validation.errors' => 'Lỗi xác thực hóa đơn',
    'invoice.void' => 'Hóa đơn hủy bỏ',
    'invoice.void.confirm' => 'Bạn muốn hủy hóa đơn này? Hóa đơn sẽ bị hủy, giữ nguyên số hiệu và không thể chỉnh sửa hoặc thanh toán nữa.',
    'invoice.void.not.allowed' => 'Chỉ những hóa đơn đã phát hành hoặc đã xem mà chưa có khoản thanh toán nào mới có thể bị hủy bỏ. Thay vào đó, hãy phát hành phiếu ghi nợ.',
    'invoice.void.selected.confirm' => 'Hủy bỏ các hóa đơn đã chọn? Chỉ những hóa đơn đã phát hành hoặc đã xem mà chưa được thanh toán mới bị hủy bỏ; chúng vẫn giữ nguyên số hiệu và không thể chỉnh sửa thêm.',
    'invoice.void.success' => 'Hóa đơn đã bị hủy.',
    ...
    'layout.password.otp.6' => 'Mật khẩu OTP (6 chữ số)',
    'layout.password.otp.6.8' => 'Mật khẩu OTP (6 chữ số) / Mã khôi phục dự phòng (8 chữ số)',
    'layout.password.otp.6.first' => 'Nhập mã 6 chữ số từ ứng dụng xác thực của bạn.',
    'layout.password.otp.recovery.8' => 'Nhập mã khôi phục bản sao lưu của bạn (8 ký tự)',
    'layout.password.otp.use.6.digit.code' => 'Thay vào đó, hãy sử dụng mã 6 chữ số của bạn.',
    'layout.password.otp.use.recovery.code' => 'Thay vào đó, hãy sử dụng mã khôi phục.',
    'layout.password.otp.verify.6' => 'Nhập mật khẩu OTP thứ hai khác do Aegis tạo ra (6 chữ số)',
    ...
    'location' => 'Vị trí',
    'location.accuracy' => 'Sự chính xác',
    'location.latitude' => 'Vĩ độ',
    'location.longitude' => 'Kinh độ',
    'location.test.button' => 'Kiểm tra vị trí của tôi',
    'location.tester' => 'Kiểm tra vị trí thiết bị của bạn',
    'location.tester.description' => 'Ứng dụng này sử dụng quyền truy cập vị trí của trình duyệt để hiển thị tọa độ GPS hiện tại của thiết bị. Không có dữ liệu nào được lưu lại — việc này chỉ nhằm xác nhận chức năng định vị hoạt động trên thiết bị này trước khi sử dụng nó ở những nơi khác. Ứng dụng yêu cầu HTTPS và chấp nhận lời nhắc cấp quyền truy cập vị trí.',
    'login' => 'Đăng nhập',
    ...
    'loginalert.user.emailnotverified' => 'Truy cập bị từ chối: Vui lòng nhấp vào liên kết xác minh được gửi đến địa chỉ email của bạn.',
    ...
    'menu.contact.interest' => 'Mẫu báo giá/liên hệ thương mại',
    ...
    'menu.gateway.status' => 'Trạng thái cổng thanh toán',
    'menu.hmrc.api.status' => 'Trạng thái API của HMRC',
    'menu.language' => 'Ngôn ngữ',
    'menu.login' => 'Đăng nhập',
    'menu.logout' => 'Đăng xuất ({login})',
    'menu.more' => 'Hơn',
    'menu.peppol.status' => 'Trạng thái điểm truy cập Peppol',
    'menu.pricing' => 'Giá cả',
    ...
    'menu.webshop' => 'Cửa hàng trực tuyến',
    ...
    'mobile' => 'Di động',
    'mobile.hint' => 'Ví dụ: +447700900000',
    'mobile.number' => 'Số điện thoại di động',
    'mobile.placeholder' => '+447700900000',
    'monday' => 'Thứ hai',
    'monitoring.health.cache' => 'Hệ thống bộ nhớ đệm',
    'monitoring.health.database' => 'Kết nối cơ sở dữ liệu',
    'monitoring.health.storage' => 'Lưu trữ tệp',
    'monitoring.metrics.errors' => 'Tỷ lệ lỗi',
    'monitoring.metrics.requests' => 'Tổng số yêu cầu',
    'monitoring.metrics.response_time' => 'Thời gian phản hồi trung bình',
    ...
    'mtd.business.missing.nino.or.token' => 'Mã số bảo hiểm quốc gia hoặc mã truy cập HMRC chưa được thiết lập.',
    'mtd.eori' => 'Mã số đăng ký và nhận dạng doanh nghiệp (EORI)',
    'mtd.eori.hint' => 'Cần xác định doanh nghiệp này cho API Khai báo Hải quan của HMRC -- ví dụ: GB123456789000',
    'mtd.fph' => 'Tiêu đề phòng ngừa gian lận',
    'mtd.fph.all.valid' => 'Tất cả các tiêu đề phòng ngừa gian lận đều hợp lệ',
    'mtd.fph.feedback.client.credentials.error' => 'HMRC đã từ chối yêu cầu cấp mã thông báo truy cập hạn chế ứng dụng: "{error}" — {description}',
    'mtd.fph.feedback.no.client.credentials.token' => 'DEVELOPER_GOV_SANDBOX_HMRC_API_CLIENT_ID hoặc _CLIENT_SECRET không được thiết lập trong .env -- FPH Feedback cần mã thông báo truy cập hạn chế ứng dụng riêng từ HMRC, tách biệt với mã thông báo được sử dụng bởi mọi trang HMRC khác ở đây.',
    'mtd.fph.feedback.unexpected.token.response' => 'HMRC đã trả về mã 200 cho yêu cầu mã thông báo truy cập bị hạn chế theo ứng dụng, nhưng không có access_token nào trong phần thân phản hồi.',
    'mtd.fph.generate' => 'Phát ra',
    'mtd.fph.manage.subscriptions.link.text' => 'thêm vào đây',
    'mtd.fph.missing.hmrc.token' => 'Bạn chưa đăng nhập vào HMRC. Vui lòng nhấp vào {link}, sau đó thử lại.',
    'mtd.fph.missing.otp.session' => 'Thông tin xác thực hai yếu tố của bạn bị thiếu hoặc đã hết hạn, đây là thông tin cần thiết cho quá trình kiểm tra Tiêu đề Phòng chống Gian lận. Hãy đăng xuất và đăng nhập lại, sau đó thử lại.',
    ...
    'mtd.fph.validate.error.generic' => 'HMRC đã trả về lỗi khi xác thực Tiêu đề Phòng chống Gian lận của bạn: "{code}" — {message}',
    'mtd.fph.validate.error.not.subscribed' => 'HMRC đã trả về "{code}": {message} Ứng dụng Developer Hub của bạn cần thêm API Test Fraud Prevention Headers vào phần đăng ký — {link}.',
    ...
    'mtd.hmrc' => 'Chương trình số hóa thuế của HMRC (Cơ quan Thuế Vương quốc Anh)',
    'mtd.hmrc.developer.hub' => 'Trung tâm phát triển của HMRC',
    'mtd.hmrc.developer.hub.add.production.application' => 'Thêm ứng dụng sản xuất',
    'mtd.hmrc.developer.hub.add.sandbox.application' => 'Thêm ứng dụng hộp cát',
    'mtd.hmrc.developer.hub.application.id' => 'ID ứng dụng Developer Hub',
    'mtd.hmrc.developer.hub.application.id.not.set' => 'Chưa được thiết lập — hãy thêm DEVELOPER_GOV_SANDBOX_HMRC_API_APPLICATION_ID vào tệp .env (UUID từ URL "Quản lý ứng dụng" của Developer Hub, chứ không phải client_id của OAuth)',
    'mtd.hmrc.developer.hub.change.name.and.description' => 'Thay đổi tên và mô tả',
    'mtd.hmrc.developer.hub.change.password' => 'Thay đổi mật khẩu',
    'mtd.hmrc.developer.hub.client.secrets' => 'bí mật khách hàng',
    'mtd.hmrc.developer.hub.delete.application' => 'Xóa ứng dụng',
    'mtd.hmrc.developer.hub.email.preferences' => 'Tùy chọn email',
    'mtd.hmrc.developer.hub.ip.allowlist' => 'danh sách IP cho phép',
    'mtd.hmrc.developer.hub.login' => 'Đăng nhập',
    'mtd.hmrc.developer.hub.logout' => 'Đăng xuất',
    'mtd.hmrc.developer.hub.manage.application' => 'Quản lý ứng dụng',
    'mtd.hmrc.developer.hub.profile' => 'Hồ sơ',
    'mtd.hmrc.developer.hub.redirect.uris' => 'URI chuyển hướng',
    'mtd.hmrc.developer.hub.security.preferences' => 'Tùy chọn bảo mật',
    'mtd.hmrc.developer.hub.subscriptions' => 'Đăng ký',
    'mtd.hmrc.developer.hub.tc.and.privacy.policy.url' => 'Điều khoản và điều kiện / URL chính sách bảo mật',
    'mtd.hmrc.developer.hub.team.members' => 'Thành viên nhóm',
    'mtd.individual.calculations.trigger.error' => 'Cơ quan thuế HMRC đã trả về lỗi kích hoạt quá trình tính toán: "{code}" — {message}',
    'mtd.individual.calculations.triggered' => 'Quá trình tính toán được kích hoạt (ID: {calculationId}).',
    'mtd.nino' => 'Mã số bảo hiểm quốc gia (NINO)',
    'mtd.nino.hint' => 'Cần thiết cho mọi API dựa trên NINO bên dưới (Doanh nghiệp tự kinh doanh, Chi tiết doanh nghiệp, v.v.) -- đối với môi trường thử nghiệm của HMRC, hãy sử dụng NINO được trả về bởi hàm Tạo người dùng thử nghiệm, chứ không phải NINO thật của bạn.',
    'mtd.vat.obligations' => 'Nghĩa vụ thuế GTGT',
    'mtd.vat.obligations.missing.vrn.or.token' => 'Mã số đăng ký VAT hoặc mã truy cập HMRC chưa được thiết lập.',
    'mtd.vat.registration.number' => 'Mã số thuế GTGT (VRN)',
    'mtd.vat.registration.number.hint' => 'Mã số gồm 9 chữ số trên giấy chứng nhận đăng ký thuế GTGT của bạn.',
    'mtd.vat.return.error.client_or_agent_not_authorised' => 'Tài khoản này không được phép nộp tờ khai thuế GTGT cho mã số thuế GTGT này.',
    'mtd.vat.return.error.duplicate_submission' => 'Tờ khai thuế GTGT cho kỳ này đã được nộp.',
    'mtd.vat.return.error.invalid_monetary_amount' => 'Một trong các số tiền đã nhập không phải là giá trị tiền tệ hợp lệ (từ 0 đến 99.999.999.999,99, làm tròn đến 2 chữ số thập phân).',
    'mtd.vat.return.error.invalid_numeric_value' => 'Một trong các giá trị đã gửi không phải là số hợp lệ.',
    'mtd.vat.return.error.invalid_request' => 'Cơ quan thuế HMRC đã bác bỏ yêu cầu này vì cho rằng nó không đúng quy cách.',
    'mtd.vat.return.error.not_finalised' => 'Tờ khai này chưa được xác nhận là tờ khai cuối cùng -- hãy đánh dấu vào ô xác nhận và gửi lại.',
    'mtd.vat.return.error.period_key_invalid' => 'Mã kỳ kế toán cho tờ khai thuế GTGT này không hợp lệ hoặc không được nhận diện.',
    'mtd.vat.return.error.rule_insolvent_trader' => 'Theo hồ sơ của HMRC, thương nhân này đã mất khả năng thanh toán, do đó không thể chấp nhận tờ khai thuế.',
    'mtd.vat.return.error.tax_period_not_ended' => 'Kỳ tính thuế này vẫn chưa kết thúc -- HMRC không thể chấp nhận tờ khai trước khi kỳ tính thuế kết thúc.',
    'mtd.vat.return.error.vat_net_value' => 'Ô số 5 (Thuế GTGT ròng phải nộp) phải bằng hiệu số giữa ô số 3 và ô số 4.',
    'mtd.vat.return.error.vat_total_value' => 'Ô số 3 (Tổng thuế GTGT phải nộp) phải bằng Ô số 1 + Ô số 2.',
    'mtd.vat.return.error.vrn_invalid' => 'Mã số thuế GTGT được cung cấp không hợp lệ.',
    'mtd.vat.return.submit' => 'Nộp tờ khai thuế GTGT',
    ...
    'oauth2.backup.recovery.codes' => 'Mã khôi phục dự phòng.Giữ ở nơi an toàn.',
    'oauth2.backup.recovery.codes.regenerate' => 'Tạo lại mã khôi phục sao lưu',
    'oauth2.consent.required' => 'Cần có sự đồng ý',
    'oauth2.default' => 'Cấu hình oauth2.0 mặc định được sử dụng',
    ...
    'oauth2.missing.authentication.code.or.state.parameter' => 'Thiếu mã xác thực hoặc tham số trạng thái.',
    'oauth2.missing.state.parameter.possible.csrf.attack' => 'Thiếu tham số trạng thái.Có thể bị tấn công CSRF',
    'oauth2.server.error' => 'Lỗi máy chủ',
    'oauth2.temporarily.unavailable' => 'Tạm thời không có sẵn',
    'oauth2.test.user.creation.not.allowed.prod.env' => 'Không được phép tạo người dùng thử nghiệm trong môi trường sản xuất.',
    'oauth2.unauthorized.client' => 'Khách hàng không được ủy quyền',
    'oauth2.unsupported.grant.type' => 'Loại tài trợ không được hỗ trợ',
    'oauth2.unsupported.response.type' => 'Loại phản hồi không được hỗ trợ',
    'off' => 'Tắt',
    'on' => 'TRÊN',
    'online.bookkeeping' => 'Kế toán trực tuyến',
    ...
    'online.payment.adyen.hmac.kcv.hint' => 'Adyen chỉ hiển thị giá trị của khóa HMAC mới một lần duy nhất — việc sao chép nó không giống với việc lưu trang cấu hình riêng của webhook. Hãy xác minh, sau đó so sánh KCV được hiển thị ở đây với KCV trong Khu vực Khách hàng của Adyen cho webhook này trước khi sử dụng nó.',
    'online.payment.adyen.hmac.kcv.not.configured' => 'Chưa cấu hình khóa HMAC của webhook Adyen, hoặc khóa đó không phải là mã thập lục phân hợp lệ.',
    'online.payment.adyen.hmac.kcv.result' => 'Mã KCV của khóa này là %s — hãy so sánh nó với mã KCV hiển thị trong Khu vực Khách hàng của Adyen cho webhook này. Nếu chúng không khớp, có thể khóa đã được sao chép nhưng chưa được lưu trên hệ thống của Adyen — hãy tạo lại khóa và nhớ nhấn Lưu lần này.',
    'online.payment.adyen.hmac.kcv.verify' => 'Xác minh khóa HMAC (hiển thị KCV)',
    ...
    'online.payment.bitpay.generic.complete.message' => 'Giao dịch thanh toán BitPay của bạn đang được xử lý. Hóa đơn của bạn sẽ tự động cập nhật sau khi BitPay xác nhận trên chuỗi khối — vui lòng kiểm tra trực tiếp hóa đơn để biết trạng thái mới nhất.',
    ...
    'online.payment.checkout_com.environmentSubdomain' => 'Miền con Môi trường',
    'online.payment.checkout_com.processingChannelId' => 'ID kênh xử lý',
    'online.payment.checkout_com.publicKey' => 'Khóa API công khai',
    'online.payment.checkout_com.secretKey' => 'Khóa API bí mật',
    'online.payment.checkout_com.webhookSecret' => 'Khóa chữ ký Webhook',
    'online.payment.clientId' => 'Mã khách hàng',
    'online.payment.clientKey' => 'Khóa khách hàng',
    ...
    'online.payment.find.here' => 'Tìm thấy ở đây →',
    'online.payment.for' => 'Thanh toán trực tuyến cho',
    'online.payment.for.invoice' => 'Thanh toán trực tuyến cho hóa đơn',
    'online.payment.get.credentials' => 'Lấy thông tin đăng nhập →',
    'online.payment.installationId' => 'Mã cài đặt',
    'online.payment.keyId' => 'Mã định danh chính',
    'online.payment.keySecret' => 'Bí mật quan trọng',
    'online.payment.locationId' => 'Mã định danh vị trí',
    'online.payment.login' => 'Đăng nhập người bán',
    'online.payment.merchantAccessCode' => 'Mã truy cập của thương gia',
    'online.payment.merchantAccount' => 'Tài khoản người bán',
    ...
    'online.payment.password1' => 'Mật khẩu #1',
    'online.payment.password2' => 'Mật khẩu #2',
    'online.payment.password3' => 'Mật khẩu #3 (API hoàn tiền, tùy chọn)',
    ...
    'online.payment.payment.processing' => 'Quá trình thanh toán hóa đơn %s vẫn đang được xử lý. Vui lòng quay lại sau để xác nhận.',
    'online.payment.payment.processing.generic' => 'Cảm ơn',
    ...
    'online.payment.posToken' => 'Mã POS',
    ...
    'online.payment.shopId' => 'Mã cửa hàng',
    'online.payment.signature' => 'Chữ ký',
    'online.payment.signingKid' => 'Mã định danh khóa ký (trẻ em)',
    ...
    'online.payment.thirdPartyProvider' => 'Nhà cung cấp bên thứ ba ví dụ như Wonderful',
    ...
    'online.payment.webhookHmacKey' => 'Khóa HMAC Webhook',
    'online.payment.webhookId' => 'ID Webhook',
    'online.payment.webhookSecret' => 'Bí mật Webhook',
    'online.payment.websiteKey' => 'Chìa khóa trang web',
    'online.payments' => 'Thanh toán trực tuyến',
    'open' => 'Mở',
    'open.banking.not.configured' => 'Open Banking chưa được cấu hình.Vui lòng liên hệ bộ phận hỗ trợ.',
    ...
    'oxalis' => 'Oxalis',
    'oxalis.env.not.set' => 'Chưa được thiết lập',
    'oxalis.env.only.note' => 'Oxalis được cấu hình thông qua các biến .env, không phải ở đây — phần mô tả bên dưới chỉ để đọc. Xem src/Invoice/Peppol/README.md để biết các bước thiết lập. Oxalis chưa được sử dụng cho lần gửi thực tế nào trong hệ thống này.',
    'oxalis.setup.guide' => 'Hướng dẫn thiết lập Oxalis →',
    'page' => 'Trang',
    'paid' => 'Trả',
    'password' => 'Mật khẩu',
    ...
    'payment.option' => 'Bạn muốn thanh toán bằng cách nào?',
    ...
    'payment.terms.immediate' => 'Thanh toán phải được thực hiện ngay lập tức.',
    'payment.terms.net15' => 'Thanh toán phải được thực hiện trong vòng 15 ngày.',
    'payment.terms.net30' => 'Thanh toán phải được thực hiện trong vòng 30 ngày.',
    'payment.terms.net60' => 'Thanh toán phải được thực hiện trong vòng 60 ngày.',
    ...
    'pdf.modal' => 'Modal Pdf',
    'pdf.playwright' => 'Chromium PDF (Nhà soạn kịch)',
    ...
    'pdf.render.playwright.failed' => 'Không thể hiển thị PDF thông qua Playwright.',
    'pdf.render.playwright.failed.solution' => 'Vui lòng thử lại. Nếu sự cố vẫn tiếp diễn, hãy kiểm tra xem lệnh `npm run build:playwright` đã được chạy chưa và tài khoản render đã cấu hình (PLAYWRIGHT_TEST_EMAIL trong .env) có thể đăng nhập được hay không.',
    ...
    'peppol.access.point' => 'Điểm truy cập Peppol',
    'peppol.access.point.get.credentials' => 'Lấy thông tin đăng nhập →',
    'peppol.access.point.hint' => 'Hãy chọn điểm truy cập nào thực sự truyền tải tài liệu Peppol của bạn, sau đó điền thông tin chi tiết của nhà cung cấp đó bên dưới — chỉ thẻ của nhà cung cấp đã chọn mới được sử dụng khi gửi.',
    'peppol.access.point.provider' => 'Nhà cung cấp điểm truy cập',
    ...
    'peppol.allowance.or.charge.inherit.inv' => 'Phí dự toán hóa đơn và phí dự toán mặt hàng hóa đơn được kế thừa từ phí dự toán cấp độ tài liệu Peppol đã hoàn tất.',
    'peppol.allowance.or.charge.inherit.quote' => 'Phí dự toán báo giá và phí dự toán mặt hàng báo giá được kế thừa từ phí dự toán cấp độ tài liệu Peppol đã hoàn tất.',
    'peppol.auto.update.exchange.rate' => 'Tỷ giá hối đoái tự động cập nhật hàng ngày (tỷ giá của Ngân hàng Trung ương Châu Âu, không cần tra cứu thủ công trên xe.com)',
    'peppol.buyer.postal.address.not.found.fix' => 'Sửa ngay bây giờ',
    ...
    'peppol.client.check.missing' => 'Khách hàng này chưa thiết lập bất kỳ thông tin nào về Peppol.',
    'peppol.client.check.no.client' => 'Hóa đơn này không có thông tin khách hàng — Peppol không thể gửi hàng nếu thiếu thông tin khách hàng.',
    ...
    'peppol.currency.rate.last.updated' => 'Cập nhật lần cuối: {date}',
    'peppol.currency.to.from' => 'Một trong những loại tiền tệ To ngày nay chuyển đổi sang loại tiền tệ From',
    'peppol.debug.with.emojis' => 'Gỡ lỗi hóa đơn điện tử có biểu tượng cảm xúc',
    'peppol.debug.with.internal.validator' => 'Gỡ lỗi hóa đơn điện tử bằng Trình xác thực nội bộ',
    'peppol.doc.currency.toggle' => 'Peppol Toggle Doc Currency',
    'peppol.document.currency' => 'Peppol Document Currency - bật/tắt chế độ Xem',
    ...
    'peppol.endpointid.checksum.invalid' => 'Giá trị này không vượt qua bài kiểm tra tổng cần thiết theo quy tắc.',
    'peppol.endpointid.looks.like.email' => 'Đây trông giống như một địa chỉ email, nhưng không có chương trình Peppol nào thực sự sử dụng địa chỉ email làm định danh — thay vào đó, hãy nhập mã định danh doanh nghiệp (số đăng ký, mã số thuế GTGT, GLN, v.v.) phù hợp với chương trình đã chọn.',
    ...
    'peppol.messages.log' => 'Thông điệp Peppol',
    'peppol.optional' => ' (Không bắt buộc)',
    'peppol.send.via' => 'Gửi qua Peppol',
    'peppol.send.via.oxalis' => 'Gửi qua Peppol (Oxalis)',
    ...
    'peppol.tax.category.not.found.fix' => 'Đặt ngay bây giờ',
    ...
    'peppol.unknown.document.type' => 'Loại tài liệu không xác định',
    ...
    'product.added.despite.insufficient.stock' => 'Đã bổ sung hàng dù nguồn cung không đủ:',
    ...
    'product.availability' => 'Tính khả dụng',
    'product.availability.b2b' => 'Cổng thông tin khách hàng B2B (Bán buôn)',
    'product.availability.hint' => 'Cửa hàng trực tuyến (Bán lẻ) niêm yết sản phẩm này trên trang web công khai với giá bán lẻ như bên dưới. Cổng thông tin khách hàng B2B (Bán buôn) chỉ cung cấp sản phẩm này cho nhân viên và khách hàng sử dụng để báo giá/đặt hàng/hóa đơn, với giá như bên trên.',
    'product.availability.webshop' => 'Cửa hàng trực tuyến (Bán lẻ)',
    'product.available.stock' => 'Hàng có sẵn',
    'product.client.association' => 'Hiệp hội Khách hàng Sản phẩm',
    'product.client.association.options' => 'Các tùy chọn liên kết khách hàng sản phẩm',
    'product.client.associations.completed' => 'Hoàn tất liên kết khách hàng sản phẩm',
    ...
    'product.peppol.unit.hint' => 'Không bắt buộc phải lưu sản phẩm này, nhưng cần thiết khi hóa đơn sử dụng sản phẩm này được gửi qua Peppol — đây phải là bản ghi UnitPeppol cho cùng một Đơn vị đã chọn ở trên, chứ không phải bất kỳ bản ghi UnitPeppol nào. Hãy thiết lập ngay nếu sản phẩm này sẽ được sử dụng trên hóa đơn Peppol.',
    'product.peppol.unit.missing' => 'Chưa được thiết lập',
    'product.price' => 'Giá',
    ...
    'product.reorder.threshold' => 'Ngưỡng đặt hàng lại (một vùng đệm dự trữ — để trống = không có vùng đệm, toàn bộ số lượng hàng tồn kho được hiển thị/bán hết)',
    'product.retail.price' => 'Giá bán lẻ (chỉ áp dụng cho cửa hàng trực tuyến — để trống nếu muốn sử dụng giá ở trên)',
    ...
    'product.stock.quantity' => 'Hàng tồn kho hiện tại',
    'product.stock.quantity.not.yet.available' => 'Sản phẩm này sẽ không khả dụng cho đến khi được lưu.',
    'product.tariff' => 'Thuế quan',
    'product.track.stock' => 'Hàng tồn kho',
    'product.trade.min.order.quantity' => 'Số lượng đặt hàng tối thiểu dành cho giao dịch thương mại (để trống = không có điều khoản thương mại, ẩn nút Giá bán buôn của cửa hàng)',
    'product.trade.min.order.spend' => 'Đơn hàng tối thiểu dành cho giao dịch thương mại (để trống = không có điều khoản thương mại, ẩn nút Giá bán buôn của cửa hàng)',
    ...
    'products.remaining.after.this' => 'Các sản phẩm còn lại sau sản phẩm này',
    ...
    'purchase.entry.add' => 'Thêm mục mua hàng',
    'purchase.entry.csv.imported' => 'Đã nhập {count} mục mua hàng ({skipped} hàng bị bỏ qua).',
    'purchase.entry.csv.no.file' => 'Không có tệp CSV nào được tải lên hoặc có lỗi khi tải lên.',
    'purchase.entry.delete' => 'Xóa mục mua hàng',
    'purchase.entry.edit' => 'Chỉnh sửa mục mua hàng',
    'purchase.entry.index' => 'Mục mua hàng',
    'purchase.entry.tax.year.locale.applied' => 'Ngày bắt đầu năm tính thuế đã được áp dụng. Giờ đây, bạn có thể nhóm các mục mua hàng theo quý VAT.',
    'purchase.entry.tax.year.locale.invalid' => 'Giá trị tháng hoặc ngày không hợp lệ. Vui lòng chọn ngôn ngữ/vùng miền hợp lệ.',
    'purchase.entry.tax.year.not.configured' => 'Tính năng nhóm quý VAT không khả dụng: Ngày bắt đầu năm tính thuế (năm, tháng, ngày) chưa được cấu hình đầy đủ. Vui lòng sử dụng các liên kết điều hướng bên dưới để thiết lập.',
    'purchase.price' => 'Giá mua',
    'qr.absolute.url' => 'Url tuyệt đối được sử dụng để xây dựng Mã QR ở trên',
    'qr.code' => 'Mã QR',
    'qr.code.1' => 'Mã QR 1',
    'qr.code.details' => 'Chi tiết mã QR',
    'qr.code.instructions' => 'Hãy dán tờ này lên cửa sổ. Quét mã vạch mỗi khi bạn nhận được dịch vụ chăm sóc tại nhà hoàn chỉnh để yêu cầu hóa đơn tiếp theo, sau đó bạn có thể thanh toán ngay lập tức theo phương thức thanh toán đã chọn. Điều này giúp chúng tôi đối chiếu sổ sách ngân hàng. Cảm ơn bạn.',
    ...
    'quote.must.be.approved.first' => 'Báo giá phải được chấp thuận trước khi chuyển đổi',
    ...
    'record.successfully.created.not' => 'Bản ghi KHÔNG được tạo thành công',
    ...
    'recurring.client' => 'Khách hàng',
    'recurring.create' => 'Tạo hóa đơn định kỳ',
    'recurring.create.from.productclient' => 'Thiết lập hóa đơn định kỳ từ danh sách sản phẩm',
    ...
    'recurring.no.products.associated' => 'Hiện chưa có sản phẩm nào được liên kết với khách hàng này. Vui lòng sử dụng chức năng Tạo sản phẩm trước.',
    'recurring.original.invoice.date' => 'Ngày hóa đơn gốc: ',
    'recurring.setup' => 'Thiết lập định kỳ',
    ...
    'redirect.map' => 'Chuyển hướng bản đồ',
    'refund' => 'Đền bù',
    'refund.confirm' => 'Bạn có chắc chắn muốn hoàn tiền khoản thanh toán này qua %s không?',
    'refund.failed' => 'Giao dịch hoàn tiền qua %s thất bại. Vui lòng kiểm tra nhật ký cổng thanh toán để biết chi tiết.',
    'refund.no.provider.reference' => 'Không có mã tham chiếu thanh toán %s nào được ghi nhận cho khoản thanh toán này, vì vậy không thể hoàn tiền tự động.',
    'refund.recorded' => 'Đã được hoàn tiền qua %s. Mã tham chiếu nhà cung cấp: %s',
    'refund.successful' => 'Giao dịch hoàn tiền qua %s đã thành công.',
    'region' => 'Vùng đất',
    'reject' => 'Từ chối',
    'reject.this.quote' => 'Từ chối trích dẫn này',
    'rejected' => 'Vật bị loại bỏ',
    'remember.me.days' => 'Thời gian hiệu lực của tính năng "Nhớ tôi" (Ngày)',
    'reminder' => 'Đã gửi lời nhắc nhở',
    'remove' => 'Di dời',
    'remove.logo' => 'Xóa Logo',
    'report' => 'Báo cáo',
    'report.aging.title' => 'Báo cáo tuổi nợ phải thu',
    'report.client.statement' => 'Bảng sao kê tài khoản khách hàng',
    'report.options' => 'Tùy chọn báo cáo',
    'report.period.from_to' => 'Thời gian: {from_date} đến {to_date}',
    'report.revenue.title' => 'Báo cáo phân tích doanh thu',
    ...
    'reports' => 'Báo cáo',
    'reset' => 'Cài lại',
    'reset.column.widths' => 'Đặt lại chiều rộng cột về mặc định.',
    ...
    'run.sheet.pdf' => 'Bảng kế hoạch chi tiết (PDF)',
    'run.sheet.pdf.tooltip' => 'Tải xuống file PDF của mọi hóa đơn hiện đang hiển thị theo bộ lọc của bạn, địa chỉ được hiển thị đầu tiên dưới dạng liên kết Google Maps có thể nhấp chuột -- hữu ích cho việc theo dõi lịch dọn dẹp nhà cửa hoặc bất kỳ danh sách hóa đơn nào khác mà bạn cần xem hoặc tham khảo ngoại tuyến.',
    'sales' => 'Việc bán hàng',
    ...
    'salesorder.peppol.response.ab' => 'Đã xác nhận -- đã nhận được, nhưng chưa xử lý',
    'salesorder.peppol.response.acknowledge' => 'Chỉ xác nhận',
    'salesorder.peppol.response.acknowledge.description' => 'Gửi phản hồi toàn bộ đơn hàng với nội dung &quot;đã nhận, nhưng chưa xử lý&quot;, mà chưa quyết định bất kỳ dòng nào. Hãy sử dụng chức năng &quot;Gửi phản hồi đơn hàng Peppol&quot; thay thế khi bạn đã sẵn sàng chấp nhận, từ chối hoặc thay đổi từng dòng riêng lẻ.',
    'salesorder.peppol.response.ap' => 'Đã được chấp nhận',
    'salesorder.peppol.response.ca' => 'Đã được chấp nhận với những thay đổi.',
    'salesorder.peppol.response.failed' => 'Không thể gửi phản hồi đơn hàng Peppol.',
    'salesorder.peppol.response.failed.no.client' => 'Không thể gửi phản hồi đơn hàng Peppol: Đơn hàng không có Khách hàng.',
    'salesorder.peppol.response.failed.no.peppol' => 'Không thể gửi phản hồi đơn hàng Peppol: Khách hàng chưa đăng ký Peppol.',
    'salesorder.peppol.response.linestatus.accepted' => 'Đã được chấp nhận',
    'salesorder.peppol.response.linestatus.added' => 'Đã thêm',
    'salesorder.peppol.response.linestatus.alreadydelivered' => 'Đã giao hàng',
    'salesorder.peppol.response.linestatus.changed' => 'Đã thay đổi',
    'salesorder.peppol.response.linestatus.rejected' => 'Vật bị loại bỏ',
    'salesorder.peppol.response.perline' => 'Phản hồi đơn hàng Peppol',
    'salesorder.peppol.response.preview' => 'Xem trước XML',
    'salesorder.peppol.response.re' => 'Vật bị loại bỏ',
    'salesorder.peppol.response.send' => 'Gửi phản hồi đơn hàng Peppol',
    'salesorder.peppol.response.sent' => 'Phản hồi đơn hàng Peppol đã được gửi',
    'salesorder.quote' => 'Trích dẫn',
    ...
    'select.existing.client' => 'Chọn khách hàng hiện có',
    ...
    'send.telegram.invoice' => 'Gửi hóa đơn Telegram',
    'sent' => 'Đã gửi',
    'set.new.password' => 'Đặt mật khẩu mới',
    'set.to.read.only' => 'Đặt Hóa đơn thành chỉ đọc trên',
    'setting' => 'Cài đặt',
    'setting.add' => 'Cài đặt Thêm',
    'setting.arbitration.details.note' => 'Các trường "Cơ quan trọng tài" và "Thẩm quyền trọng tài" được sử dụng trong phần "Giải quyết tranh chấp" và "Luật điều chỉnh" cũng được thiết lập trên trang "Công ty".',
    ...
    'setting.company.details.note' => 'Tên công ty, thông tin liên hệ và địa chỉ hiển thị trên trang này được quản lý trên trang Công ty.',
    ...
    'setting.hide.from.front.page' => 'Ẩn khỏi trang chủ',
    'setting.key' => 'Cài đặt khóa',
    'setting.privacy.policy.preview' => 'Xem trước Chính sách bảo mật',
    'setting.section' => 'Phần',
    'setting.subsection' => 'Tiểu mục',
    'setting.terms.of.service.preview' => 'Xem trước Điều khoản dịch vụ',
    ...
    'spreadsheet.import' => 'Nhập bảng tính',
    'sql.file' => 'Tập tin SQL',
    'start' => 'Bắt đầu',
    'start.date' => 'Ngày bắt đầu',
    'state' => 'Tình trạng',
    'status' => 'Trạng thái',
    'status.invoice.cancelled' => 'Đã hủy',
    'status.invoice.draft' => 'Bản nháp',
    'status.invoice.overdue' => 'Quá hạn',
    'status.invoice.paid' => 'Trả',
    'status.invoice.partial' => 'Đã thanh toán một phần',
    'status.invoice.sent' => 'Đã gửi',
    'status.invoice.viewed' => 'Đã xem',
    'sticky.grid.header' => 'Tiêu đề lưới cố định',
    'sticky.grid.header.hint' => 'Giữ nguyên vị trí các tiêu đề cột trong danh sách hóa đơn khi bạn cuộn trang. Lưu ngay lập tức — có hiệu lực ở lần tải trang tiếp theo.',
    'sticky.navbar' => 'Thanh điều hướng cố định',
    'sticky.navbar.hint' => 'Giữ thanh điều hướng trên cùng cố định khi bạn cuộn trang. Lưu ngay lập tức — có hiệu lực khi bạn tải trang lần tiếp theo.',
    'stop' => 'Dừng lại',
    'stop.homecare.signing.up' => 'Không cần đăng ký dịch vụ chăm sóc tại nhà.',
    ...
    'street.order' => 'Chiến dịch dọn dẹp — Trật tự đường phố',
    'street.order.back.to.families' => 'Trở lại mục Gia đình',
    'street.order.drag.hint' => 'Kéo các con phố theo thứ tự bạn muốn dọn dẹp. Thứ tự sẽ được lưu tự động khi bạn thả một hàng.',
    'street.order.manage.link' => 'Quản lý trật tự đường phố →',
    'street.order.position' => 'Vị trí vận hành làm sạch:',
    'subject' => 'Chủ thể',
    'submenu' => 'Menu phụ',
    'submit' => 'Nộp',
    'subtotal' => 'Tổng cộng',
    'success' => 'Thành công',
    'success.create.invoice' => 'Hóa đơn số #{invoice_number} đã được tạo thành công',
    'success.payment.received' => 'Đã nhận được khoản thanh toán {amount} cho hóa đơn số #{invoice_number}',
    'success.send.invoice' => 'Hóa đơn số {invoice_number} đã được gửi đến {client_email}',
    'success.update.client' => 'Khách hàng {client_name} đã được cập nhật thành công.',
    'successful' => 'Thành công',
    'suggested.from.previous.selection' => 'Đề xuất từ ​​lựa chọn trước đó',
    'sunday' => 'Chủ nhật',
    'system.settings' => 'Cài đặt hệ thống',
    'system.updates' => 'Cập nhật hệ thống',
    'system.updates.check.failed' => 'Kiểm tra phiên bản PHP thất bại',
    'system.updates.check.now' => 'Kiểm tra ngay',
    'system.updates.current.version' => 'Phiên bản PHP hiện tại',
    'system.updates.last.checked' => 'Lần kiểm tra cuối cùng',
    'system.updates.latest.version' => 'Phiên bản PHP mới nhất',
    'system.updates.never.checked' => 'Chưa bao giờ kiểm tra',
    'system.updates.outdated' => 'Phiên bản PHP mới hơn hiện có sẵn.',
    'system.updates.security.release' => 'Bản phát hành bảo mật',
    'system.updates.select.platform' => 'Chọn nền tảng của bạn để xem hướng dẫn cập nhật.',
    'system.updates.up.to.date' => 'PHP đã được cập nhật.',
    'system.updates.update.instructions' => 'Hướng dẫn cập nhật',
    'table' => 'Bàn',
    'task' => 'Nhiệm vụ',
    ...
    'tax.exempt.notice' => 'Giao dịch này được miễn thuế.',
    'tax.information' => 'Thông tin thuế',
    'tax.point' => 'Ngày Điểm Thuế',
    'tax.rate' => 'Tỷ lệ thuế',
    'tax.rate.active.not' => 'Cảnh báo:Không có mức thuế nào được kích hoạt.Hãy kích hoạt ít nhất một mức thuế.Cài đặt .Mức thuế',
    ...
    'tax.rates' => 'Thuế suất',
    'tax.total.amount' => 'Tổng thuế: {số tiền}',
    'tax.vat.rate' => 'Thuế suất VAT: {rate}%',
    'taxes' => 'Thuế',
    'taxrate.peppol.tax.rate.code.hint' => 'Không bắt buộc phải lưu mức thuế suất này, nhưng cần thiết (mã UNCL5305, ví dụ: S/Z/E/AE) ngay khi hóa đơn sử dụng mức thuế suất này được gửi qua Peppol — hãy thiết lập ngay nếu mức thuế suất này sẽ được sử dụng trên hóa đơn Peppol.',
    'taxrate.peppol.tax.rate.code.missing' => 'Chưa được thiết lập',
    'telegram' => 'Điện tín',
    ...
    'telegram.bot.api.payment.method.id' => 'Mã định danh phương thức thanh toán được sử dụng khi ghi nhận thanh toán tự động trên Telegram.',
    ...
    'telegram.bot.api.provider.token' => 'Mã thông báo nhà cung cấp thanh toán Telegram (từ @BotFather → Thanh toán → Stripe)',
    ...
    'telegram.invoice.client.chat.id.not.set' => 'Khách hàng không có ID nhóm chat Telegram. Hãy chỉnh sửa thông tin khách hàng và thêm ID nhóm chat Telegram của họ.',
    'telegram.invoice.link.created' => 'Đã tạo liên kết thanh toán Telegram. Sao chép liên kết bên dưới.',
    'telegram.invoice.link.created.menu' => 'Tạo liên kết thanh toán Telegram',
    'telegram.invoice.sent' => 'Đã gửi hóa đơn Telegram thành công.',
    'telegram.location.not.configured' => 'Vị trí địa lý (vĩ độ và kinh độ) của công ty chưa được cấu hình. Hãy thiết lập chúng trong phần Cài đặt.',
    'telegram.location.sent' => 'Thông tin địa điểm công ty đã được gửi thành công đến Telegram.',
    'telegram.pdf.not.found' => 'Không tìm thấy tệp PDF lưu trữ nào cho hóa đơn này. Vui lòng tạo tệp PDF trước qua Tùy chọn → Tải xuống PDF.',
    'telegram.pdf.send.menu' => 'Gửi file PDF qua Telegram',
    'telegram.pdf.sent' => 'Đã gửi thành công file PDF hóa đơn lên Telegram.',
    'telegram.stars.no.charge.id' => 'Không thể hoàn tiền: Phiếu thanh toán không chứa mã giao dịch Telegram và ID người dùng của người mua.',
    'telegram.stars.refunded' => 'Giao dịch hoàn tiền Telegram Stars đã thành công.',
    ...
    'two.factor.authentication.compatible.apps' => 'Ứng dụng này hoạt động với bất kỳ ứng dụng xác thực TOTP nào — ví dụ như Google Authenticator, Microsoft Authenticator, Authy, 1Password, Bitwarden, Yandex ID hoặc Aegis. Hãy sử dụng ứng dụng mà bạn đã có sẵn.',
    ...
    'two.factor.authentication.enabled.badge' => 'Đã bật xác thực hai yếu tố',
    ...
    'two.factor.authentication.invalid.backup.recovery.code' => 'Mã khôi phục sao lưu 8 chữ số không hợp lệ',
    ...
    'two.factor.authentication.invalid.totp.code' => 'Mã xác thực một lần có thời gian 6 chữ số không hợp lệ',
    'two.factor.authentication.missing.code.or.secret' => 'Thiếu mã xác thực hoặc bí mật 2FA.',
    'two.factor.authentication.new.recovery.code' => 'Vui lòng nhập một trong các Mã Khôi phục Sao lưu chưa sử dụng của bạn (8 ký tự) bên dưới.',
    ...
    'two.factor.authentication.rate.limit.reached' => 'Đã đạt đến giới hạn tốc độ.Vui lòng đợi 10 giây.',
    ...
    'two.factor.authentication.use.backup.code' => 'Thay vào đó, hãy sử dụng mã khôi phục bản sao lưu gồm 8 chữ số.',
    'type' => 'Kiểu',
    'ubl.version.required.2.4' => 'Phiên bản UBL phải là 2.1, 2.2, 2.3 hoặc 2.4.',
    'unit' => 'Đơn vị',
    ...
    'user.client.count' => '#',
    'user.client.delete.not' => 'Không thể xóa! Khách hàng có tài liệu hiện có.',
    ...
    'user.inv.delete.blocked.callback' => 'Người dùng có vai trò RBAC đang hoạt động sẽ nhận được lỗi 403 Forbidden trong lần gọi lại OAuth tiếp theo đến /invoice. Hãy sử dụng chức năng Thu hồi tất cả vai trò trước, sau đó mới xóa.',
    'user.inv.delete.blocked.roles' => 'Không thể xóa: người dùng vẫn đang giữ vai trò RBAC:',
    ...
    'user.inv.rbac.link' => 'Liên kết RBAC',
    'user.inv.rbac.link.stable' => 'Liên kết RBAC ổn định — vai trò được chỉ định và hàng cầu nối hiện diện',
    'user.inv.rbac.link.sync.confirm' => 'Gán vai trò quan sát viên (nếu thiếu) và đồng bộ hóa hàng cầu nối RBAC cho người dùng này?',
    'user.inv.rbac.link.synced' => 'Liên kết RBAC đã được đồng bộ hóa — vai trò người quan sát đã được chỉ định nếu chưa có.',
    ...
    'user.inv.role.worker' => 'Công nhân',
    'user.inv.role.worker.assign' => 'Giao phó',
    'user.inv.role.worker.assigned' => 'Vai trò của người lao động được chỉ định',
    'user.inv.role.worker.none.available' => 'Không có hồ sơ Nhân viên nào chưa được liên kết — hãy thêm một hồ sơ vào mục Nhân viên trước.',
    'user.inv.role.worker.unavailable' => 'Không thể chỉ định — Nhân viên đã chọn đã được liên kết với người dùng khác.',
    ...
    'validation.amount.positive' => 'Số tiền phải lớn hơn không.',
    'validation.client.email.format' => 'Địa chỉ email của khách hàng phải là địa chỉ email hợp lệ.',
    'validation.currency.supported' => 'Loại tiền tệ {currency} không được hỗ trợ',
    'validation.invoice.date.invalid' => 'Vui lòng cung cấp ngày hóa đơn hợp lệ.',
    'validation.invoice.number.required' => 'Cần có số hóa đơn.',
    ...
    'webshop.currency.refresh.already.current' => 'Tỷ giá hối đoái đã được cập nhật cho ngày hôm nay.',
    'webshop.currency.refresh.disabled' => 'Chức năng cập nhật tỷ giá tự động đã bị tắt.',
    'webshop.currency.refresh.failed' => 'Không thể lấy tỷ giá hối đoái hiện tại — vui lòng thử lại sau.',
    'webshop.currency.refresh.updated' => 'Tỷ giá hối đoái đã được cập nhật.',
    'welcome' => 'Chào mừng',
    'whatsapp' => 'WhatsApp',
    'whatsapp.business.cloud.api.access.token' => 'Mã truy cập vĩnh viễn (từ người dùng hệ thống trong cài đặt doanh nghiệp)',
    'whatsapp.business.cloud.api.business.account.id' => 'ID tài khoản doanh nghiệp WhatsApp',
    'whatsapp.business.cloud.api.enable' => 'Bật WhatsApp',
    'whatsapp.business.cloud.api.enabled.not' => 'WhatsApp chưa được kích hoạt',
    'whatsapp.business.cloud.api.general.purpose' => '<b>API WhatsApp Business Cloud gửi thông báo sẵn sàng lập hóa đơn cho khách hàng thông qua mẫu tin nhắn đã được phê duyệt trước, được xác định bằng ID số điện thoại và mã truy cập bên dưới.</b>',
    'whatsapp.business.cloud.api.not.configured' => 'WhatsApp chưa được cấu hình đầy đủ (cần có ID số điện thoại, Mã truy cập và Tên mẫu).',
    'whatsapp.business.cloud.api.phone.number.id' => 'Mã số điện thoại (từ WhatsApp -&gt; Thiết lập API — không phải số điện thoại hiển thị)',
    'whatsapp.business.cloud.api.template.language' => 'Mã ngôn ngữ mẫu tin nhắn (ví dụ: en_GB)',
    'whatsapp.business.cloud.api.template.name' => 'Tên mẫu tin nhắn đã được phê duyệt',
    'whatsapp.business.cloud.api.test.message.sent' => 'Đã gửi tin nhắn thử nghiệm WhatsApp.',
    'whatsapp.business.cloud.api.test.message.sent.not' => 'Tin nhắn thử nghiệm WhatsApp KHÔNG được gửi.',
    'whatsapp.business.cloud.api.test.recipient.not.set' => 'Mã số người nhận xét nghiệm chưa được thiết lập.',
    'whatsapp.business.cloud.api.test.recipient.number' => 'Mã số người nhận thử nghiệm (phải được xác minh trước trong Meta khi ứng dụng đang ở chế độ phát triển)',
    'whatsapp.business.cloud.api.webhook.current.status' => '<b>Hiện trạng sử dụng:</b> Quá trình xác thực GET được triển khai để có thể lưu đăng ký webhook trong bảng điều khiển Meta. Các sự kiện POST đến (trạng thái gửi, phản hồi) chỉ được ghi nhật ký — chúng chưa được xử lý, tương tự như webhook của Telegram hiện nay.',
    'whatsapp.business.cloud.api.webhook.future.use' => '<b>Tương lai:</b> Việc xử lý các sự kiện đến có thể tự động ghi lại trạng thái đã gửi/đã đọc hoặc xử lý phản hồi của khách hàng.',
    'whatsapp.business.cloud.api.webhook.url.this.site' => 'Đây là URL Webhook WhatsApp của trang web này — hãy nhập URL này và Mã xác minh bên dưới vào WhatsApp &gt; Cấu hình &gt; Webhooks trong bảng điều khiển Meta.',
    'whatsapp.business.cloud.api.webhook.verify.token' => 'Mã thông báo xác thực Webhook (một giá trị do bạn chọn; được nhập trong bảng điều khiển Meta và được phản hồi lại trong quá trình bắt tay xác thực)',
    'worker' => 'Công nhân',
    'worker.assign' => 'Giao phó',
    'worker.assigned' => 'Người lao động được phân công',
    'worker.firstname' => 'Tên',
    'worker.lastname' => 'Họ',
    'worker.linked.login' => 'Đăng nhập liên kết',
    'worker.unassigned' => 'Chưa được chỉ định',
    'workers' => 'Công nhân',
