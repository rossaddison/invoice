...
'add.family' => '新增家庭',
'add.files' => '新增檔案...',
'add.invoice.tax' => '新增發票稅',
'add.new.row' => '新增行',
'add.note' => '新增註釋',
'add.notes' => '新增註釋',
'add.payment.provider' => '新增支付提供者',
'add.product' => '添加產品',
'add.quote' => '新增報價',
'add.quote.tax' => '新增報價稅',
'add.task' => '新增任務',
...
'administrator' => '行政人員',
'after.amount' => '之後金額',
'after.amount.space' => '在金額後面添加不間斷空格',
'aging' => '發票帳齡',
'aging.1.15' => '1 - 15天',
'aging.16.30' => '16 - 30天',
'aging.above.30' => '超過30天',
'alert.no.client.assigned' => '該項目沒有指定客戶。',
'alert.no.tasks.found' => '未找到該項目的任務。',
'alert.task.delete' => '警告！您想要刪除用於產生發票的任務。',
'all' => '全部',
...
'amounts' => '發票金額',
'any.family' => '任何家庭',
'apply.after.item.tax' => '商品稅後應用',
'apply.before.item.tax' => '商品稅前申請',
'approve' => '核准',
'approve.this.quote' => '批准此報價',
'approved' => '得到正式認可的',
...
'breadcrumb.product.property.index' => '產品性能指標',
'calculate.discounts' => '計算折扣',
'calendar.day.1' => '1天',
'calendar.day.15' => '15天',
'calendar.day.2' => '2天',
'calendar.day.3' => '3天',
...
'calendar.day.5' => '5天',
'calendar.day.6' => '6天',
'calendar.month.1' => '1個月',
'calendar.month.10' => '10個月',
'calendar.month.11' => '11個月',
'calendar.month.2' => '2個月',
'calendar.month.3' => '3個月',
'calendar.month.4' => '4個月',
'calendar.month.5' => '5個月',
'calendar.month.6' => '6個月',
'calendar.month.7' => '7個月',
'calendar.month.8' => '8個月',
'calendar.month.9' => '9個月',
'calendar.week.1' => '1週',
'calendar.week.2' => '2週',
'calendar.week.3' => '3週',
'calendar.week.4' => '4週',
...
'case.number' => '案件編號',
'cash.discount' => '現金折扣',
'category.primary' => '類別 小學',
'category.secondary' => '中學類別',
'caution.delete.invoices' => '僅測試：刪除所有發票及相關記錄。 （參見函數 inv/flush）',
'caution.deleted.invoices' => '僅測試：所有發票和相關欄位已被刪除。',
'cc' => '副本',
'change.client' => '更改客戶端',
'change.password' => '更改密碼',
'checking.for.news' => '正在檢查新聞...',
...
'client.add' => '客戶端添加',
'client.age' => '年齡',
'client.age.hint' => '此欄位為必填項，客戶法定年齡至少為 16 歲',
'client.already.exists' => '客戶端已存在！',
'client.birthdate.hint' => '如果不知道出生日期，請輸入 01/01/1901',
'client.building.number' => '客戶樓號',
...
'client.postaladdress.country' => '國家',
'client.postaladdress.countrysubentity' => '國家子實體',
'client.postaladdress.none' => '客戶沒有郵寄地址',
'client.postaladdress.postalzone' => '郵政區',
'client.postaladdress.street.name' => '街道名稱',
'client.purchase.order.number' => '客戶採購訂單編號',
'client.streets' => '街道',
'client.surname' => '客戶姓氏',
'client.surname.optional' => '客戶姓氏（可選）',
'client.title' => '客戶稱謂（先生/女士/小姐/博士/教授）',
'client.title.doctor' => '博士',
'client.title.miss' => '錯過',
'client.title.mr' => '先生',
'client.title.mrs' => '太太',
...
'closed' => '關閉',
'column' => '柱子',
'common.date.created' => '建立日期',
'common.date.modified' => '修改日期',
'common.name' => '姓名',
'company' => '公司',
'company.deleted' => '公司已刪除',
'company.not.deleted' => '本公司尚未被刪除，因為您已為其附加公司簡介。',
'company.private' => '公司私人',
'company.private.logo' => '公司標誌',
...
'continue.with.govuk' => '繼續使用 Gov Uk',
'continue.with.linkedin' => '繼續使用 LinkedIn',
'continue.with.microsoftonline' => '繼續使用 MicrosoftOnline',
'continue.with.vkontakte' => '繼續使用 VKontakte',
'continue.with.x' => '繼續 X',
'continue.with.yandex' => '繼續使用 Yandex',
'contract' => '合約',
'contract.add' => '新增合約',
...
'country' => '國家',
'create' => '創造',
'create.credit.invoice' => '創建信用發票',
'create.credit.invoice.alert' => '建立信用發票將使目前發票變為<em>唯讀狀態，</em>這表示您將無法再編輯該發票。信用發票將包含所有項目的當前狀態，但金額和餘額為負。',
'create.invoice' => '建立發票',
'create.product' => '創建產品',
'create.project' => '創建專案',
'create.quote' => '建立報價',
'create.recurring' => '建立重複',
'create.task' => '創建任務',
'created' => '創建',
'creation.unsuccessful' => '發票建立失敗',
'credit.invoice' => '信用發票',
'credit.invoice.date' => '貸記發票日期',
'credit.invoice.details' => '信用發票詳細信息',
'credit.invoice.for.invoice' => '貸項通知單',
'credit.note.creation.successful' => '貸項票據創建成功',
'credit.note.creation.unsuccessful' => '取消發票的貸項票據或貸項備忘錄建立失敗',
'creditcard.cvv' => 'CVV/CSC',
'creditcard.details' => '信用卡詳細資訊',
...
'currency.symbol.placement' => '貨幣符號位置',
'current.day' => '目前日期',
'current.month' => '本月',
'current.version' => '目前版本',
'current.year' => '目前年份',
'current.yy' => '當前年份（2 位數字格式）',
'custom' => '發票定制',
'custom.field' => '自訂字段',
'custom.field.add' => '自訂欄位新增',
'custom.field.form' => '自訂欄位表單',
'custom.field.location' => '文件位置',
'custom.field.number' => '數位',
'custom.field.required' => '必需的',
'custom.fields' => '自訂字段',
'custom.invoice.add' => '自訂發票添加',
'custom.title' => '自訂標題',
'custom.value' => '自訂值',
'custom.value.delete' => '首先刪除自訂值',
'custom.value.new' => '自訂值新',
'custom.values' => '自訂值',
'custom.values.edit' => '編輯自訂值',
'custom.values.new' => '新的自訂值',
'dashboard' => '儀表板',
'database' => '資料庫',
'database.properly.configured' => '資料庫已正確配置',
'date' => '發票日期',
'date.actual.delivery' => '實際交貨日期',
'date.applied' => '申請日期',
'date.created' => '建立日期',
'date.format' => '日期格式',
'date.issued' => '發行/創建日期',
...
'default.email.template' => '預設電子郵件模板',
...
'default.pdf.template' => '預設 PDF 模板',
'default.public.template' => '預設公共模板',
'default.quote.group' => '預設報價組',
'default.terms' => '預設條款',
'delete' => '刪除',
'delete.attachment.warning' => '您確定要刪除此附件嗎？',
'delete.client' => '刪除客戶端',
'delete.client.warning' => '如果您刪除此客戶，則與此客戶相關的所有發票、報價和付款也將刪除。您確定要永久刪除此客戶嗎？',
'delete.invoice' => '刪除發票',
'delete.invoice.warning' => '如果您刪除此發票，以後將無法恢復。您確定要永久刪除此發票嗎？',
'delete.quote' => '刪除引文',
'delete.quote.warning' => '如果您刪除此引言，以後將無法恢復。您確定要永久刪除此引言嗎？',
'delete.record.warning' => '您確定要刪除該記錄嗎？',
'delete.sent' => '無法刪除 - 發票已發送',
'delete.tax.warning' => '您確定要刪除此稅嗎？',
'delete.user.client.warning' => '您確定要取消該客戶與該使用者的分配嗎？',
'deleted' => '已刪除',
'deletion.forbidden' => '禁止刪除發票。請聯絡管理員或查閱文件。',
'delivery' => '交貨詳情：發票/交貨期開始/結束日期',
'delivery.actual.delivery.date' => '實際交貨日期',
'delivery.add' => '添加配送',
'delivery.date.created' => '建立日期',
'delivery.date.modified' => '交貨日期已修改',
...
'delivery.location.view' => '查看送貨地點',
'delivery.party' => '送貨方',
'delivery.party.add' => '送貨方添加',
'delivery.party.edit' => '送貨隊 編輯',
'delivery.party.name' => ' 送貨方名稱',
'delivery.party.view' => '送貨方視圖',
'delivery.start.date' => '交貨/發票期限開始日期',
'description' => '描述',
'description.document' => '文件描述',
'details' => '細節',
'development.progress' => '開發進度',
'development.schema' => '架構',
'disable.flash.messages' => '禁用發票閃現訊息',
'disable.quickactions' => '停用快速操作',
'disable.sidebar' => '禁用側邊欄',
'discount' => '折扣',
'discount.amount' => '折扣金額',
'discount.percent' => '折扣百分比',
'discount.percentage' => '折扣百分比',
'document.description' => 'Peppol 文件描述',
'documentation' => '文件',
'download' => '下載',
'download.pdf' => '下載 PDF',
'draft' => '草稿',
'draft.guest' => '客戶無法查看發票草稿。',
'draft.number.off' => '新的草稿發票將沒有發票號碼。標記為已寄出即可取得發票編號',
'draft.number.on' => '新的發票草稿將有一個發票號碼',
'drop.files.here' => '將文件拖放到此處！',
'due.date' => '兩次約會',
'early.settlement.cash.discount' => '提前結算現金折扣',
'edit' => '編輯',
'elements' => '元素',
'email' => '電子郵件',
'email.address' => '電子郵件',
'email.date' => '發送電子郵件的日期',
'email.default' => '預設',
'email.default.none.set' => '未設定預設值',
'email.exception' => '電子郵件異常。',
'email.from.dropdown' => '從電子郵件下拉式選單中取得要包含在 MailerQuote 表單和 MailerInv 表單中的電子郵件地址',
'email.include' => '包括',
'email.invoice' => '電子郵件發票',
'email.link.click.confirm' => '請點擊此連結確認您的電子郵件地址',
'email.log' => '發票電子郵件日誌',
'email.logs' => '發票電子郵件日誌',
'email.logs.with.filter' => '已透過電子郵件發送',
'email.not.configured' => '在傳送電子郵件之前，您必須在系統設定區域設定電子郵件設定。',
'email.not.sent.successfully' => '電子郵件未成功發送',
'email.pdf.attachment' => '在電子郵件中附加報價/發票？',
'email.quote' => '電子郵件報價',
'email.send.method' => '郵件發送方式',
'email.send.method.phpmail' => 'PHP郵件',
...
'email.template.successfully.deleted' => '電子郵件範本已成功刪除',
'email.template.successfully.edited' => '電子郵件範本已成功編輯',
'email.template.tags' => '電子郵件範本標籤',
'email.template.tags.instructions' => '範本標籤可用於向電子郵件範本新增動態訊息，例如客戶名稱或發票號碼。點擊「正文」文字框，然後從下拉式選單中選擇一個標籤。它將自動插入到文字方塊中。',
'email.template.type' => '電子郵件範本類型',
'email.templates' => '電子郵件模板',
'email.to.address.missing' => '您必須指定要傳送電子郵件的電子郵件地址。',
'email.warning.draft' => '草稿發票必須先標記為已發送，以便它們出現在用戶端，然後才能透過電子郵件發送。',
'enable.debug.mode' => '啟用調試模式',
'enable.online.payments' => '啟用線上支付',
'enable.permissive.search.clients' => '啟用寬容搜尋',
...
'end' => '結尾',
'end.date' => '結束日期',
'enforcement' => '執法人員出席地址',
'enter' => '進入',
'enter.payment' => '輸入付款',
'error.duplicate.file' => '錯誤：檔案名稱重複，請更改！',
'errors' => '錯誤',
'every' => '每一個',
'example' => '例子',
'expired' => '已到期',
...
'family' => '家庭',
'family.add' => '家庭添加',
'family.already.exists' => '家庭已經存在！',
'family.history' => '家族史已存在。無法刪除',
'family.name' => '姓',
'family.search' => '家庭搜尋',
'faq' => '常見問題解答',
...
'faq.php.info.credits' => '致謝',
'faq.php.info.details' => 'Php 資訊詳細信息',
'faq.php.info.environment' => '環境',
'faq.php.info.general' => '一般的',
'faq.php.info.licence' => '執照',
'faq.php.info.modules' => '模組',
'faq.php.info.variables' => '變數',
'faq.shared.hosting' => '如何在共享主機上託管 yii3i？',
'faq.taxpoint' => '如何確定稅點？',
'faq.yii.requirement.checker' => 'Yii 應用程式需求檢查器',
'fax' => '傳真',
'fax.abbr' => 'F',
'fax.number' => '傳真號碼',
'field' => '場地',
'filter.clients' => '過濾客戶端',
'filter.invoices' => '篩選發票',
'filter.payments' => '過濾付款',
'filter.quotes' => '篩選報價',
'first' => '第一的',
'first.day.of.week' => '一週的第一天',
'first.reset' => '首先刪除您為測試建立的測試報價和發票。然後才能刪除測試資料。',
'flash.messages.appear.here' => '閃現訊息出現在這裡。',
'footer' => '頁尾',
'forgot.your.password' => '我忘了密碼',
'form.error' => '表單錯誤',
'from.date' => '起始日期',
'from.default.in.dropdown' => '下拉清單中的預設電子郵件地址',
'from.email' => '來自電子郵件',
'from.email.address' => '寄件者電子郵件地址：選擇預設',
...
'gln' => '麩醯胺酸',
'gov.developer.sandbox' => '開發者沙盒',
'gov.developer.sandbox.uk' => '英國稅務海關總署',
'gridview.api' => 'API',
...
'group' => '團體',
'group.add' => '群組添加',
'group.document.number' => '未產生憑證編號。請檢查組。',
'group.form' => '團體形式',
'group.history' => '群組歷史記錄已存在。無法刪除',
'groups' => '團體',
'guest.account.denied' => '此帳戶未配置。請聯絡系統管理員。',
...
'invoiced' => '已開立發票',
'invoiceplane' => '發票飛機',
'invoiceplane.clients' => '客戶端已插入',
'invoiceplane.database.name' => '資料庫名稱',
'invoiceplane.database.password' => '密碼',
...
'invoiceplane.yes.connection' => '是的，您已連接到您的 Invoiceplane 資料庫！',
'invoices' => '發票',
'invoices.due.after' => '發票到期日（天）',
'is.not.writable' => '不可寫',
'is.writable' => '可寫',
'item' => '發票項目',
'item.add' => '發票項目新增',
...
'item.discount' => '商品折扣',
'item.lookup' => '發票項目查找',
'item.lookup.form' => '商品查詢表',
'item.lookups' => '商品查找',
'item.name' => '項目名稱',
'item.tax' => '項目稅',
'item.tax.excluded' => '小計 x 稅率（已不含商品稅）',
'item.tax.included' => '（小計+項目稅）x稅率',
'item.tax.rate' => '項目稅率',
'items' => '發票項目',
'judgement' => '已獲得判決',
'label' => '標籤',
'label.switch.off' => '增值稅發票',
'label.switch.on' => '無增值稅發票',
'language' => '語言',
'last' => '最後的',
'last.month' => '上個月',
'last.quarter' => '上季',
...
'layout.add.tag' => '添加標籤',
'layout.archive' => '檔案',
'layout.archive.for-year' => '{year} 的存檔',
'layout.blog' => '部落格',
'layout.change-language' => '更改語言',
'layout.console' => '安慰',
'layout.content' => '內容',
'layout.create.new-user' => '建立新用戶',
'layout.db.schema' => '資料庫模式',
'layout.go.home' => '返回首頁',
'layout.login' => '登入',
...
'layout.password' => '密碼',
'layout.password-verify' => '確認您的密碼',
'layout.password-verify.new' => '確認您的新密碼',
'layout.password.new' => '新密碼',
'layout.password.otp' => '免洗密碼',
'layout.rbac.assign-role' => '為使用者指派 RBAC 角色',
'layout.remember' => '記住帳號',
'layout.reset' => '重置',
'layout.show-more' => '顯示更多',
'layout.submit' => '提交',
'layout.title' => '標題',
'layout.total.posts' => '總共 {count} 個帖子',
'left.pad' => '左墊',
'letter' => '行動前 7 天信函已發送',
'loading.error' => '看起來應用程式由於錯誤而卡住了。',
'loading.error.help' => '獲取協助',
'login' => '登入',
'login.logo' => '登入標誌',
'loginalert.credentials.incorrect' => '電子郵件或密碼不正確。',
'loginalert.no.password' => '請輸入密碼。',
'loginalert.user.inactive' => '此用戶已被標記為非活動狀態。請聯絡系統管理員。',
'loginalert.user.not.found' => '此電子郵件地址尚未註冊任何帳戶。',
'loginalert.wrong.auth.code' => '密碼重置被拒絕。您提供的身份驗證令牌無效。',
'logo' => '發票徽標',
'logout' => '登出',
'loss' => '註銷',
'mark.invoices.sent.copy' => '複製發票時將發票標記為已寄送',
'mark.invoices.sent.pdf' => '產生 PDF 時將發票標記為已傳送',
'mark.quotes.sent.pdf' => '產生 PDF 時將報價標記為已傳送',
'mark.sent.copy.on' => '複製發票時將發票標記為已發送已啟用。此功能僅在開發過程中啟用',
'mark.sent.off' => '複製發票時將發票標記為已發送…目前處於關閉狀態。僅在開發期間設定為開啟。點擊此處將其開啟',
'mark.sent.on' => '影印發票時將發票標記為已寄出…目前處於開啟狀態。生產過程中請務必將其關閉。點此關閉',
'max' => '最大限度',
'max.quantity' => '最大數量',
'menu' => '選單',
'menu.about' => '關於',
...
'merchant.add' => '商家地址',
'merchant.driver' => '司機',
'merchant.reference' => '參考',
'merchant.response' => '回覆',
'min.quantity' => '最小數量',
'mobile' => '移動的',
'mobile.number' => '手機號碼',
'monday' => '週一',
'monospaced.font.for.amounts' => '使用等寬字體來表示金額',
'month' => '月',
'month.prefix' => '月前綴',
'mpdf' => '平均機率密度函數',
...
'mpdf.cjk' => '中文、日文、韓文字體',
'mpdf.ltr' => '從左到右',
'mpdf.show.image.errors' => '顯示影像錯誤',
'mtd' => '稅務數位化',
'mtd.fph' => '詐欺防制標頭',
'mtd.fph.all.valid' => '所有詐欺防制標頭均有效',
'mtd.fph.generate' => '產生',
'mtd.fph.no.provided' => '未提供詐欺防制標頭',
'mtd.fph.record.alert' => '您確定要記錄新的詐欺預防標頭詳細資訊嗎？保存後，先前的詳細資訊將被覆蓋！',
...
'no.overdue.invoices' => '無逾期發票',
'no.quotes.requiring.approval' => '沒有需要批准的報價。',
'no.records' => '沒有記錄',
...
'online.payment.accessKey' => '存取密鑰',
'online.payment.accessToken' => '訪問令牌',
'online.payment.accountId' => '帳戶 ID',
'online.payment.accountNumber' => '帳號',
'online.payment.apiKey' => 'API金鑰',
'online.payment.apiLoginId' => 'API 登入 ID',
'online.payment.appId' => '應用程式 ID',
'online.payment.appSecret' => '應用程式秘密',
'online.payment.callbackPassword' => '回撥密碼',
...
'online.payment.installationId' => '安裝 ID',
'online.payment.merchantAccessCode' => '商家存取代碼',
'online.payment.merchantId' => '商家編號',
'online.payment.merchantKey' => '商家密鑰',
'online.payment.method' => '網路支付方式',
'online.payment.partner' => '夥伴',
'online.payment.partnerID' => '合作夥伴 ID',
'online.payment.password' => '密碼',
'online.payment.payment.cancelled' => '付款已取消。',
'online.payment.payment.failed' => '付款失敗。請重試。',
'online.payment.payment.redirect' => '請稍候，我們將把您重新導向到付款頁面...',
'online.payment.payment.successful' => '發票 %s 付款成功！',
'online.payment.pdtKey' => 'Pdt鍵',
'online.payment.privateKey' => '私鑰',
'online.payment.profileID' => '設定檔 ID',
'online.payment.profileId' => '個人資料 ID',
'online.payment.publicKey' => '公鑰',
'online.payment.publicKeyId' => '公鑰ID',
'online.payment.publishableKey' => '可發布密鑰',
'online.payment.pxPostPassword' => 'Px 發布密碼',
'online.payment.pxPostUsername' => 'Px 貼文用戶名',
'online.payment.referrerId' => '推薦人 ID',
'online.payment.region' => '地區',
'online.payment.returnUrl' => '返回網址',
'online.payment.sandbox' => '沙盒',
'online.payment.sandboxId' => '沙盒 ID',
'online.payment.secret' => '秘密',
'online.payment.secretKey' => '金鑰',
'online.payment.secretWord' => '秘密詞',
'online.payment.secureHash' => '安全哈希',
'online.payment.sharedSecret' => '共享秘密',
'online.payment.signature' => '簽名',
'online.payment.siteCode' => '網站程式碼',
'online.payment.siteId' => '網站 ID',
...
'other.settings' => '其他設定',
'overdue' => '逾期',
'overdue.invoices' => '逾期發票',
'overview' => '發票概覽',
'overview.period' => '發票概覽期間',
'page' => '頁',
'paid' => '有薪資的',
'password' => '密碼',
...
'payment' => '支付',
'payment.add' => '付款方式',
'payment.cannot.delete' => '無法刪除付款',
'payment.cannot.exceed.balance' => '付款金額不能超過發票餘額。',
'payment.custom' => '付款習慣',
'payment.custom.add' => '付款自訂添加',
'payment.date' => '付款日期',
...
'payment.method.history' => '無法刪除。付款方式歷史記錄已存在。',
'payment.methods' => '付款方式',
'payment.no.invoice.sent' => '我們尚未發送任何發票，客戶也未查看任何發票。',
...
'paymentpeppol' => '透過 Peppol 付款',
'paymentpeppol.reference.plural' => '使用 Peppol 的付款參考',
'payments' => '付款',
'paymentterm' => '付款期限',
'pdf' => 'PDF',
...
'pdf.modal' => '模態PDF',
'pdf.quote.footer' => '引文頁腳',
'pdf.quote.footer.hint' => '您可以在此輸入任何 HTML，它將顯示在 PDF 報價的底部。',
'pdf.settings' => 'PDF 設定',
'pdf.template' => 'PDF模板',
...
'platform.PhpSupport' => 'Php 支援',
'platform.PhpVersion' => 'Php 版本',
'platform.csrf' => '跨站點偽造保護',
'platform.editor' => '編輯',
'platform.mySqlVersion' => 'mySql版本',
'platform.netbeans.UTF-8' => 'Netbeans UTF-8 編碼',
'platform.server' => '伺服器',
'platform.sqlPath' => 'SQL 路徑',
'platform.update' => 'WampServer 檔案和插件',
'platform.windowsVersion' => 'Windows 11 家用版',
'platform.xdebug' => 'Xdebug 擴充',
'please.enable.js' => '請啟用 Javascript 以使用 InvoicePlane',
'po.group' => '採購訂單組',
'port' => '港口',
'position' => '位置',
'possible.file.upload.attack' => '可能的文件上傳攻擊： ',
'pre.password' => '發票標準PDF密碼（可選）',
'prefix' => '前綴',
'prev' => '上一頁',
'preview' => '預覽',
'price' => '價格',
...
'product.price' => '價格',
'product.price.base.quantity' => '產品數量',
'product.property' => ' 產品特性',
'product.property.add' => ' 產品屬性添加',
'product.property.edit' => '產品屬性編輯',
'product.property.index' => '產品性能指標',
...
'product.view.tab.images' => '產品圖片',
'product.view.tab.properties' => '產品特性',
'productimage.add' => '新增產品圖片',
'productimage.deleted.from' => '圖像已成功從以下目錄中刪除： ',
'productimage.form' => '產品圖片表格',
'productimage.gallery' => '相關圖片： ',
'productimage.index' => '產品圖片索引',
...
'profile.property.label.current' => '目前的',
'profile.property.label.description' => '描述',
'profile.property.label.email' => '電子郵件',
'profile.property.label.mobile' => '移動的',
'profile.singular' => '輪廓',
'project' => '專案',
'project.add' => '項目新增',
'project.name' => '項目名稱',
...
'properties' => '特性',
'provider.name' => '提供者名稱',
'provider.response' => '提供者回應',
'purchase.price' => '購買價格',
'Q1' => '問題 1',
'Q2' => '第二季',
'Q3' => '第三季',
'Q4' => '第四季',
'qr.absolute.url' => '用於建立上述二維碼的絕對 URL',
'qr.code' => 'QR 圖碼',
'qr.code.1' => 'QR 圖碼 1',
'qr.code.details' => 'QR 圖碼詳情',
'qr.code.level.1' => '編碼級別為基礎',
'qr.code.level.2' => '編碼水平為中級',
'qr.code.level.3' => '編碼水平為高級',
...
'quote.add' => '引用添加',
'quote.amount' => '報價金額',
'quote.amount.add' => '報價金額 添加',
'quote.amounts' => '報價金額',
'quote.approve' => '核准',
'quote.approved' => '此報價已獲批准',
'quote.copied.to.invoice' => '報價已複製到新發票',
'quote.copied.to.quote' => '報價已複製到新報價！',
'quote.copied.to.so' => '報價已複製到銷售訂單',
'quote.custom' => '報價定制',
'quote.custom.add' => '報價自訂添加',
'quote.date' => '報價日期',
'quote.dates' => '報價日期',
...
'quote.id' => '報價編號 ',
'quote.item' => '報價項目',
'quote.item.add' => '報價項目添加',
'quote.item.amount' => '報價項目金額',
'quote.item.amount.add' => '報價項目金額添加',
...
'quote.overview' => '報價概覽',
'quote.overview.period' => '報價概覽期',
'quote.password' => '引用 PDF 密碼（可選）',
...
'read.only' => '只讀',
'read.this.please' => '請閱讀此文！',
'reason' => '原因',
'reason.accident' => '意外事故',
'reason.birthdefect' => '出生缺陷',
'reason.disease' => '疾病',
'reason.maternity' => '產科',
'reason.prevention' => '預防',
'reason.unknown' => '未知',
'recent.clients' => '最近的客戶',
'recent.invoices' => '最近的發票',
'recent.payments' => '近期付款',
'recent.quotes' => '近期行情',
'record.successfully.created' => '記錄創建成功',
'record.successfully.deleted' => '記錄已成功刪除',
'record.successfully.updated' => '記錄已成功更新',
'records.no' => '無記錄',
'recurring' => '再次發生的',
'recurring.add' => '重複添加',
'recurring.deleted' => '已刪除',
'recurring.frequency' => '頻率',
'recurring.invoices' => '定期發票',
'recurring.no.invoices.selected' => '您尚未選擇任何發票。',
'recurring.original.invoice.date' => '原始發票日期： ',
'recurring.status.sent.only' => '只有狀態為「已發送」的發票才可以重複發送',
'recurring.tooltip.next' => '下一個日期透過索引來設定。',
'reject' => '拒絕',
'reject.this.quote' => '拒絕此報價',
'rejected' => '被拒絕',
'reminder' => '已發送提醒',
'remove' => '消除',
'remove.logo' => '移除標誌',
...
'sales.with.tax' => '含稅銷售',
'salesorder' => '銷售訂單',
'salesorder.agree.to.terms' => '請同意即將發送給您的條款',
...
'salesorder.goods.services.delivered' => '已交付的商品/服務',
'salesorder.invoice' => '發票',
'salesorder.invoice.generate' => '發票生成',
'salesorder.invoice.generated' => '已產生發票',
'salesorder.invoice.number' => '發票號碼',
'salesorder.number' => '銷售訂單編號',
'salesorder.number.status' => '銷售訂單編號 狀態',
'salesorder.password' => '銷售訂單密碼',
'salesorder.payment.terms' => '銷售訂單付款條款，例如：請在 30 天內付款',
'salesorder.recent' => '近期銷售訂單',
'salesorder.reject' => '銷售訂單拒絕',
'salesorder.rejected' => '銷售訂單被拒絕',
'salesorder.sent.to.customer' => '需要條款協議',
'salesorder.to.invoice' => '銷售訂單到發票',
'salesorder.vat.salesorder' => '增值稅銷售訂單',
'salesorders' => '銷售訂單',
'save' => '節省',
...
'site.soletrader.about.happy' => '滿意的顧客',
'site.soletrader.about.quality' => '不犧牲質量',
'site.soletrader.about.return' => '回頭客',
'site.soletrader.about.simply' => '只要拿起一個電話，我們就會重新完成工作。',
'site.soletrader.about.solved' => '已解決的問題',
'site.soletrader.about.trained' => '我們的團隊訓練有素、經驗豐富。',
'site.soletrader.about.we' => '我們勤奮地盡最大努力運用我們的技能。',
'site.soletrader.about.willing' => '願意回報支持',
'site.soletrader.contact.address' => '地址',
'site.soletrader.contact.email' => '電子郵件',
'site.soletrader.contact.lookout' => '我們始終期待與新客戶合作。如果您有意向，請透過以下方式與我們聯繫。',
'site.soletrader.contact.phone' => '電話',
'site.soletrader.contact.touch' => '聯絡我們',
'site.soletrader.pricing.basic' => '基本的',
'site.soletrader.pricing.choosePlan' => '選擇計劃',
'site.soletrader.pricing.currencyPerMonth' => '每月',
'site.soletrader.pricing.explore' => '探索我們靈活的定價，找到最適合您經營業務的定價。',
...
'site.soletrader.team.we' => '我們是一群富有愛心、經驗豐富、勤奮的人。',
'site.soletrader.testimonial.we' => '這些是推薦',
...
'six.months' => '六個月',
'smtp.mail.from' => '系統電子郵件的 SMTP 寄件者位址',
'smtp.password' => 'SMTP 密碼',
'smtp.port' => 'SMTP 連接埠',
'smtp.requires.authentication' => '需要身份驗證',
'smtp.security' => '安全',
'smtp.server.address' => 'SMTP 伺服器位址',
'smtp.ssl' => 'SSL',
'smtp.tls' => 'TLS',
'smtp.username' => 'SMTP 使用者名稱',
'smtp.verify.certs' => '驗證 SMTP 證書',
'sql.file' => 'SQL檔案',
'start' => '開始',
'start.date' => '開始日期',
'state' => '狀態',
...
'sumex.place' => '蘇梅克斯廣場',
'sumex.place.association' => '協會',
'sumex.place.company' => '公司',
'sumex.place.hospital' => '醫院',
'sumex.place.lab' => '實驗室',
'sumex.place.practice' => '實踐',
'sumex.rcc' => '碾壓混凝土',
'sumex.role' => 'Sumex 角色',
'sumex.role.chiropractor' => '脊椎按摩師',
'sumex.role.dentaltechnician' => '牙科技師',
'sumex.role.dentist' => '牙醫',
'sumex.role.druggist' => '藥師',
'sumex.role.ergotherapist' => '體能治療師',
'sumex.role.hospital' => '醫院',
'sumex.role.labtechnician' => '實驗室技術員',
'sumex.role.logotherapist' => '意義治療師',
'sumex.role.midwife' => '助產士',
'sumex.role.naturopathicdoctor' => '自然療法醫生',
'sumex.role.naturopathictherapist' => '自然療法治療師',
'sumex.role.nursingstaff' => '護理人員',
'sumex.role.nutritionist' => '營養師',
'sumex.role.other' => '其他',
'sumex.role.othertechnician' => '其他技術人員',
'sumex.role.pharmacist' => '藥師',
'sumex.role.physician' => '醫生',
'sumex.role.physiotherapist' => '物理治療師',
'sumex.role.psychologist' => '心理學家',
'sumex.role.transport' => '運輸',
'sumex.role.wholesaler' => '批發商',
'sumex.settings' => 'Sumex 設定',
...
'tax.code' => '稅法',
'tax.code.short' => '稅法',
'tax.information' => '稅務資訊',
'tax.point' => '日期稅點',
'tax.rate' => '稅率',
'tax.rate.add' => '稅率加',
'tax.rate.code' => '發票稅率代碼',
'tax.rate.decimal.places' => '稅率小數位數',
'tax.rate.edit' => '編輯稅率',
'tax.rate.form' => '稅率表',
'tax.rate.history.exists' => '無法刪除。歷史記錄已存在',
'tax.rate.name' => '稅率名稱，例如：標準',
'tax.rate.percent' => '稅率百分比',
'tax.rate.placement' => '稅率設定',
'tax.rates' => '稅率',
'taxes' => '稅收',
'telegram' => '電報',
...
'total.billed' => '總帳單',
'total.paid' => '支付總額',
'transaction.reference' => '交易參考',
'transaction.successful' => '交易成功',
'treatment' => '治療',
'treatment.end' => '治療結束',
'treatment.start' => '開始治療',
'true' => '真的',
'try.again' => '再試一次',
...
'unit.edit' => '編輯單位',
'unit.history' => '無法刪除。歷史記錄已存在。',
'unit.name' => '單位名稱',
'unit.name.plrl' => '單位名稱（複數形式）',
'unit.peppol' => '佩波爾',
'unit.peppol.add' => '單位 Peppol 添加',
'unit.peppol.code' => '單位 Peppol 代碼',
'unit.peppol.edit' => '佩波爾單位 編輯',
'unit.peppol.index' => '單位 Peppol 指數',
'units' => '單位',
'unknown' => '未知',
'unpaid' => '未付',
'updatecheck' => '更新檢查',
'updatecheck.failed' => '更新檢查失敗！請檢查您的網路連線。',
'updates' => '更新',
'updates.available' => '有可用更新！',
'upload.date' => '上傳日期',
'upload.description' => '描述',
'upload.filename.description' => '檔案名稱 描述',
'upload.filename.new' => '新檔案名稱',
'upload.filename.original' => '原始檔名',
'upload.index' => '上傳索引',
'upload.plural' => '上傳',
'upload.url.key' => 'URL 鍵',
'use.system.language' => '使用系統語言',
'user' => '使用者',
'user.account' => '發票使用者帳戶',
...
'user.client.count' => '#',
'user.client.no.account' => '此用戶端沒有關聯的使用者帳戶，因此無法建立此文件。',
'user.clients.assigned.not' => '該用戶尚未被指定客戶。',
'user.form' => '使用者表單',
'user.iban' => 'IBAN',
...
'username' => '使用者名稱',
'users' => '使用者',
'utility.assets.clear' => '清除資源快取',
'validator.fail' => '無法處理欄位 %s：%s',
...
'value' => '價值',
'values' => '價值觀',
'values.with.taxes' => '含稅價值',
'vat' => '加值稅',
'vat.abbreviation' => '加值稅',
'vat.break.down' => '增值稅摘要',
'vat.id' => '增值稅號',
'vat.id.short' => '加值稅',
'vat.invoice' => '增值稅發票',
'vat.rate' => '增值稅稅率',
'vat.reg.no' => '增值稅登記號',
'vat.registered' => '增值稅登記',
'vendor.nikic.fast-route' => '打造更快的路線',
'verify.password' => '驗證密碼',
'version.history' => '版本歷史記錄',
'view' => '看法',
'view.all' => '看全部',
'view.client' => '查看客戶端',
'view.clients' => '查看客戶',
...
'view.invoices' => '查看發票',
'view.payment.logs' => '查看線上支付日誌',
'view.payments' => '查看付款',
'view.product.families' => '查看產品系列',
'view.product.units' => '查看產品單位',
'view.products' => '查看產品',
'view.projects' => '查看項目',
'view.quotes' => '查看報價',
'view.recurring.invoices' => '查看定期發票',
'view.tasks' => '查看任務',
'viewed' => '已瀏覽',
'warning' => '警告',
'web' => '網路',
'web.address' => '網址',
'welcome' => '歡迎',
'wrong.passwordreset.token' => '未找到提供重置令牌的使用者。如果您認為這是一個錯誤，請聯絡您的管理員。',
'year' => '年',
'year.prefix' => '年份前綴',
'years' => '年',
'yes' => '是的',
