...
return [
    ...
    'as4.messages.log' => 'AS4-berichten',
    ...
    'body' => 'Lichaam',
    'bookkeeping.export.hint' => 'Synchroniseert het grootboek vanuit uw facturen en verzendt vervolgens alles wat nog niet is geëxporteerd naar QuickBooks.',
    'bookkeeping.export.now' => 'Exporteer nu',
    'bookkeeping.export.summary' => 'Export van boekhoudgegevens voltooid: %d geëxporteerd, %d mislukt.',
    'bookkeeping.quickbooks.account.accounts.receivable' => 'Debiteurenrekening-ID',
    'bookkeeping.quickbooks.account.bank' => 'Bankrekening-ID',
    'bookkeeping.quickbooks.account.payment.fees' => 'Betalingskosten Rekening-ID',
    'bookkeeping.quickbooks.account.sales' => 'Verkoopaccount-ID',
    'bookkeeping.quickbooks.account.vat.or.tax' => 'BTW-/omzetbelastingrekening-ID',
    'bookkeeping.quickbooks.client.id' => 'Klant-ID',
    'bookkeeping.quickbooks.client.secret' => 'Klantgeheim',
    'bookkeeping.quickbooks.connect' => 'Verbinden met QuickBooks',
    'bookkeeping.quickbooks.connect.cancelled' => 'De QuickBooks-verbinding is geannuleerd of geweigerd.',
    'bookkeeping.quickbooks.connect.hint' => 'U wordt doorgestuurd naar QuickBooks om deze app te autoriseren. De onderstaande client-ID/geheimcode moet eerst worden opgeslagen.',
    'bookkeeping.quickbooks.connect.invalid.state' => 'De QuickBooks-verbinding is mislukt: ongeldige statusparameter.',
    'bookkeeping.quickbooks.connect.success' => 'Gekoppeld aan QuickBooks.',
    'bookkeeping.quickbooks.connect.unexpected.response' => 'QuickBooks gaf een onverwachte reactie.',
    'bookkeeping.quickbooks.connected' => 'Aangesloten',
    'bookkeeping.quickbooks.not.configured' => 'De QuickBooks-client-ID/het QuickBooks-geheim is niet geconfigureerd.',
    'bookkeeping.quickbooks.not.connected' => 'Niet verbonden',
    'bookkeeping.quickbooks.sandbox' => 'Sandbox (maakt gebruik van sandbox-quickbooks.api.intuit.com)',
    'boolean' => 'Booleaanse',
    ...
    'bootstrap5.calendar.accent.color' => 'Kalenderaccentkleur',
    ...
    'bootstrap5.layout.invoice.navbar.sticky' => 'Vaste navigatiebalk',
    'bootstrap5.layout.invoice.navbar.sticky.hint' => 'Houdt de bovenste navigatiebalk vast terwijl de pagina eronder scrollt. Wordt direct opgeslagen — het effect is zichtbaar bij de volgende paginalading.',
    ...
    'client.postaladdress.add.save.first' => 'Sla deze klant eerst op en voeg daarna een postadres toe.',
    ...
    'debug.reset.tree.confirm' => 'Weet je zeker dat je wilt doorgaan?',
    'debug.reset.tree.confirm.button' => 'Afbreken en opnieuw opbouwen',
    'debug.reset.tree.db.password' => 'Databasewachtwoord',
    'debug.reset.tree.done' => 'De tabellen Inv, Quote en SalesOrder zijn verwijderd en opnieuw opgebouwd.',
    'debug.reset.tree.failed' => 'De reset is mislukt, er is verder niets veranderd.',
    'debug.reset.tree.menu' => 'Factuur/Offerte/Verkooporder resetten',
    'debug.reset.tree.tables.heading' => 'De volgende tabellen worden verwijderd en opnieuw aangemaakt, zonder inhoud:',
    'debug.reset.tree.title' => 'Voorraad, offerte en verkooporder resetten',
    'debug.reset.tree.warning' => 'Hiermee worden alle facturen, offertes en verkooporders, inclusief alle regelitems, bedragen, btw-tarieven, aangepaste velden en toeslagen, permanent verwijderd. Er wordt eerst een gecomprimeerde back-up naar /backups geschreven, maar dit kan vanaf dit scherm niet ongedaan worden gemaakt.',
    'debug.reset.tree.wrong.password' => 'Onjuist databasewachtwoord, er is niets gewijzigd',
    ...
    'delivery.location.peppol.output.fix' => 'Stel er nu een in',
    ...
    'grid.sticky.header' => 'Vaste rasterkop',
    'grid.sticky.header.hint' => 'Houdt kolomkoppen bovenaan vast tijdens het scrollen door een lange lijst met facturen, offertes, verkooporders of producten. Wordt direct opgeslagen — het effect is zichtbaar wanneer u een lijst opent.',
    'gridview.api' => 'API',
    ...
    'home.peppol.access.point.status' => 'Status van het Peppol-toegangspunt ➡️',
    ...
    'invoice.status.cannot.revert' => 'Een uitgegeven factuur kan niet worden teruggezet naar een eerdere status. Annuleer de factuur (indien onbetaald) of geef een creditnota uit.',
    'invoice.status.issued' => 'Uitgegeven',
    'invoice.status.void' => 'Leegte',
    'invoice.to.html' => 'Factuur naar HTML',
    'invoice.trash' => 'Factuurprullenbak',
    'invoice.validation.errors' => 'Factuurvalidatiefouten',
    'invoice.void' => 'Ongeldige factuur',
    'invoice.void.confirm' => 'Wilt u deze factuur ongeldig maken? Dan wordt deze geannuleerd, behoudt u het factuurnummer en kunt u de factuur niet meer bewerken of betalen.',
    'invoice.void.not.allowed' => 'Alleen een uitgegeven of ingezien factuur zonder betaling kan worden geannuleerd. Geef in plaats daarvan een creditnota uit.',
    'invoice.void.selected.confirm' => 'De geselecteerde facturen ongeldig maken? Alleen uitgegeven of bekeken facturen zonder betaling worden ongeldig gemaakt; deze behouden hun nummer en kunnen niet meer worden bewerkt.',
    'invoice.void.success' => 'Factuur ongeldig verklaard.',
    ...
    'menu.more' => 'Meer',
    'menu.peppol.status' => 'Peppol-toegangspuntstatus',
    ...
    'mtd.business.missing.nino.or.token' => 'Burgerservicenummer of HMRC-toegangstoken niet ingesteld',
    'mtd.eori' => 'Registratie- en identificatienummer voor economische actoren (EORI-nummer)',
    'mtd.eori.hint' => 'Het was nodig om dit bedrijf te identificeren bij de API voor douaneaangiften van HMRC -- bijvoorbeeld GB123456789000',
    'mtd.fph' => 'Fraudepreventie-headers',
    'mtd.fph.all.valid' => 'Alle Fraudepreventie-headers zijn geldig',
    'mtd.fph.feedback.client.credentials.error' => 'HMRC heeft het verzoek om een ​​applicatie-beperkt toegangstoken afgewezen: "{error}" — {description}',
    'mtd.fph.feedback.no.client.credentials.token' => 'DEVELOPER_GOV_SANDBOX_HMRC_API_CLIENT_ID of _CLIENT_SECRET is niet ingesteld in .env -- FPH Feedback heeft een eigen, applicatie-specifieke toegangstoken van HMRC nodig, die losstaat van het token dat door alle andere HMRC-pagina\'s hier wordt gebruikt.',
    'mtd.fph.feedback.unexpected.token.response' => 'HMRC gaf een 200-statuscode terug voor het verzoek om een ​​toegangstoken met applicatiebeperkingen, maar er zat geen access_token in de reactie.',
    'mtd.fph.generate' => 'Genereren',
    'mtd.fph.manage.subscriptions.link.text' => 'Voeg het hier toe',
    'mtd.fph.missing.hmrc.token' => 'U bent niet ingelogd bij HMRC. {link}, probeer het dan opnieuw.',
    'mtd.fph.missing.otp.session' => 'De gegevens van uw tweefactorauthenticatiesessie ontbreken of zijn verlopen. Deze gegevens zijn nodig voor het testen van de Fraud Prevention Headers. Log uit en weer in en probeer het opnieuw.',
    ...
    'mtd.fph.validate.error.generic' => 'HMRC heeft een foutmelding gegeven bij het valideren van uw fraudepreventieheaders: "{code}" — {message}',
    'mtd.fph.validate.error.not.subscribed' => 'HMRC heeft "{code}" geretourneerd: {message} Uw Developer Hub-applicatie moet de Test Fraud Prevention Headers API toevoegen aan de abonnementen — {link}.',
    ...
    'mtd.hmrc.developer.hub' => 'HMRC-ontwikkelaarshub',
    'mtd.hmrc.developer.hub.add.production.application' => 'Productieapplicatie toevoegen',
    'mtd.hmrc.developer.hub.add.sandbox.application' => 'Sandbox-applicatie toevoegen',
    'mtd.hmrc.developer.hub.application.id' => 'Developer Hub-applicatie-ID',
    'mtd.hmrc.developer.hub.application.id.not.set' => 'Niet ingesteld — voeg DEVELOPER_GOV_SANDBOX_HMRC_API_APPLICATION_ID toe aan .env (de UUID van de URL "Applicatie beheren" van Developer Hub zelf, niet de OAuth client_id)',
    'mtd.hmrc.developer.hub.change.name.and.description' => 'Naam en beschrijving wijzigen',
    'mtd.hmrc.developer.hub.change.password' => 'Wachtwoord wijzigen',
    'mtd.hmrc.developer.hub.client.secrets' => 'Klantgeheimen',
    'mtd.hmrc.developer.hub.delete.application' => 'Applicatie verwijderen',
    'mtd.hmrc.developer.hub.email.preferences' => 'E-mailvoorkeuren',
    'mtd.hmrc.developer.hub.ip.allowlist' => 'IP-toegangslijst',
    'mtd.hmrc.developer.hub.login' => 'Inloggen',
    'mtd.hmrc.developer.hub.logout' => 'Uitloggen',
    'mtd.hmrc.developer.hub.manage.application' => 'Applicatie beheren',
    'mtd.hmrc.developer.hub.profile' => 'Profiel',
    'mtd.hmrc.developer.hub.redirect.uris' => 'Omleidings-URI\'s',
    'mtd.hmrc.developer.hub.security.preferences' => 'Beveiligingsvoorkeuren',
    'mtd.hmrc.developer.hub.subscriptions' => 'Abonnementen',
    'mtd.hmrc.developer.hub.tc.and.privacy.policy.url' => 'Algemene voorwaarden / privacybeleid URL',
    'mtd.hmrc.developer.hub.team.members' => 'Teamleden',
    'mtd.individual.calculations.trigger.error' => 'HMRC gaf een foutmelding die de berekening activeerde: "{code}" — {message}',
    'mtd.individual.calculations.triggered' => 'Berekening gestart (ID: {calculationId}).',
    'mtd.nino' => 'Burgerservicenummer (BSN)',
    'mtd.nino.hint' => 'Vereist voor elke NINO-gebaseerde API hieronder (Zelfstandige, Bedrijfsgegevens, enz.) -- gebruik voor de HMRC-sandbox de NINO die wordt geretourneerd door \'Testgebruiker aanmaken\', niet uw eigen echte NINO.',
    ...
    'mtd.vat.return.error.client_or_agent_not_authorised' => 'Dit account is niet gemachtigd om btw-aangiften in te dienen voor dit VRN-nummer.',
    'mtd.vat.return.error.duplicate_submission' => 'Voor deze periode is reeds een btw-aangifte ingediend.',
    'mtd.vat.return.error.invalid_monetary_amount' => 'Een van de ingediende bedragen is geen geldige geldwaarde (0 tot 99.999.999.999,99, tot 2 decimalen).',
    'mtd.vat.return.error.invalid_numeric_value' => 'Een van de ingevoerde waarden is geen geldig getal.',
    'mtd.vat.return.error.invalid_request' => 'De Britse belastingdienst (HMRC) heeft dit verzoek afgewezen omdat het onjuist was ingediend.',
    'mtd.vat.return.error.not_finalised' => 'Deze aangifte is niet als definitief aangemerkt. Vink het vakje voor de declaratie aan en dien de aangifte opnieuw in.',
    'mtd.vat.return.error.period_key_invalid' => 'De periodecode voor deze btw-aangifte is ongeldig of wordt niet herkend.',
    'mtd.vat.return.error.rule_insolvent_trader' => 'Volgens de gegevens van de Britse belastingdienst (HMRC) is deze handelaar insolvent, waardoor de aangifte niet kan worden geaccepteerd.',
    'mtd.vat.return.error.tax_period_not_ended' => 'Deze belastingperiode is nog niet afgelopen; de Britse belastingdienst (HMRC) kan geen aangifte accepteren voordat de periode is afgesloten.',
    'mtd.vat.return.error.vat_net_value' => 'Vak 5 (Netto verschuldigde btw) moet gelijk zijn aan het verschil tussen vak 3 en vak 4.',
    'mtd.vat.return.error.vat_total_value' => 'Vak 3 (Totaal verschuldigde btw) moet gelijk zijn aan Vak 1 + Vak 2.',
    'mtd.vat.return.error.vrn_invalid' => 'Het opgegeven btw-nummer is ongeldig.',
    ...
    'off' => 'Uit',
    'on' => 'Op',
    'online.bookkeeping' => 'Online boekhouding',
    ...
    'online.payment.bitpay.generic.complete.message' => 'Uw BitPay-betaling wordt verwerkt. Uw factuur wordt automatisch bijgewerkt zodra BitPay de betaling on-chain bevestigt. Controleer uw factuur rechtstreeks voor de meest recente status.',
    ...
    'online.payment.payment.processing.generic' => 'Bedankt',
    ...
    'oxalis' => 'Oxalis',
    'oxalis.env.not.set' => 'Niet ingesteld',
    'oxalis.env.only.note' => 'Oxalis wordt geconfigureerd via .env-variabelen, niet hier — hieronder alleen-lezen weergegeven. Zie src/Invoice/Peppol/README.md voor de installatiestappen. Oxalis is in deze implementatie nog niet gebruikt voor een daadwerkelijke verzending.',
    'oxalis.setup.guide' => 'Installatiehandleiding voor Oxalis →',
    'page' => 'Pagina',
    'paid' => 'Betaald',
    'password' => 'Wachtwoord',
    ...
    'peppol.access.point.get.credentials' => 'Inloggegevens verkrijgen →',
    'peppol.access.point.hint' => 'Kies het toegangspunt waarmee u uw Peppol-documenten daadwerkelijk verzendt en vul vervolgens de gegevens van die aanbieder hieronder in. Alleen de kaart van de geselecteerde aanbieder wordt gebruikt voor de verzending.',
    'peppol.access.point.provider' => 'Toegangspuntaanbieder',
    ...
    'peppol.buyer.postal.address.not.found.fix' => 'Los het nu op.',
    ...
    'peppol.client.check.missing' => 'Deze klant heeft helemaal geen Peppol-gegevens ingesteld.',
    'peppol.client.check.no.client' => 'Aan deze factuur is geen klant gekoppeld — Peppol kan niet zonder klant worden verzonden.',
    ...
    'peppol.endpointid.checksum.invalid' => 'Deze waarde voldoet niet aan de door het schema vereiste controlesom.',
    'peppol.endpointid.looks.like.email' => 'Dit lijkt op een e-mailadres, maar geen enkel bestaand Peppol-schema gebruikt er een als identificatiemiddel. Voer in plaats daarvan de bedrijfsidentificatiecode (registratienummer, btw-nummer, GLN, enz.) in die overeenkomt met het geselecteerde schema.',
    ...
    'peppol.messages.log' => 'Peppol-berichten',
    'peppol.optional' => ' (Optioneel)',
    'peppol.send.via' => 'Verzenden via Peppol',
    ...
    'peppol.tax.category.not.found.fix' => 'Stel het nu in',
    ...
    'product.peppol.unit.hint' => 'Het is niet nodig om dit product op te slaan, maar het is wel vereist zodra een factuur met dit product via Peppol wordt verzonden. Dit moet een UnitPeppol-record zijn voor dezelfde eenheid die hierboven is geselecteerd, niet zomaar een willekeurig UnitPeppol-record. Stel dit nu in als dit product ooit op een Peppol-factuur zal worden gebruikt.',
    'product.peppol.unit.missing' => 'Niet ingesteld',
    'product.price' => 'Prijs',
    ...
    'rejected' => 'Afgewezen',
    'remember.me.days' => 'Onthoud mij (duur: dagen)',
    ...
    'run.sheet.pdf.tooltip' => 'Download een pdf van elke factuur die momenteel door uw filters wordt weergegeven, met het adres bovenaan als een aanklikbare Google Maps-link. Dit is handig voor een schoonmaakbezoek van HomeCare of voor elke andere factuurlijst die u offline wilt bekijken of raadplegen.',
    'sales' => 'Verkoop',
    ...
    'setting.arbitration.details.note' => 'De velden \'Arbitrage-instantie\' en \'Arbitragejurisdictie\' die worden gebruikt in de secties \'Geschillenbeslechting\' en \'Toepasselijk recht\', worden ook ingesteld op de bedrijfspagina.',
    ...
    'setting.company.details.note' => 'De bedrijfsnaam, contactgegevens en het adres die op deze pagina worden weergegeven, worden beheerd op de bedrijfspagina.',
    ...
    'setting.hide.from.front.page' => 'Verberg dit op de voorpagina',
    'setting.key' => 'Instelsleutel',
    'setting.privacy.policy.preview' => 'Bekijk het privacybeleid',
    'setting.section' => 'Sectie',
    'setting.subsection' => 'Subsectie',
    'setting.terms.of.service.preview' => 'Bekijk de gebruiksvoorwaarden',
    ...
    'sticky.grid.header' => 'Vaste rasterkop',
    'sticky.grid.header.hint' => 'Houdt de kolomkoppen van de factuurlijst vast tijdens het scrollen. Wordt direct opgeslagen en is van kracht bij de volgende paginalading.',
    'sticky.navbar' => 'Vaste navigatiebalk',
    'sticky.navbar.hint' => 'Hiermee blijft de bovenste navigatiebalk vastgezet terwijl u door deze pagina scrollt. De wijziging wordt direct opgeslagen en treedt in werking bij de volgende paginalading.',
    'stop' => 'Stop',
    ...
    'taxes' => 'Belastingen',
    'taxrate.peppol.tax.rate.code.hint' => 'Het is niet verplicht om dit belastingtarief op te slaan, maar het is wel vereist (UNCL5305-code, bijv. S/Z/E/AE) zodra een factuur met dit belastingtarief via Peppol wordt verzonden. Stel het nu in als u dit tarief ooit op een Peppol-factuur wilt gebruiken.',
    'taxrate.peppol.tax.rate.code.missing' => 'Niet ingesteld',
    'telegram' => 'Telegram',
    ...
    'two.factor.authentication.use.backup.code' => 'Gebruik in plaats daarvan de 8-cijferige back-upherstelcode.',
    'type' => 'Type',
