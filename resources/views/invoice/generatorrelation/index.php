...
<?php echo Html::openTag('div'); ?>
    <?php echo Html::openTag('h5'); ?><?php echo $translator->translate('generator.relations'); ?><?php echo Html::closeTag('h5'); ?>
        <?php echo Html::openTag('div'); ?>
            <?php echo Html::a(
...
?>
<?php
$toolbarString = Form::tag()->post($urlGenerator->generate('generatorrelation/index'))->csrf($csrf)->open().
