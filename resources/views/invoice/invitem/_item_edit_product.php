...
<tbody id="new_inv_item_row">
                ...
                <td class="td-amount td-vert-middle">
                    <div class="input-group">
                        ...
                        <input type="number" name="discount_amount" class="input-sm form-control amount has-feedback" required
                               ...
                               title="<?= $s->get_setting('currency_symbol') . ' ' . $translator->translate('i.per_item'); ?>" value="<?= $numberhelper->format_amount($body['discount_amount'] ?? 0.00); ?>">
                    </div>
                </td>
                <!-- icon button example -->
                <?php 
 ...
 // if one or more allowance/charge is associated with this item show the index button
                ...
                <td class="td-icon text-right td-vert-middle">                   
                    <button type="submit" class="btn btn btn-info" data-bs-toggle = "tooltip" title="invitem/edit"><i class="fa fa-plus"></i><?= $translator->translate('i.save'); ?></button>
                </td>
            </tr>
            <tr>
