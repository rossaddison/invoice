...
$columns = [
    ...
    new DataColumn(
        ...
        content: static function (QuoteAllowanceCharge $model): string {
    ...
    new DataColumn(
        property: 'vat_or_tax',
        header: $vat ? $translator->translate('vat', ['term' => $s->activeTaxSchemeTerm()])
...
$gridSummary = $s->gridSummary(
    ...
    $translator->translate('allowance.or.charge.quote'),
    '',
);
...
// can be sorted. It also appears in this state if another column has been sorted
...
->header($translator->translate('allowance.or.charge.quote'))
