...
echo Breadcrumbs::widget()
    ->links(
        ...
        BreadcrumbLink::to(
            ...
            attributes: [
                'data-bs-toggle' => 'tooltip',
                'title'          => '1' == $s->getSetting('generate_invoice_number_for_draft') ? '✅' : '❌',
            ],
            encodeLabel: false,
        ),
        BreadcrumbLink::to(
...
<div>
    ...
    <div class="submenu-row">
        ...
        <div class="btn-group index-options">
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 0]); ?>"
            ...
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 1]); ?>" style="text-decoration:none"
               class="btn btn-<?php echo 1 == $status ? $iR->getSpecificStatusArrayClass(1) : 'btn-default'; ?>">
                   <?php echo $iR->getSpecificStatusArrayEmoji(1).' '.$translator->translate('draft'); ?>
            </a>
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 2]); ?>" style="text-decoration:none"
            ...
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 3]); ?>" style="text-decoration:none"
            ...
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 4]); ?>" style="text-decoration:none"
            ...
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 5]); ?>" style="text-decoration:none"
            ...
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 6]); ?>" style="text-decoration:none"
            ...
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 7]); ?>" style="text-decoration:none"
            ...
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 8]); ?>" style="text-decoration:none"
            ...
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 9]); ?>" style="text-decoration:none"
            ...
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 10]); ?>" style="text-decoration:none"
            ...
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 11]); ?>" style="text-decoration:none"
            ...
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 12]); ?>" style="text-decoration:none"
            ...
            <a href="<?php echo $urlGenerator->generate('inv/index', ['page' => 1, 'status' => 13]); ?>" style="text-decoration:none"
...
<?php
    ...
    $columns = [
                ...
                if (($inv instanceof Inv) && (null !== ($id = $inv->getId()))) {
                    return Input::tag()
                        ...
                        ->addAttributes([
                            ...
                            'name'           => 'checkbox[]',
                            'data-bs-toggle' => 'tooltip',
                            'title'          => 0 == $inv->getInvAmount()->getTotal() ?
        ...
        new DataColumn(
            ...
            content: static function (Inv $model) use ($islR, $toggleColumnInvSentLog): string|A {
                $modelId = $model->getId();
                if (null !== $modelId) {
        ...
        new DataColumn(
            'invsentlogs',
            header: $translator->translate('email.logs.with.filter'),
            content: static function (Inv $model) use ($islR, $urlGenerator, $translator): string|A {
                $modelId = $model->getId();
                if (null !== $modelId) {
                    $count = $islR->repoInvSentLogEmailedCountForEachInvoice($modelId);
                    if ($count > 0) {
        ...
        new DataColumn(
            ...
            content: static function (Inv $model) use ($s, $iR, $irR, $translator): Yiisoft\Html\Tag\CustomTag {
                ...
                if ($model->getIs_read_only() && '0' == $s->getSetting('disable_read_only')) {
                    $label .= ' 🚫';
                }
        ...
        new DataColumn(
            ...
            content: static function (Inv $model) use ($s, $translator, $urlGenerator): A|Label {
                return false === $model->getIs_read_only() && $s->getSetting('disable_read_only') === (string) 0 && '0' === $model->getSo_id() && '0' === $model->getQuote_id() ?
                        A::tag()->content(
                            Html::tag(
                                'button',
...
?>
<?php
$toolbarString = Form::tag()->post($urlGenerator->generate('inv/index'))->csrf($csrf)->open().
