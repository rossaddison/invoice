        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-8">
            <div class="card border border-dark shadow-2-strong rounded-3">
                <div class="card-header bg-dark text-white">
                    <h1 class="fw-normal h3 text-center"><?php echo $translator->translate('email.invoice').' #'.($invoice->getNumber() ?? '#').' => '.($invoice->getClient()?->getClient_email() ?? ''); ?></h1>
                </div>
...
?>
                    ...
                    <?php echo Field::email($form, 'to_email')->addInputAttributes(['value' => Html::encode($invoice->getClient()?->getClient_email())])
                        ->required(true)
                        ->hideLabel(); ?> 
                    
                    <?php echo Html::tag('Label', $translator->translate('email.template')); ?>                        
                    <?php echo Field::select($form, 'email_template')
                    ...
                    <?php echo Field::text($form, 'from_name')
                    ...
                    <?php echo Field::email($form, 'from_email')
                    ...
                    <?php echo Field::text($form, 'subject')
                    ...
                    <?php echo Field::select($form, 'pdf_template')
                    ...
                    <?php echo Field::textarea($form, 'body')
...
?>                   
                    ...
                    <div class="form-group">
                        ...
                        <?php echo Field::text($form, 'guest_url')
                            ->readonly(true)
