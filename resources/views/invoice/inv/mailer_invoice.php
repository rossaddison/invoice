            ...
            <div class="card border border-dark shadow-2-strong rounded-3">
                ...
                <div class="card-body p-5 text-center">
                    ...
                    <?= Field::email($form, 'to_email')
                        ->addInputAttributes(['value' => Html::encode($invoice->getClient()?->getClientEmail())])
                        ->required(true)
                        ->hideLabel() ?>
...
$pdfUrlJson = json_encode(
    $urlGenerator->generate('inv/pdfDashboardExcludeCf', ['id' => $invoice->reqId()]),
...
$js7 = <<<JS
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var form = document.getElementById('MailerInvForm');
        if (form) {
...
echo Html::script($js7)->type('module');
