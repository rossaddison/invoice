...
<p><b>1st April 2026</b></p>
<p>CompanyPublic - new field seo_description introduced => BUILDDATABASE in .env</p>
<p>Settings ... General ... Use AppCdnAsset (Not AppNodeModulesAsset)</p>
<p>Settings ... General ... Use InvoiceCdnAsset (Not InvoiceNodeModulesAsset)</p>
<p>Settings ... Bootstrap5 ... Use Bootstrap5CdnAsset (Not Bootstrap5NodeModulesAsset)</p>
<p>Settings ... Bootstrap5 ... Layout{Invoice/Main/Guest}NavBarFont (main, guest(Observer), invoice layouts adjust according to font and fontsize</p>
<p>js files removed where typescript used in its place.</p>
<p>A new AEO related entity QA (Questions and Answers) has been created for future FAQ'S on the frontpage</p>
<p>The generator was used for this purpose.</p>
<p>A few changes have been made to the Generator templates to reflect the overall code of the package.</p>
<p>form-control default is now 'form-control form-control-lg'</p>
<p>The font size was lacking in size on the forms.</p>
<p>Too many var statements in typescript generated by vs code - Sonarqube complaining - so .vscode directory files adjusted</p>
<p>Bugfix: Family index paginator working properly. Generator code adjusted.</p>
<p><b>28th March 2026</b></p>
<p>Reduce var statements in iife to comply with Sonarqube</p>
<p>Create separate Asset files for the Cdn</p>
<p>Use Node</p>
...
<p><b>22nd December 2025</b></p>
<p>OpenTags with classes: Replacing searched html div class="row mb4" with Html::openTag('div', ['class' => 'row mb4'])</p>
<p>Search: <(\w+)\s+class="([^"]*)"[^>]*></p>
<p>Replace: <code>Html::openTag('$1', ['class' => '$2']);</code> </p>
<p>Closing tags without classes</p>
<p>Search: </(\w+)></p>
<p>Replace: <code>Html::closeTag('$1'); </code></p>
