...
<p><b>Step 3:</b> Mollie, for instance, uses 4 keys that are unique to Payment Gateways and have never been used before
   ...
   <pre>
    ...
    'online_payment_testOrLiveApiKey' => 'Test or Live Api Key i.e starts with test_ or live_',
    'online_payment_partnerID' => 'Partner ID',
    'online_payment_profileID' => 'Profile ID',
   </pre>
