...
echo Html::closeTag('td');
echo Html::openTag('td');
echo 'Disables text-end field when used, applies percentage discount';
echo Html::closeTag('td');
echo Html::closeTag('td');
echo 'Medium - Calculation logic';
echo Html::closeTag('td');
...
echo Html::closeTag('td');
echo Html::openTag('td');
echo 'Disables percent field when text-end entered';
echo Html::closeTag('td');
echo Html::openTag('td');
...
echo Html::closeTag('td');
echo Html::openTag('td');
echo 'Disables text-end field when percent entered';
echo Html::closeTag('td');
echo Html::openTag('td');
echo 'Medium - Field interactions';
echo Html::closeTag('td');
