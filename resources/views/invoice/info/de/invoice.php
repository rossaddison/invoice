<!--
    GERMAN TRANSLATION FILE (invoice.de.php)
    
    This file is automatically loaded when the user's language is set to German (_language=de).
    The system will fall back to invoice.php (English) if this file is not found or has errors.
    
    TO TRANSLATE:
    - Replace all English text with German equivalents
    - Keep all HTML tags and structure intact
    - Keep all IDs and class names unchanged
    - Test after translation to ensure proper rendering
-->

<h6 id="invoice">Development Summary: (...resources/views/invoice/info/invoice.de.php)</h6>
