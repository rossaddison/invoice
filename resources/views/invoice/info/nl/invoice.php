<!--
    DUTCH TRANSLATION FILE (invoice.nl.php)
    
    This file is automatically loaded when the user's language is set to Dutch (_language=nl).
    The system will fall back to invoice.php (English) if this file is not found or has errors.
    
    TO TRANSLATE:
    - Replace all English text with Dutch equivalents
...
<h6 id="invoice">Development Summary: (...resources/views/invoice/info/invoice.nl.php)</h6>
