...
<p><b>Fixed development tooling:</b> Updated .php-cs-fixer.php configuration to use '@PER-CS2x0' rule set instead of deprecated '@PER-CS2.0'. Resolved npm dependency conflict by downgrading ESLint from v9.39.0 to v8.57.0 for compatibility with eslint-plugin-deprecation@3.0.0. Added .eslintrc.cjs configuration for TypeScript linting. Both PHP CS Fixer and ESLint now work without deprecation warnings. Removed duplicate addProducts function from InvController as existing modal workflow provides superior functionality.</p>
