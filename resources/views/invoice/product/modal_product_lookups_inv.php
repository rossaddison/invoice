                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="form-group panel panel-primary">
                                <label for="filter_product_inv"><?php echo $translator->translate('product.name'); ?></label>
                                ...
                                <button type="button" id="filter-button-inv" class="btn btn-info"><?php echo $translator->translate('search.product'); ?></button>
                                <button type="button" id="product-reset-button-inv" class="btn btn-danger"><?php echo $translator->translate('reset'); ?></button>
                            </div>
                        </div>
