    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo $translator->translate('telegram.bot.api.general.purpose'); ?>
            </div>
                        ...
                        <div class="form-group">
                            ...
                            <p><b>3. Record the token here ...</b>
                                <label for="settings[telegram_token]" >
                                    <?php echo $translator->translate('telegram.bot.api.token'); ?>
                                </label>
                                <?php
...
?>
                                <input type="password" name="settings[telegram_token]" id="settings[telegram_token]"
                                    class="form-control" value="<?php echo Html::encode($body['settings[telegram_token]']); ?>">
                            </p>
                            ...
                            <p><b>5. </b>Ensure the listening webhook is off before using the manual 'getUpdates' which uses 'long polling' by <a href="<?php echo $urlGenerator->generate('telegram/delete_webhook'); ?>">clicking here ...</a></p>
                            <p><b>6. </b>Use 'getUpdates' now by <a href="<?php echo $urlGenerator->generate('telegram/get_updates'); ?>" target="_blank">clicking here ...</a> and you will see the message Chat Id and message that you sent to your Bot in <b>Step 4.</b> Record your personal account <b>Chat Id</b> below</p>
                            <p><b>7. </b>
                                <label for="settings[telegram_chat_id]" >
                                    <?php echo $translator->translate('telegram.bot.api.chat.id'); ?>
                                </label>
                                <?php
...
?>
                                <input type="password" name="settings[telegram_chat_id]" id="settings[telegram_chat_id]"
                                    class="form-control" value="<?php echo Html::encode($body['settings[telegram_chat_id]']); ?>">
                            </p>
                            <label for="settings[telegram_test_message_use]">
                                <b>8. </b><?php echo $translator->translate('telegram.bot.api.hello.world.test.message.use'); ?>
                            </label>
...
?>>
                            ...
                            <br>
                            <p><b>9. </b>To receive your first 'Hello' 'World' test message <a href="<?php echo $urlGenerator->generate('telegram/index'); ?>">click here...</a></p>
                            <label for="settings[telegram_payment_notifications]">
                                <b>10. </b><?php echo $translator->translate('telegram.bot.api.payment.notifications'); ?>
                            </label>
...
?>>
                ...
                <div class='row'>
                    <div class="col-xs-12 col-md-6">
                        <label for="settings[telegram_payment_notifications]">
                            <b><h4><?php echo 'Webhooks'; ?></h4></b>
                        </label>
                        <div class="form-group">
                            <p><?php echo $translator->translate('telegram.bot.api.current.status'); ?></p>
                            <p><?php echo $translator->translate('telegram.bot.api.future.use'); ?></p>
                            ...
                            <label for="settings[telegram_webhook_secret_token]" >
                                <?php echo $translator->translate('telegram.bot.api.webhook.secret.token'); ?>
                            </label>
                            <?php
...
?>
                            <input type="password" name="settings[telegram_webhook_secret_token]" id="settings[telegram_webhook_secret_token]"
                                 class="form-control" value="<?php echo Html::encode($body['settings[telegram_webhook_secret_token]']); ?>">
                        </div>
                    </div>
                </div>
                <div class='row'>
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            <label>
                                <b><?php echo $translator->translate('telegram.bot.api.webhook.url.this.site'); ?></b>
                            </label>
                            <p><pre><?php echo $urlGenerator->generateAbsolute('telegram/webhook'); ?></pre></p>                           
                        </div>
                    </div>
                </div>    
            </div>    
