    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?= $translator->translate('invoice.invoice.telegram.bot.api.general.purpose'); ?>
            </div>
            <div class="panel-body">
                ...
                <div class='row'>
                    <div class="col-xs-12 col-md-6">
                        ...
                        <div class="form-group">
                            <p><?= $translator->translate('invoice.invoice.telegram.bot.api.current.status'); ?></p>
                            <p><?= $translator->translate('invoice.invoice.telegram.bot.api.future.use'); ?></p>
