...
<div class="row">
    <div class="col-xs-12 col-md-8 col-md-offset-2">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <?= $translator->translate('sumex.settings'); ?>
            </div>
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            ...
                            <p class="help-block"><?= $translator->translate('sumex.help'); ?></p>
                        </div>

                        <div class="form-group">
                            <label for="settings[sumex_sliptype]">
                                <?= $translator->translate('sumex.sliptype'); ?>
                            </label>                                                                                                                                                                                   
...
foreach ($slipTypes as $k => $v): ?>
                                    <option value="<?= $k; ?>" <?php $s->check_select($body['settings[sumex_sliptype]'], $k) ?>>
                                        <?= $translator->translate('sumex.sliptype-' . $v); ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                            <p class="help-block"><?= $translator->translate('sumex.sliptype.help'); ?></p>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            <label for="settings[sumex_role]">
                                <?= $translator->translate('sumex.role'); ?>
                            </label>                                                                                                                                                                                                               
    ...
    foreach ($roles as $k => $v): ?>
                                    <option value="<?= $k; ?>" <?php $s->check_select($body['settings[sumex_role]'], $k) ?>>
                                        <?= $translator->translate('sumex.role.' . $v); ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="settings[sumex_place]">
                                <?= $translator->translate('sumex.place'); ?>
                            </label>                                                                                                                                                                                                                                           
    ...
    foreach ($places as $k => $v): ?>
                                    <option value="<?= $k; ?>" <?php $s->check_select($body['settings[sumex_place]'], $k); ?>>
                                        <?= $translator->translate('sumex.place.' . $v); ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="settings[sumex_canton]">
                                <?= $translator->translate('sumex.canton'); ?>
                            </label>                                                                                                                                                                                                                                                                       
