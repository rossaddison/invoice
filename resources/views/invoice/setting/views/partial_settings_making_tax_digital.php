    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo A::tag()->href('https://github.com/MicrosoftDocs/dynamics365smb-docs/blob/main/business-central/LocalFunctionality/UnitedKingdom/fraud-prevention-data.md')->content($translator->translate('mtd.fph')); ?>
            </div>
            <div class="panel-body">
                <br>
                <label>
                    <h4>
                        <?php echo $translator->translate('mtd.gov.client.connection.method'); ?>
                    </h4>
                </label>
                <div class = 'row'>
        ...
        <!-- Connection Method -->               
                        ...
                        <input type="text" name="settings[fph_connection_method]" id="settings[fph_connection_method]"
                            ...
                            value="<?php echo strlen($body['settings[fph_connection_method]']) > 0 ? $body['settings[fph_connection_method]'] : 'WEB_APP_VIA_SERVER'; ?>">
                        <label>
                            <h4>
                                <?php echo $translator->translate('mtd.gov.client.browser.js.user.agent').' '.$translator->translate('mtd.gov.client.browser.js.user.agent.eg'); ?>
                            </h4>
                        </label>
        ...
        <!-- Client Browser User Agent -->               
                        ...
                        <input type="text" name="settings[fph_client_browser_js_user_agent]" id="settings[fph_client_browser_js_user_agent]"
                            class="form-control" readonly
                            value="<?php echo $body['settings[fph_client_browser_js_user_agent]']; ?>">
        
        <!-- Client Device Id -->                
                        <label>
                            <h4>
                                <?php echo $translator->translate('mtd.gov.client.device.id').' '.$translator->translate('mtd.gov.client.device.id.eg'); ?>
                            </h4>
                        </label>
                        ...
                        <input type="text" name="settings[fph_client_device_id]" id="settings[fph_client_device_id]"
                            class="form-control" readonly
                            value="<?php echo $body['settings[fph_client_device_id]']; ?>">
        
        <!-- Client Screens -->                
                        <label>
                            <h4>
                                <?php echo $translator->translate('mtd.gov.client.screens'); ?>
                            </h4>
                        </label>
                        <br>
                        <label for="settings[fph_screen_width]">
                                <?php echo $translator->translate('mtd.gov.client.screens.width').' ('.$translator->translate('mtd.gov.client.screens.pixels').')'; ?>
                        </label>
                        <?php
                        ...
                        <input type="text" name="settings[fph_screen_width]" id="settings[fph_screen_width]"
                            class="form-control" readonly
                            value="<?php echo $body['settings[fph_screen_width]']; ?>">
                        <label for="settings[fph_screen_height]">
                            <?php echo $translator->translate('mtd.gov.client.screens.height').' ('.$translator->translate('mtd.gov.client.screens.pixels').')'; ?>
                        </label>
                        <?php
                        ...
                        <input type="text" name="settings[fph_screen_height]" id="settings[fph_screen_height]"
                            class="form-control" readonly
                            value="<?php echo $body['settings[fph_screen_height]']; ?>">
                        <label for="settings[fph_screen_scaling_factor]">
                            <?php echo $translator->translate('mtd.gov.client.screens.scaling.factor').' ('.$translator->translate('mtd.gov.client.screens.scaling.factor.bits').')'; ?>
                        </label>
                        <?php
                        ...
                        <input type="text" name="settings[fph_screen_scaling_factor]" id="settings[fph_screen_scaling_factor]"
                            class="form-control" readonly
                            value="<?php echo $body['settings[fph_screen_scaling_factor]']; ?>">
                        <label for="settings[fph_screen_colour_depth]">
                            <?php echo $translator->translate('mtd.gov.client.screens.colour.depth'); ?>
                        </label>
                        <?php
                        ...
                        <input type="text" name="settings[fph_screen_colour_depth]" id="settings[fph_screen_colour_depth]"
                            class="form-control" readonly
                            value="<?php echo $body['settings[fph_screen_colour_depth]']; ?>">
                        <label for="settings[fph_timestamp]">
                            <?php echo $translator->translate('mtd.fph.screen.timestamp'); ?>
                        </label>
                        <?php
                        ...
                        <input type="text" name="settings[fph_timestamp]" id="settings[fph_timestamp]"
                            class="form-control" readonly
                            value="<?php echo $body['settings[fph_timestamp]']; ?>">
        <!-- Client Window Size -->
                        <label for="settings[fph_window_size]">
                            <h4>
                                <?php echo $translator->translate('mtd.gov.client.window.size').' ('.$translator->translate('mtd.gov.client.window.size.pixels').')'; ?>
                            </h4>     
                        </label>
                        <?php
                        ...
                        <input type="text" name="settings[fph_window_size]" id="settings[fph_window_size]"
                            class="form-control" readonly
                            value="<?php echo $body['settings[fph_window_size]']; ?>">
        <!-- Client User Id -->
                        <label for="settings[fph_gov_client_user_id]">
                            <h4>
                                <?php echo $translator->translate('mtd.gov.client.user.ids').' ('.$translator->translate('mtd.gov.client.user.ids.uuid').')'; ?>
                            </h4>     
                        </label>
                        <?php
                        ...
                        <input type="text" name="settings[fph_gov_client_user_id]" id="settings[fph_gov_client_user_id]"
                            class="form-control" readonly
                            value="<?php echo $body['settings[fph_gov_client_user_id]']; ?>">                
                    <?php echo Button::tag()
                        ->id('btn_fph_generate')
