    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo $translator->translate('two.factor.authentication'); ?>
            </div>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            <div class="checkbox">
                                ...
                                <label <?php echo $s->where('enable_tfa'); ?>>
                                    ...
                                    <?php echo $translator->translate('two.factor.authentication.enable'); ?>
                                </label>
                            </div>    
                        </div>
                        <div class="form-group">
                            <label for="settings[enable_tfa_with_disabling]">
                                <p><?php echo $translator->translate('yes').' = '; ?><?php echo $translator->translate('two.factor.authentication.enabled.with.disabling'); ?></p>
                                <p><?php echo $translator->translate('no').' = '; ?><?php echo $translator->translate('two.factor.authentication.enabled.without.disabling'); ?></p>
                            </label>
