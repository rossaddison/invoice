    ...
    <div class="col-xs-12 col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo $translator->translate('storecove'); ?>
            </div>
            <div class="panel-body">
                <div class='row'>
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            <label for="settings[storecove_country]" <?php echo $s->where('storecove_country'); ?>>
                                <?php echo Html::a($translator->translate('storecove.create.a.sender.legal.entity.country'), 'https://www.storecove.com/docs/#_create_a_sender', ['style' => 'text-decoration:none']); ?>
                            </label>
                            ...
                            <select name="settings[storecove_country]" id="settings[storecove_country]"
                                    ...
                                    <?php $s->check_select($body['settings[storecove_country]'], $cldr); ?>>
                                            <?php echo $cldr.str_repeat('&nbsp;', 2).str_repeat('-', 10).str_repeat('&nbsp;', 2).$country; ?>
                                    </option>
                                <?php } ?>
                            </select>
                        </div>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            <label for="storecove_legal_entity_id">
                                <?php echo $translator->translate('storecove.legal.entity.id.for.json'); ?>
                            </label>
                            ...
                            <input type="text" name="settings[storecove_legal_entity_id]" id="storecove_legal_entity_id"
                                   class="form-control" 
                                   value="<?php echo $body['settings[storecove_legal_entity_id]']; ?>">
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <div class="form-group">
                            <label for="settings[storecove_sender_identifier]" <?php echo $s->where('storecove_sender_identifier'); ?> >
                                <?php echo $translator->translate('storecove.sender.identifier'); ?>
                            </label>
                            ...
                            <select name="settings[storecove_sender_identifier]" id="settings[storecove_sender_identifier]" class="form-control">
                                ...
                                foreach ($sender_identifier_array as $key => $value) {
                                    ...
                                    <option value="<?php echo $key; ?>" <?php $s->check_select($body['settings[storecove_sender_identifier]'], $key); ?>>
                                        <?php echo ucfirst(
                                            $value['Region']
                                                .str_repeat('&nbsp;', 2)
                                                .str_repeat('-', 10)
                            ...
                            <br>
                            <label for="storecove_sender_identifier_basis" <?php echo $s->where('storecove_sender_identifier_basis'); ?>>
                                <?php echo $translator->translate('storecove.sender.identifier.basis'); ?>
                            </label>
