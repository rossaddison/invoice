    ...
    echo H::openTag('div', ['class' => 'mb-3']); //5
     ...
     echo H::openTag('div', ['class' => 'form-check']); //6
      ...
      echo H::tag('input', '', [
       'type' => 'checkbox',
       'class' => 'form-check-input',
       'id' => 'no_github_continue_button',
       'name' => $kNoGithub,
       'value' => '1',
       'checked' => $body[$kNoGithub] == 1
      ]);
      echo H::openTag('label', ['class' => 'form-check-label', 'for' => 'no_github_continue_button']);
     ...
     echo H::openTag('div', ['class' => 'form-check']); //6
      ...
      echo H::tag('input', '', [
       'type' => 'checkbox',
       'class' => 'form-check-input',
       'id' => 'no_google_continue_button',
       'name' => $kNoGoogle,
       'value' => '1',
       'checked' => $body[$kNoGoogle] == 1
      ]);
      echo H::openTag('label', ['class' => 'form-check-label', 'for' => 'no_google_continue_button']);
     ...
     echo H::openTag('div', ['class' => 'form-check']); //6
      ...
      echo H::tag('input', '', [
       'type' => 'checkbox',
       'class' => 'form-check-input',
       'id' => 'no_facebook_continue_button',
       'name' => $kNoFacebook,
       'value' => '1',
       'checked' => $body[$kNoFacebook] == 1
      ]);
      echo H::openTag('label', ['class' => 'form-check-label', 'for' => 'no_facebook_continue_button']);
     ...
     echo H::openTag('div', ['class' => 'form-check']); //6
      ...
      echo H::tag('input', '', [
       'type' => 'checkbox',
       'class' => 'form-check-input',
       'id' => 'no_govuk_continue_button',
       'name' => $kNoGovuk,
       'value' => '1',
       'checked' => $body[$kNoGovuk] == 1
      ]);
      echo H::openTag('label', ['class' => 'form-check-label', 'for' => 'no_govuk_continue_button']);
       echo H::tag('img', '', [
        'src' => '/img/govuk-opengraph-image.png',
        'width' => '12',
        'height' => '12'
     ...
     echo H::openTag('div', ['class' => 'form-check']); //6
      ...
      echo H::tag('input', '', [
       'type' => 'checkbox',
       'class' => 'form-check-input',
       'id' => 'no_linkedin_continue_button',
       'name' => $kNoLinkedin,
       'value' => '1',
       'checked' => $body[$kNoLinkedin] == 1
      ]);
      echo H::openTag('label', ['class' => 'form-check-label', 'for' => 'no_linkedin_continue_button']);
     ...
     echo H::openTag('div', ['class' => 'form-check']); //6
      ...
      echo H::tag('input', '', [
       'type' => 'checkbox',
       'class' => 'form-check-input',
       'id' => 'no_microsoftonline_continue_button',
       'name' => $kNoMicrosoft,
       'value' => '1',
       'checked' => $body[$kNoMicrosoft] == 1
      ]);
      echo H::openTag('label', ['class' => 'form-check-label', 'for' => 'no_microsoftonline_continue_button']);
       echo new I()->addClass('bi bi-microsoft')->render() . ' Microsoft Online';
      echo H::closeTag('label');
     echo H::closeTag('div'); //6

     echo H::openTag('div'); //6
      echo H::openTag('div', ['class' => 'form-check']); //7
       ...
       echo H::tag('input', '', [
        'type' => 'checkbox',
        'class' => 'form-check-input',
        'id' => 'no_openbanking_continue_button',
        'name' => $kNoOpenBanking,
        'value' => '1',
        'checked' => $body[$kNoOpenBanking] == 1
       ]);
       echo H::openTag('label', ['class' => 'form-check-label', 'for' => 'no_openbanking_continue_button']);
        echo H::openTag('svg', [
     ...
     echo H::openTag('div', ['class' => 'form-check']); //6
      ...
      echo H::tag('input', '', [
       'type' => 'checkbox',
       'class' => 'form-check-input',
       'id' => 'no_openidconnect_continue_button',
       'name' => $kNoOpenIdConnect,
       'value' => '1',
       'checked' => $body[$kNoOpenIdConnect] == 1
      ]);
      echo H::openTag('label', ['class' => 'form-check-label', 'for' => 'no_openidconnect_continue_button']);
     ...
     echo H::openTag('div', ['class' => 'form-check']); //6
      ...
      echo H::tag('input', '', [
       'type' => 'checkbox',
       'class' => 'form-check-input',
       'id' => 'no_vkontakte_continue_button',
       'name' => $kNoVkontakte,
       'value' => '1',
       'checked' => $body[$kNoVkontakte] == 1
      ]);
      echo H::openTag('label', ['class' => 'form-check-label', 'for' => 'no_vkontakte_continue_button']);
       echo H::tag('img', '', [
     ...
     echo H::openTag('div', ['class' => 'form-check']); //6
      ...
      echo H::tag('input', '', [
       'type' => 'checkbox',
       'class' => 'form-check-input',
       'id' => 'no_x_continue_button',
       'name' => $kNoX,
       'value' => '1',
       'checked' => $body[$kNoX] == 1
      ]);
      echo H::openTag('label', ['class' => 'form-check-label', 'for' => 'no_x_continue_button']);
     ...
     echo H::openTag('div', ['class' => 'form-check']); //6
      ...
      echo H::tag('input', '', [
       'type' => 'checkbox',
       'class' => 'form-check-input',
       'id' => 'no_yandex_continue_button',
       'name' => $kNoYandex,
       'value' => '1',
       'checked' => $body[$kNoYandex] == 1
      ]);
      echo H::openTag('label', ['class' => 'form-check-label', 'for' => 'no_yandex_continue_button']);
       echo H::tag('img', '', [
        'src' => '/img/yandex.jpg',
        'width' => '12',
        'height' => '12'
