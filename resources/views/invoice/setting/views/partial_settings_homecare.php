...
echo H::tag(
    'p',
    $translator->translate('homecare.vision.api.key.description'),
    ['class' => 'text-muted']
);
...
echo H::tag(
    'p',
    $translator->translate('homecare.hidden.columns.description'),
    ['class' => 'text-muted']
);
...
echo H::tag(
    'p',
    $translator->translate('homecare.hidden.columns.guest.description'),
    ['class' => 'text-muted']
);
