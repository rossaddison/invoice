...
<header class="clearfix">    
    ...
    <div id="client">
        <div>
            <b><?php echo Html::encode($quote->getClient()?->getClient_name()); ?></b>
        </div>
...
if ($items) {
    ...
    foreach ($items as $item) {
        ...
        <?php if (!empty($quote_tax_rates) && ('0' === $vat)) { ?>    
        <?php
                        /**
                         * @var App\Invoice\Entity\QuoteTaxRate $quote_tax_rate
                         */
        ...
        <?php } ?>
        <?php if ('0' == $vat) { ?>    
        <?php if (0.00 !== $quote->getDiscount_percent()) { ?>
            <tr>
                <td <?php echo $show_item_discounts ? 'colspan="7"' : 'colspan="6"'; ?> class="text-right">
        ...
        <?php } ?>
        <?php if (0.00 !== $quote->getDiscount_amount()) { ?>
            <tr>
                <td <?php echo $show_item_discounts ? 'colspan="7"' : 'colspan="6"'; ?> class="text-right">
                    <?php echo Html::encode($translator->translate('discount')); ?>
                </td>
