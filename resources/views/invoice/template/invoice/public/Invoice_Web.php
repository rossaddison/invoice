    ...
    echo H::openTag('div', $idContent); //4
     echo H::openTag('div', $wpHeader); //5
      ...
      echo H::openTag('div', $btnGroup); //6
       echo H::openTag('a', ['href' => $urlGenerator->generate('inv/pdfDownloadIncludeCf', ['url_key' => $inv_url_key, '_language' => $_language]), 'class' => 'btn btn-primary']); //7
       ...
       echo H::closeTag('a'); //7
       echo H::openTag('a', ['href' => $urlGenerator->generate('inv/pdfDownloadExcludeCf', ['url_key' => $inv_url_key, '_language' => $_language]), 'class' => 'btn btn-danger']); //7
        echo H::tag('i', '', ['class' => 'bi bi-file-pdf']);
       ...
       if ($s->getSetting('enable_online_payments') == 1 && $inv_amount->getBalance() > 0) :
        echo H::openTag('a', ['href' => $urlGenerator->generate('paymentinformation/inform', ['url_key' => $inv_url_key, 'gateway' => $client_chosen_gateway, '_language' => $_language]), 'class' => 'btn btn-success']); //7
