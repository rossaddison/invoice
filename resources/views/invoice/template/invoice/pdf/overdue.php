...
<main>
    ...
    <table class="items table-primary table table-borderless no-margin">
        ...
        <?php } ?>
        <?php if (0.00 !== $inv->getDiscount_amount()) { ?>
            <tr>
                <td <?php echo $show_item_discounts ? 'colspan="7"' : 'colspan="6"'; ?> class="text-right">
                    <?php echo Html::encode($translator->translate('discount')); ?>
                </td>
...
<watermarkimage src="/img/overdue.png" alpha="0.1"></watermarkimage>
...
<footer class="notes">
    ...
    <div>
        ...
        <p><?php echo Html::encode($translator->translate('reason_'.$reason[is_int($sumexReason = $sumex?->getReason()) ? $sumexReason : 5])); ?></p>       
    </div>
    <div>            
