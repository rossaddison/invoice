...
<?php echo Html::openTag('div'); ?>
    <?php echo Html::openTag('h5'); ?><?php echo $translator->translate('group'); ?><?php echo Html::closeTag('h5'); ?>
        <?php echo Html::openTag('div'); ?>
            <?php echo Html::a(I::tag()->addClass('bi bi-plus')->content(' '.Html::encode($translator->translate('new'))), $urlGenerator->generate('group/add'), ['class' => 'btn btn-success']); ?>
...
?>
<?php
$toolbarString = Form::tag()->post($urlGenerator->generate('group/index'))->csrf($csrf)->open().
