...
<?php echo $translator->translate('client.form'); ?>
...
<?php echo Field::select($form, 'client_title')
...
<?php echo Field::text($form, 'client_name')
...
?>
<?php echo Field::text($form, 'client_surname')
...
<?php echo Field::email($form, 'client_email')
...
<?php echo Field::telephone($form, 'client_mobile')
...
<?php echo Field::text($form, 'client_group')
...
<?php echo Field::select($form, 'client_frequency')
...
<?php echo Field::text($form, 'client_number')
...
<?php echo Html::openTag('div', ['class' => 'card']); ?>
    <?php echo Html::openTag('div', ['class' => 'card-header']); ?>
        <?php echo $translator->translate('address'); ?>
    <?php echo Html::closeTag('div'); ?>
    <?php echo Html::openTag('div', ['class' => 'row']); ?>
        <?php echo Html::openTag('div', ['class' => 'mb-3 form-group']); ?>
            <?php echo Field::text($form, 'client_address_1')
...
?>
        ...
        <?php echo Html::tag('br'); ?>
        <?php echo Html::openTag('div', ['class' => 'mb-3 form-group']); ?>
            <?php echo Field::text($form, 'client_address_2')
...
?>
        <?php echo Html::closeTag('div'); ?>
        <?php echo Html::openTag('div', ['class' => 'mb-3 form-group']); ?>
            <?php echo Field::text($form, 'client_building_number')
...
?>
        <?php echo Html::closeTag('div'); ?>
        <?php echo Html::openTag('div', ['class' => 'mb-3 form-group']); ?>
            <?php echo Field::text($form, 'client_city')
...
?>
        <?php echo Html::closeTag('div'); ?>
        <?php echo Html::openTag('div', ['class' => 'mb-3 form-group']); ?>
            <?php echo Field::text($form, 'client_state')
...
?>
        <?php echo Html::closeTag('div'); ?>
        <?php echo Html::openTag('div', ['class' => 'mb-3 form-group']); ?>
            <?php echo Field::text($form, 'client_zip')
...
<?php echo Html::openTag('div', ['class' => 'card']); ?>
    <?php echo Html::openTag('div', ['class' => 'card-header']); ?>
        <?php echo $translator->translate('contact.information'); ?>
    <?php echo Html::closeTag('div'); ?>
    <?php echo Html::openTag('div', ['class' => 'row']); ?>
        <?php echo Html::openTag('div', ['class' => 'mb-3 form-group']); ?>
            <?php echo Field::telephone($form, 'client_phone')
        ...
        ->required(false);
?>
            <?php echo Field::telephone($form, 'client_fax')
    ...
    ->required(false);
?>            
            <?php echo Field::text($form, 'client_web')
...
?>
        ...
        <?php echo Html::openTag('div', ['class' => 'mb-3 form-group']); ?>
           <?php echo Html::openTag('div'); ?>
                <label for="postaladdress_id"><?php echo $translator->translate('client.postaladdress.available'); ?>: </label>
            <?php echo Html::closeTag('div'); ?>           
        ...
        if ($postal_address_count > 0 && 'edit' == $origin) { ?>
                    <?php echo Field::select($form, 'postaladdress_id')
...
if (0 === $postal_address_count && 'edit' == $origin) {
...
<?php echo Html::openTag('div', ['class' => 'card']); ?>
    ...
    <?php echo Html::openTag('div', ['class' => 'row']); ?>
        <?php echo Html::openTag('div', ['class' => 'mb-3 form-group']); ?>
            <?php echo Html::openTag('div', ['class' => 'controls']); ?>
                <?php echo Field::select($form, 'client_gender')
...
echo Field::date($form, 'client_birthdate')
                ...
                ->required(false);
?>    
            <?php echo Field::number($form, 'client_age')
...
?>
            <?php echo Field::text($form, 'client_avs')
    ...
    ->required(false);
?>
            <?php echo Field::text($form, 'client_insurednumber')
    ...
    ->required(false);
?>
            <?php echo Field::text($form, 'client_veka')
...
<?php echo Html::openTag('div', ['class' => 'card']); ?>
    <?php echo Html::openTag('div', ['class' => 'card-header']); ?>
        <?php echo $translator->translate('tax.information'); ?>
    <?php echo Html::closeTag('div'); ?>
    <?php echo Html::openTag('div', ['class' => 'row']); ?>
        <?php echo Field::text($form, 'client_vat_id')
    ...
    ->required(false);
?>
        <?php echo Field::text($form, 'client_tax_code')
...
?>
        ...
        <?php echo Html::openTag('div', ['class' => 'form-group']); ?>
            <?php if ($customFields) { ?>
            <?php echo Html::openTag('div', ['class' => 'row']); ?>
                <?php echo Html::openTag('div', ['class' => 'col-xl']); ?>
