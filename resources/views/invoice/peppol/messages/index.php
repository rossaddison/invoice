...
echo H::openTag('div', ['class' => 'container-fluid py-3']);
 ...
 echo H::openTag('form', ['method' => 'get',
  ...
  echo H::closeTag('div');
  echo H::openTag('div', ['class' => 'col-12']);
   echo H::a('Clear', $urlGenerator->generate('peppol/messages/index'),
  ...
  echo H::openTag('table', ['class' => 'table table-hover table-sm align-middle']);
   ...
   foreach ($messages as $message) {
    ...
    echo H::openTag('tr');
     ...
     echo H::tag('td',
      $msgId !== null
       ? H::tag('code', H::encode(mb_strimwidth($msgId, 0, 36, '…')),
          ['title' => H::encode($msgId)])->encode(false)->render()
     ...
     echo H::tag('td',
      H::a('Detail', $urlGenerator->generate('peppol/messages/view', ['id' => $message->reqId()]),
