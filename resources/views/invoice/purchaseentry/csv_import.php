  ...
  echo H::openTag('div', ['class' => 'col-12 col-md-7 offset-md-2']);
   ...
   echo H::openTag('div', ['class' => 'card']);
    echo H::openTag('div', [
     ...
     echo H::a('← Back', 'entry', ['class' => 'btn btn-sm btn-outline-secondary']);
    echo H::closeTag('div');
    echo H::openTag('div', ['class' => 'card-body']);
     ...
     echo (new Form())
         ->post($urlGenerator->generate('entry/csv-import'))
