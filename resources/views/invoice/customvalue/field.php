       ...
       echo H::openTag('div', ['class' => 'headerbar-item pull-right']); //7
        echo H::openTag('div', ['class' => 'btn-group btn-group-sm']); //8
         ...
         echo H::openTag('a', [
          ...
          echo H::openTag('i', ['class' => 'bi bi-plus-lg']);
          echo H::closeTag('i');
