...
<div class="card-body p-5 text-center">    
    ...
    <?= Html::label($translator->translate('online.payment.method'), 'gateway-select'); ?>
    <?= Field::text($form, 'gateway_driver')
        ...
        ->hideLabel()
    ?>
    <?= $translator->translate('creditcard.details'); ?>
    <?= $translator->translate('online.payment.creditcard.hint'); ?>
    <?= $translator->translate('creditcard.number'); ?>
    <?= Field::text($form, 'creditcard_number')
    ->addInputAttributes(['class' => 'input-sm form-control'])
    ->addInputAttributes(['value' => $body['creditcard_number'] ?? '4242424242424242' ])
    ->hideLabel()
    ?>
    <?= $translator->translate('creditcard.expiry.month'); ?>
    ...
    ->hideLabel()
    ?>
    <?= $translator->translate('creditcard.cvv'); ?>
