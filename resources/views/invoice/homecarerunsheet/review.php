...
echo H::tag(
    'p',
    $translator->translate('homecare.runsheet.review.description'),
    ['class' => 'text-muted']
);
...
if ($runSheet->getSpreadsheetFileName() !== null) {
    echo H::a(
        H::encode($translator->translate('homecare.runsheet.review.download')),
...
if ($runSheet->getStatus() === HomeCareRunSheetStatus::Exported
    ...
    echo H::tag(
        'label',
        $translator->translate('homecare.runsheet.review.upload.label'),
...
if ($runSheet->getStatus() === HomeCareRunSheetStatus::PendingReview) {
    ...
    echo H::tag(
        'p',
        $translator->translate('homecare.runsheet.review.apply.description'),
        ['class' => 'text-muted']
    );
