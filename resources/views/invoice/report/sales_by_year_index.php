...
<div id="headerbar">
    <h1 class="headerbar-title"><?php echo Html::encode($translator->translate('sales.by.date')); ?></h1>
</div>
        ...
        <div class="col-xs-12 col-md-6 col-md-offset-3">
            ...
            <div id="report_options" class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <?php echo Html::encode($translator->translate('report.options')); ?>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="<?php echo $urlGenerator->generate($actionName, $actionArguments); ?>"
                       <?php echo '1' === $s->getSetting('open_reports_in_new_tab') ? 'target="_blank"' : ''; ?>>
                        ...
                        <input type="submit" class="btn btn-success" name="btn_submit" value="<?php echo $translator->translate('run.report'); ?>">
                    </form>
                </div>
            </div>
        </div>
