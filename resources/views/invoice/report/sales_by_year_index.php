...
<div id="headerbar">
    <h1 class="headerbar-title"><?= Html::encode($translator->translate('i.sales_by_date')); ?></h1>
</div>
        ...
        <div class="col-xs-12 col-md-6 col-md-offset-3">
            ...
            <div id="report_options" class="panel panel-default">
                ...
                <div class="panel-heading">
                    ...
                    <?= Html::encode($translator->translate('i.report_options')); ?>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="<?= $urlGenerator->generate($actionName, $actionArguments); ?>"
                       <?php echo ($s->getSetting('open_reports_in_new_tab') === '1' ? 'target="_blank"' : ''); ?>>
                        ...
                        <input type="submit" class="btn btn-success" name="btn_submit" value="<?= $translator->translate('i.run_report'); ?>">
                    </form>
                </div>
            </div>
        </div>
