...
<head>
    <title><?php echo $translator->translate('report.sales.by.product'); ?></title>
</head>
<body>
<?php $this->beginBody(); ?>
<h3 class="report_title">
    <?php echo $translator->translate('report.sales.by.product'); ?><br/>
    <small><?php echo $from_date.' - '.$to_date; ?></small>
</h3>
<table>
    <tr>
        <th><?php echo $translator->translate('product'); ?></th>
    ...
    <?php
        ...
        <tr>
            <td><?php echo Html::encode($result['product_name']); ?></td>
