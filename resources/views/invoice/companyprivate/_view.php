        ...
        <?php echo Html::openTag('div', ['id' => 'content']); ?>
            <?php echo Html::openTag('div', ['class' => 'row']); ?>
                <?php echo Html::openTag('div', ['class' => 'mb3 form-group']); ?>
                    <?php echo Field::text($form, 'company_public_name')
        ->readonly(true); ?>
                ...
                <?php echo Html::openTag('div', ['class' => 'mb3 form-group']); ?>
                    ...
                    ->readonly(true); ?>
                <?php echo Html::closeTag('div'); ?>
                <?php echo Html::openTag('div', ['class' => 'container-fluid px-1']); ?>
                    <?php echo Html::openTag('div', ['class' => 'p-3 border bg-light']); ?>
                        <?php echo Html::openTag('div', ['class' => 'mb3 form-group']); ?>
                            <?php echo Field::text($form, 'logo_filename')
                    ->readonly(true)
                    ->value($form->getLogo_filename()); ?>
                        <?php echo Html::closeTag('div'); ?>
                        <?php echo Html::openTag('div', ['class' => 'mb3 form-group']); ?>
                            <?php echo Field::image()
