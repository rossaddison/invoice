...
echo Breadcrumbs::widget()
    ->links(
        ...
        BreadcrumbLink::to(
            ...
            attributes: [
                'data-bs-toggle' => 'tooltip',
                'title'          => '1' == $s->getSetting('generate_quote_number_for_draft') ? '✅' : '❌',
            ],
            encodeLabel: false,
        ),
        BreadcrumbLink::to(
...
<div>
    ...
    <div class="submenu-row">
            <div class="btn-group index-options">
                <a href="<?php echo $urlGenerator->generate('quote/index', ['page' => 1, 'status' => 0]); ?>"
                   class="btn <?php echo 0 == $status ? 'btn-primary' : 'btn-default'; ?>">
                    <?php echo $translator->translate('all'); ?>
                </a>
                <a href="<?php echo $urlGenerator->generate('quote/index', ['page' => 1, 'status' => 1]); ?>" style="text-decoration:none"
                   class="btn  <?php echo 1 == $status ? 'btn-primary' : 'btn-default'; ?>">
                    <?php echo $translator->translate('draft'); ?>
                </a>
                <a href="<?php echo $urlGenerator->generate('quote/index', ['page' => 1, 'status' => 2]); ?>" style="text-decoration:none"
                   class="btn  <?php echo 2 == $status ? 'btn-primary' : 'btn-default'; ?>">
                    <?php echo $translator->translate('sent'); ?>
                </a>
                <a href="<?php echo $urlGenerator->generate('quote/index', ['page' => 1, 'status' => 3]); ?>" style="text-decoration:none"
                   class="btn  <?php echo 3 == $status ? 'btn-primary' : 'btn-default'; ?>">
                    <?php echo $translator->translate('viewed'); ?>
                </a>
                <a href="<?php echo $urlGenerator->generate('quote/index', ['page' => 1, 'status' => 4]); ?>" style="text-decoration:none"
                   class="btn  <?php echo 4 == $status ? 'btn-primary' : 'btn-default'; ?>">
                    <?php echo $translator->translate('approved'); ?>
                </a>
                <a href="<?php echo $urlGenerator->generate('quote/index', ['page' => 1, 'status' => 5]); ?>" style="text-decoration:none"
                   class="btn  <?php echo 5 == $status ? 'btn-primary' : 'btn-default'; ?>">
                    <?php echo $translator->translate('rejected'); ?>
                </a>
                <a href="<?php echo $urlGenerator->generate('quote/index', ['page' => 1, 'status' => 6]); ?>" style="text-decoration:none"
        ...
        new DataColumn(
            ...
            content: static function (Quote $model) use ($urlGenerator, $soR): string {
                ...
                if (null !== $so) {
                    ...
                    if ('0' === $model->getSo_id() && 7 === $model->getStatus_id()) {
                        if ($statusId > 0) {
