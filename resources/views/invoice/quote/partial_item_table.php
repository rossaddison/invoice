...
<div>
        <table id="item_table" class="items table table-responsive table-condensed table-bordered no-margin">
            <thead>
                    ...
                    <td class="td-vert-middle btn-group">                        
                        <?php if ($invEdit === true) { ?>
                            ...
                            <?php } ?>
                             ...
                             <a href="<?= $urlGenerator->generate('quote/delete_quote_item',
                                    [
                                        'id' => $item->getId(),
                             ...
                             <?php if ($item->getTask_id() > 0) { ?>    
                             <a href="<?= $urlGenerator->generate('quoteitem/edit_task',
                                    [
                                        'id' => $item->getId(),
                                        '_language' => $currentRoute->getArgument('_language')]) ?>"
                            ...
                            <?php } ?>
                            <?php if ($item->getProduct_id() > 0) { ?>    
                             <a href="<?= $urlGenerator->generate('quoteitem/edit_product',
                                    [
                                        'id' => $item->getId(),
                                        '_language' => $currentRoute->getArgument('_language')]) ?>" 
                                class="btn btn-success btn">
...
?> 
        ...
        <div class="col-xs-12 col-md-6 col-md-offset-2 col-lg-4 col-lg-offset-4">
            <table class="table table-bordered text-right">
                ...
                <tr>
                    ...
                    <td style="width: 60%;background-color: lightblue" class="amount" id="amount_subtotal" data-bs-toggle = "tooltip" title="quote_amount->item_subtotal =  quote_item(s)->subtotal - quote_item(s)->discount + quote_item(s)->charge">
    <?php echo $numberHelper->format_currency($quoteAmount->getItem_subtotal() > 0.00 ? $quoteAmount->getItem_subtotal() : 0.00); ?></td>
                ...
                <tr>
                    ...
                    <td class="amount" style="background-color: lightpink" data-bs-toggle = "tooltip" id="amount_item_tax_total" title="quote_amount->item_tax_total">
    <?php echo $numberHelper->format_currency($quoteAmount->getItem_tax_total() > 0 ? $quoteAmount->getItem_tax_total() : 0.00); ?></td>
                ...
                <tr>
                    ...
                    <td class="amount" style="background-color:lightyellow" id="amount_quote_total" data-bs-toggle = "tooltip" title="quote_amount->total"><b><?php echo $numberHelper->format_currency($quoteAmount->getTotal() ?? 0.00); ?></b></td>
                </tr>
            </table>
        </div>
    <hr>
