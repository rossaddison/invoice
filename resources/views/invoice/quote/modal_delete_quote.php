...
/**
 * @see id="delete-quote" triggered by <a href="#delete-quote" data-toggle="modal"  style="text-decoration:none"> on views/quote/view.php
...
<div id="delete-quote" class="modal modal-lg" role="dialog" aria-labelledby="modal_delete_quote" aria-hidden="true">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="panel-title"><?= $translator->translate('i.delete_quote'); ?></h4>
        </div>
