...
final class <?php echo $generator->getCamelcase_capital_name(); ?>Service
{

    private <?php echo $generator->getCamelcase_capital_name(); ?>Repository $repository;

    public function __construct(<?php echo $generator->getCamelcase_capital_name(); ?>Repository $repository)
    {
        $this->repository = $repository;
    }

    public function save<?php echo $generator->getCamelcase_capital_name(); ?>(<?php echo $generator->getCamelcase_capital_name(); ?> $model, array $array): void
    {
        <?php
            echo "\n";
/**
...
foreach ($orm_schema->getColumns() as $column) {
    if ('primary' != $column->getAbstractType()) {
        ...
        if ('date' != $column->getAbstractType()) {
...
?> 
    ...
    public function delete<?php echo $generator->getCamelcase_capital_name(); ?>(<?php echo $generator->getCamelcase_capital_name(); ?> $model): void
    {
