            ...
            <?= Html::openTag('div'); ?>  
                <?php 
                    ...
                    foreach ($tables as $table) {
                        $optionsDataTable[$table->getName()] = $table->getName(); 
                    }
                    echo Field::select($form, 'pre_entity_table')
                    ->label($translator->translate('invoice.generator.table.used.to.generate.entity.controller.repository'),['class' => 'form-label'])    
                    ->addInputAttributes([
