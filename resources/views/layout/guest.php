...
<!DOCTYPE html>
<html lang="<?php echo $currentRoute->getArgument('_language') ?? 'en'; ?>">
<head>
    <?php echo Meta::documentEncoding('utf-8'); ?>
    <?php echo Meta::pragmaDirective('X-UA-Compatible', 'IE=edge,chrome=1'); ?>
    <?php echo Meta::data('viewport', 'width=device-width, initial-scale=1'); ?>
    <?php echo Meta::data('robots', 'NOINDEX,NOFOLLOW'); ?>
    <title>
