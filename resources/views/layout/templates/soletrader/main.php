...
?>
    ...
    <head>
        ...
        <title><?php echo $this->getTitle() ? Html::encode($this->getTitle()) : ''; ?></title>
        <?php $this->head(); ?>
    </head>
    ...
    <footer class='mt-auto bg-dark py-3'>
        <div class = 'd-flex flex-fill align-items-center container-fluid'>
            <div class = 'd-flex flex-fill float-start'>
                <i class=''></i>
                <a class='text-decoration-none' href='<?php echo $companyWeb; ?>' target='_blank' rel='noopener'>
                   <?php echo $brandLabel; ?> - <?php echo date('Y'); ?> -
                </a>
            ...
            <div class='float-end'>
                <a class='text-decoration-none px-1' href='<?php echo $companyWeb; ?>' target='_blank' rel='noopener' >
                    <i class="bi bi-github text-white"></i>
                </a>
                <a class='text-decoration-none px-1' href='<?php echo $companySlack; ?>' _blank' rel='noopener'>
                    <i class="bi bi-slack text-white"></i>
                </a>
                <a class='text-decoration-none px-1' href='<?php echo $companyFaceBook; ?>' target='_blank' rel='noopener'>
                    <i class="bi bi-facebook text-white"></i>
                </a>
                <a class='text-decoration-none px-1' href='<?php echo $companyTwitter; ?>' target='_blank' rel='noopener'>
                    <i class="bi bi-twitter text-white"></i>
                </a>
                <a class='text-decoration-none px-1' href='<?php echo $companyWhatsApp; ?>' target='_blank' rel='noopener'>
                    <i class="bi bi-whatsapp text-white"></i>
                </a>
                <a class='text-decoration-none px-1' href='<?php echo $companyLinkedIn; ?>' target='_blank' rel='noopener'>
