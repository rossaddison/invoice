...
if ((null !== $currentPath) && !$isGuest) {
    ...
    if ($debugMode) {
        ...
        ->items(
            ...
            ->items(
                ...
                DropdownItem::text($translator->translate('vat'),
                    ['style' => $vat ? 'background-color: #ffcccb' : 'background-color: #90EE90']),
                // Debug Mode
                DropdownItem::text($translator->translate('debug')),
                // Locale
                DropdownItem::text($translator->translate('region') 
            ...
            ->items(
                DropdownItem::link('Console Commands',
                    $urlGenerator->generate('invoice/faq',
                        ['topic' => 'consolecommands', 'selection' => ''])),
                DropdownItem::link($translator->translate('faq.taxpoint'),
                    $urlGenerator->generate('invoice/faq',
                        ['topic' => 'tp', 'selection' => ''])),
                DropdownItem::link($translator->translate('faq.shared.hosting'),
                    $urlGenerator->generate('invoice/faq',
                        ['topic' => 'shared', 'selection' => ''])),
                DropdownItem::link($translator->translate('faq.payment.provider'),
                    $urlGenerator->generate('invoice/faq',
                        ['topic' => 'paymentprovider', 'selection' => ''])),
                DropdownItem::text($subMenu->generate($translator->translate('faq.php.info.details'),
                    $urlGenerator, $subMenuPhpInfo)),
                DropdownItem::link('JavaScript Analysis',
                    $urlGenerator->generate('invoice/faq',
                        ['topic' => 'javascript_analysis', 'selection' => ''])),
                DropdownItem::link('Codeception Selectors Checklist',
                    $urlGenerator->generate('invoice/faq',
                        ['topic' => 'codeception_selectors_checklist', 'selection' => ''])),
                DropdownItem::link($translator->translate('faq.oauth2'),
                    $urlGenerator->generate('invoice/faq',
                        ['topic' => 'oauth2', 'selection' => ''])),
                DropdownItem::link($translator->translate('faq.ai.callback.session'),
                    $urlGenerator->generate('invoice/faq',
                        ['topic' => 'ai_callback_session', 'selection' => ''])),
            ),
            // Generator
            Dropdown::widget()
            ->addClass('navbar fs-4')
            ...
            ->items(
                ...
                DropdownItem::link(
                    ...
                    false,
                    ['data-bs-toggle' => 'tooltip', 
                        'title' => $translator->translate('test.reset.setting.tooltip'),
                            'hidden' => !$debugMode],
                ),
                DropdownItem::link(
                    ...
                    false,
                    ['data-bs-toggle' => 'tooltip',
                        'title' => $translator->translate('test.reset.tooltip'),
                            'hidden' => !$debugMode],
                ),
                DropdownItem::link(
                    ...
                    false,
                    ['data-bs-toggle' => 'tooltip',
                        'title' => $translator->translate('test.remove.tooltip'),
                            'hidden' => !$debugMode],
                ),
            ),
            // Performance
            ...
            ->items(
                DropdownItem::text(
                    $translator->translate('platform.xdebug') . 
                        ' ' . $xdebug, 
                        [
                            'data-bs-toggle' => 'tooltip',
                ...
                DropdownItem::text(
                    'php.ini (line 1797): opcache.memory_consumption (pref 128) = '
                        . ((string) ini_get('opcache.memory_consumption') ?: 'unknown')
                ...
                DropdownItem::text(
                    '.env: BUILD_DATABASE= (pref see nothing) = '
                        . ($buildDatabase ? 'You have built the database using BUILD_DATABASE=true, now assign the environment varirable to nothing i.e. BUILD_DATABASE=' : '✅')),
                DropdownItem::text(
            ...
            ->items(
                ...
                DropdownItem::text(
                    $translator->translate('platform.editor')
    ...
    ->items(
        ...
        ->items(
            DropdownItem::link($translator->translate('view'),
                $urlGenerator->generate('setting/debug_index'),
                    false, !$debugMode,
                        ['style' => 'background-color: #ffcccb', 'hidden' => !$debugMode]),
            DropdownItem::link($translator->translate('setting.add'),
                $urlGenerator->generate('setting/add'),
                    false, !$debugMode, 
                        ['style' => 'background-color: #ffcccb', 'hidden' => !$debugMode]),
            DropdownItem::link($translator->translate('caution.delete.invoices'), 
                $urlGenerator->generate('inv/flush'),
                    false, !$debugMode, 
                        ['style' => 'background-color: #ffcccb', 'hidden' => !$debugMode]),
            DropdownItem::link($translator->translate('view'),
                $urlGenerator->generate('setting/tab_index')),
            DropdownItem::link($translator->translate((
                ...
                $urlGenerator->generate('setting/tab_index')), 
                    ($s->getSetting('install_test_data') == '1' 
                        && $s->getSetting('use_test_data') == '1')),
            DropdownItem::link($translator->translate('email.template'),
                $urlGenerator->generate('emailtemplate/index')),
            DropdownItem::link($translator->translate('email.from.dropdown'),
                $urlGenerator->generate('from/index')),
            DropdownItem::link($translator->translate('email.log'), 
                $urlGenerator->generate('invsentlog/index')),
            DropdownItem::link($translator->translate('custom.fields'), 
                $urlGenerator->generate('customfield/index')),
            DropdownItem::link($translator->translate('group'), 
                $urlGenerator->generate('group/index')),
            DropdownItem::link($translator->translate('archive'), 
                $urlGenerator->generate('inv/archive')),
            DropdownItem::link($translator->translate('payment.method'), 
                $urlGenerator->generate('paymentmethod/index')),
            DropdownItem::link($translator->translate('tax.rate'), 
                $urlGenerator->generate('taxrate/index')),
            DropdownItem::link($translator->translate('contract'),
                $urlGenerator->generate('contract/index')),
            DropdownItem::link($translator->translate('user.account'),
            ...
            DropdownItem::link($translator->translate('user.api.list'),
                $urlGenerator->generate('user/index')),
            DropdownItem::link($translator->translate('setting.company'),
                $urlGenerator->generate('company/index')),
            DropdownItem::link($translator->translate('setting.company.private'),
                $urlGenerator->generate('companyprivate/index')),
            DropdownItem::link($translator->translate('setting.company.profile'),
        ...
        ->togglerSize(ButtonSize::LARGE)
        ->items(
            DropdownItem::link($translator->translate('allowance.or.charge.add'),
                $urlGenerator->generate('allowancecharge/index')),
            DropdownItem::link($translator->translate('peppol.store.cove.1.1.1'),
                'https://www.storecove.com/register/'),
            DropdownItem::link($translator->translate('peppol.store.cove.1.1.2'),
                $urlGenerator->generate('setting/tab_index')),
            DropdownItem::link($translator->translate('peppol.store.cove.1.1.3'),
                $urlGenerator->generate('invoice/store_cove_call_api')),
            DropdownItem::link($translator->translate('peppol.store.cove.1.1.4'),
        ...
        ->togglerSize(ButtonSize::LARGE)
        ->items(
            DropdownItem::link($translator->translate('client.add'),
                $urlGenerator->generate('client/add', ['origin' => 'main'])),
            DropdownItem::link($translator->translate('client.view'),
                $urlGenerator->generate('client/index')),
            DropdownItem::link($translator->translate('client.note.add'),
                $urlGenerator->generate('clientnote/add')),
            DropdownItem::link($translator->translate('client.note.view'),
                $urlGenerator->generate('clientnote/index')),
            DropdownItem::link($translator->translate('delivery.location'),
        ...
        ->togglerSize(ButtonSize::LARGE)
        ->items(
            DropdownItem::link($translator->translate('create.quote'),
        ...
        ->togglerSize(ButtonSize::LARGE)
        ->items(
            DropdownItem::link($translator->translate('create.invoice'), 
                $urlGenerator->generate('inv/add', ['origin' => 'main'])),
            DropdownItem::link($translator->translate('view'), 
                $urlGenerator->generate('inv/index')),
            DropdownItem::link($translator->translate('recurring'), 
        ...
        ->togglerSize(ButtonSize::LARGE)
        ->items(
            DropdownItem::link($translator->translate('enter.payment'),
                $urlGenerator->generate('payment/add')),
            DropdownItem::link($translator->translate('view'),
                $urlGenerator->generate('payment/index')),
            DropdownItem::link($translator->translate('payment.logs'),
        ...
        ->togglerSize(ButtonSize::LARGE)
        ->items(
            DropdownItem::link($translator->translate('add.product'),
                $urlGenerator->generate('product/add')),
            DropdownItem::link($translator->translate('view'),
                $urlGenerator->generate('product/index')),
            DropdownItem::link($translator->translate('category.primary'),
                $urlGenerator->generate('categoryprimary/index')),
            DropdownItem::link($translator->translate('category.secondary'),
                $urlGenerator->generate('categorysecondary/index')),
            DropdownItem::link($translator->translate('family'),
                $urlGenerator->generate('family/index')),
            DropdownItem::link($translator->translate('family.search'),
                $urlGenerator->generate('family/search')),
            DropdownItem::link($translator->translate('unit'),
                $urlGenerator->generate('unit/index')),
            DropdownItem::link($translator->translate('peppol.unit'),
        ...
        ->togglerSize(ButtonSize::LARGE)
        ->items(
            DropdownItem::link($translator->translate('add.task'),
        ...
        ->togglerSize(ButtonSize::LARGE)
        ->items(
            DropdownItem::link($translator->translate('create.project'),
        ...
        ->togglerSize(ButtonSize::LARGE)
        ->items(
            DropdownItem::link($translator->translate('sales.by.client'),
                $urlGenerator->generate('report/sales_by_client_index')),
            DropdownItem::link($translator->translate('report.sales.by.product'),
                $urlGenerator->generate('report/sales_by_product_index')),
            DropdownItem::link($translator->translate('report.sales.by.task'),
                $urlGenerator->generate('report/sales_by_task_index')),
            DropdownItem::link($translator->translate('sales.by.date'),
                $urlGenerator->generate('report/sales_by_year_index')),
            DropdownItem::link($translator->translate('payment.history'),
                $urlGenerator->generate('report/payment_history_index')),
            DropdownItem::link($translator->translate('aging'),
                $urlGenerator->generate('report/invoice_aging_index')),
            DropdownItem::link($translator->translate('report.test.fraud.prevention.headers.api'),
