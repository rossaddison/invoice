...
?>
    ...
    <?php echo Html::openTag('section', ['id' => 'Contact', 'class' => 'py-5 py-xl-8']); ?>
        <?php echo Html::openTag('div', ['class' => 'container']); ?>
            <?php echo Html::openTag('div', ['class' => 'row gy-3 gy-md-4 gy-lg-0 align-items-lg-center']); ?>
            ...
            <?php echo Html::openTag('div', ['class' => 'col-12 col-lg-6']); ?>
                <?php echo Html::openTag('div', ['class' => 'row justify-content-xl-center']); ?>
                    <?php echo Html::openTag('div', ['class' => 'col-12 col-xl-11']); ?>
                        <?php echo Html::openTag('h2', ['class' => 'h1 mb-3']); ?>
                            <?php echo (string) $contact['touch']; ?>
                        <?php echo Html::closeTag('h2'); ?>
                        <?php echo P::tag()
        ->addClass('lead fs-4 text-secondary mb-5')
        ->content((string) $contact['lookout'])
        ->render(); ?> 
                        <?php echo Html::openTag('div', ['class' => 'd-flex mb-4']); ?>
                            <?php echo Html::openTag('div', ['class' => 'me-4 text-primary']); ?>
                            ...
                            <?php echo Html::openTag('div'); ?>
                                ...
                                ->render(); ?>
                                <?php echo Html::openTag('address', ['class' => 'mb-0 text-secondary']); ?>    
                                    <?php echo $companyAddress1.', '.
                                        $companyAddress2.', '.
                                        $companyCity.', '.
                                        $companyState.', '.
                                        $companyZip; ?>
                                <?php echo Html::closeTag('address'); ?>
                        <?php echo Html::closeTag('div'); ?>
                        <?php echo Html::openTag('div', ['class' => 'd-flex mb-4']); ?>
                            <?php echo Html::openTag('div', ['class' => 'me-4 text-primary']); ?>
                            ...
                            <?php echo Html::openTag('div'); ?>
                                ...
                                ->render(); ?>
                                <?php echo Html::openTag('p', ['class' => 'mb-0']); ?>
                                    <?php echo A::tag()
...
?>
                            ...
                            <?php echo Html::closeTag('div'); ?>
                        <?php echo Html::closeTag('div'); ?>
                        <?php echo Html::openTag('div', ['class' => 'd-flex']); ?>
                            <?php echo Html::openTag('div', ['class' => 'me-4 text-primary']); ?>
