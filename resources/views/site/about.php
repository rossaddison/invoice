...
<?php echo Html::openTag('section', ['id' => 'About', 'class' => 'py-5 py-xl-8']); ?>
    <?php echo Html::openTag('div', ['class' => 'container']); ?>
        <?php echo Html::openTag('div', ['class' => 'row gy-5 gy-lg-0 align-items-lg-center']); ?> 
            <?php echo Html::openTag('div', ['class' => 'col-12 col-lg-6']); ?>
                <?php if ('1' == $s->getSetting('debug_mode')) { ?>  
                    <?php echo Html::openTag('i', ['class' => 'bi bi-info-circle', 'data-bs-toggle' => 'tooltip', 'title' => 'invoice/public/img/soletrader/about/about.png']); ?>   
                    <?php echo Html::closeTag('i'); ?>
                <?php } ?>
                <?php echo Html::tag('img', '', ['class' => 'img-fluid rounded', 'loading' => 'lazy', 'src' => '/img/soletrader/about/about.png', 'alt' => '/img/soletrader/about/about.png']); ?>    
            <?php echo Html::closeTag('div'); ?>
                  
            <?php echo Html::openTag('div', ['class' => 'col-12 col-lg-6']); ?>
                <?php echo Html::openTag('div', ['class' => 'row justify-content-xl-end']); ?>
                    <?php echo Html::openTag('div', ['class' => 'col-12 col-xl-11']); ?>
                        <?php echo Html::openTag('h3', ['class' => 'display-3 fw-bolder mb-4']); ?>
                            <?php echo // We diligently apply our skills to the best of our ability
                               (string) $about['we']; ?>
                        ...
                        <?php echo P::tag()
                                   ...
                                   ->render(); ?>    
                        <?php echo Html::openTag('div', ['class' => 'accordion accordion-flush', 'id' => 'accordionExample']); ?>
                            <?php echo Html::openTag('div', ['class' => 'accordion-item']); ?>   
                                <?php echo Html::openTag('h2', ['class' => 'accordion-header', 'id' => 'headingOne']); ?>
                                    <?php echo Button::tag()
                                    ->addAttributes(
                                        [
...
// Competitive rates
                                ...
                                <?php echo Html::openTag('div', ['id' => 'collapseOne', 'class' => 'accordion-collapse collapse show', 'aria-labelledby' => 'headingOne', 'data-bs-parent' => '#accordionExample']); ?>    
                                    <?php echo Html::openTag('div', ['class' => 'accordion-body']); ?>
                                        <?php echo // Without sacrificing quality
                                            (string) $about['quality']; ?>
                                    <?php echo Html::closeTag('div'); ?>
                                <?php echo Html::closeTag('div'); ?>
                            <?php echo Html::closeTag('div'); ?>
                            <?php echo Html::openTag('div', ['class' => 'accordion-item']); ?>
                                <?php echo Html::openTag('h2', ['class' => 'accordion-header', 'id' => 'headingTwo']); ?>
                                    <?php echo Button::tag()
                                                ->addAttributes(
                                                    [
...
// Contemporary skills
                                                ...
                                                ->render(); ?>
                                <?php echo Html::closeTag('h2'); ?>
                                <?php echo Html::openTag('div', ['id' => 'collapseTwo', 'class' => 'accordion-collapse collapse', 'aria-labelledby' => 'headingTwo', 'data-bs-parent' => '#accordionExample']); ?>    
                                    <?php echo Html::openTag('div', ['class' => 'accordion-body']); ?>
                                        <?php echo (string) $about['trained']; ?>
                                    <?php echo Html::closeTag('div'); ?>
                                <?php echo Html::closeTag('div'); ?>
                            <?php echo Html::closeTag('div'); ?>
                            <?php echo Html::openTag('div', ['class' => 'accordion-item']); ?>
                                <?php echo Html::openTag('h2', ['class' => 'accordion-header', 'id' => 'headingThree']); ?>
                                    <?php echo Button::tag()
                                        ->addAttributes(
                                            [
                                                'class'          => 'accordion-button collapsed',
...
// Willing Return Support
                                        ...
                                        ->render(); ?>
                                <?php echo Html::closeTag('h2'); ?>
                                <?php echo Html::openTag('div', ['id' => 'collapseThree', 'class' => 'accordion-collapse collapse', 'aria-labelledby' => 'headingThree', 'data-bs-parent' => '#accordionExample']); ?>    
                                    <?php echo Html::openTag('div', ['class' => 'accordion-body']); ?>
                                        <?php echo (string) $about['dissatisfaction']; ?>. <?php echo (string) $about['simply']; ?>
                                    <?php echo Html::closeTag('div'); ?>
                                <?php echo Html::closeTag('div'); ?>
                            <?php echo Html::closeTag('div'); ?>
                        <?php echo Html::closeTag('div'); ?>                    
        ...
        <?php echo Html::closeTag('div'); ?>                                
    <?php echo Html::closeTag('div'); ?>
    <?php echo Html::openTag('div', ['class' => 'container pt-5 pt-xl-8']); ?>
        <?php echo Html::openTag('div', ['class' => 'row gy-4']); ?>    
            <?php echo Html::openTag('div', ['class' => 'col-12 col-sm-6 col-xl-3']); ?>    
                <?php echo Html::openTag('div', ['class' => 'card border-0 border-bottom border-primary shadow-sm']); ?>
                    <?php echo Html::openTag('div', ['class' => 'card-body text-center p-4 p-xxl-5']); ?>
                        <?php echo Html::openTag('div', ['class' => 'btn btn-primary pe-none mb-2 text-primary border-0']); ?>                
                        ...
                        <?php echo Html::closeTag('div'); ?>
                        <?php echo Html::openTag('h3', ['class' => 'h1 mb-2']); ?>
                            <?php echo Html::encode('100+'); ?>           
                        <?php echo Html::closeTag('h3'); ?>
                        <?php echo P::tag()
                            ->addClass('fs-5 mb-0')
// Happy Customers
