...
final class PrometheusExporterIntegrationTest extends TestCase
{
    public function testNodeExporterCompatibility(): void
    {
        ...
        $this->assertStringContainsString(
            'yii3_invoice_health_application_healthy 1',
            $output
        );
        $this->assertStringContainsString(
            'yii3_invoice_db_connections_active 5',
            $output
        );
        $this->assertStringContainsString(
            'yii3_invoice_php_fpm_processes_active 8',
            $output
        );
    ...
    public function testWindowsExporterCompatibility(): void
    {
        ...
        $this->assertStringContainsString(
            'yii3_invoice_temp_files_count 23',
            $output
        );
    }
