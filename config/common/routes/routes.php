...
return [
    ...
    Route::methods([Method::GET, Method::POST], '/regenerateCodes')
        ->middleware(fn (AccessChecker $checker) => $checker->withPermission(Permissions::VIEW_INV)
        ->withPermission(Permissions::NO_ENTRY_TO_BASE_CONTROLLER))
    ...
    Group::create('/invoice')
        ...
        ->middleware(fn (AccessChecker $checker) => $checker->withPermission(Permissions::ENTRY_TO_BASE_CONTROLLER))
        ->routes(
            Route::get('')
            ...
            Route::methods([Method::GET, Method::POST], '/client/guest')
                ->name('client/guest')
                ->middleware(fn (AccessChecker $checker) => $checker->withPermission(Permissions::EDIT_CLIENT_PEPPOL))
            ...
            Route::methods([Method::GET, Method::POST], '/paymentinformation/amazon_complete/{url_key}')
                ->middleware(fn (AccessChecker $checker) => $checker->withPermission(Permissions::VIEW_PAYMENT))
            ...
            Route::get('/payment[/page/{page:\d+}]')
                ->middleware(fn (AccessChecker $checker) => $checker->withPermission(Permissions::EDIT_PAYMENT))
            ...
            Route::methods([Method::GET, Method::POST], '/userinv/guest')
                ->name('userinv/guest')
                ->middleware(fn (AccessChecker $checker) => $checker->withPermission(Permissions::EDIT_USER_INV))
